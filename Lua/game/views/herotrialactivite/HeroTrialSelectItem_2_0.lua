...
function slot0.AddListeners(slot0)
	slot0:AddBtnListener(slot0.button_, nil, function ()
		HeroTrialData:SetSelectActiviteHeroID(uv0.activityID_, uv0.acitvityTrialID_)
...
function slot0.RefreshUI(slot0)
	slot2 = ActivityHeroTrialCfg[slot0.acitvityTrialID_].trial_id
	slot3 = HeroStandardSystemCfg[slot2].skin_id
	slot0.imageSelect_.sprite = getSpriteViaConfig("HeroIcon", slot3)
	slot0.imageIcon_.sprite = getSpriteViaConfig("HeroIcon", slot3)
	slot4 = HeroCfg[HeroStandardSystemCfg[slot2].hero_id].race
	slot0.imageRace_.sprite = getSprite("Atlas/CampItem", RaceEffectCfg[slot4].icon)
	slot0.imageRaceSelect_.sprite = getSprite("Atlas/CampItem", RaceEffectCfg[slot4].icon)
end
