slot0 = class("StrategyMatrixProcessShopSelectHeroView", MatrixProcessSelectHeroView)
...
function slot0.OnRewardAction(slot0)
	...
	if MatrixConst.ITEM_TYPE.WEAPON_SERVANT == slot4 then
		...
		StrategyMatrixAction.BuyShopItem(slot0.matrix_activity_id, slot0.shopIndex, slot0:GetHeroData(slot2):GetStandardId(), 0)
	end
end
