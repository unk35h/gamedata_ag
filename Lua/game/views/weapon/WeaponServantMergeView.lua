slot0 = class("WeaponServantMergeView", ReduxView)
...
function slot0.indexItem(slot0, slot1, slot2)
	...
	if slot0:MaterialEnoughById(slot3.id) then
...
function slot0.OnCurrencyUpdate(slot0, slot1)
	slot2 = {}
...
function slot0.OnEnter(slot0)
	...
	slot0.currencyUpdateHandler_ = handler(slot0, slot0.OnCurrencyUpdate)

	manager.notify:RegistListener(MATERIAL_MODIFY, slot0.materialUpdateHandler_)
	manager.notify:RegistListener(CURRENCY_UPDATE, slot0.currencyUpdateHandler_)
...
function slot0.OnExit(slot0)
	...
	manager.notify:RemoveListener(CURRENCY_UPDATE, slot0.currencyUpdateHandler_)

	slot0.materialUpdateHandler_ = nil
	slot0.currencyUpdateHandler_ = nil
