slot0 = class("MythicChipManagerUnlockView", ChipManagerUnlockView)
...
function slot0.GetEnabledManagerID(slot0)
	return BattleTeamData:GetMimirInfo(BattleConst.STAGE_TYPE_NEW.MYTHIC_FINAL, slot0.activityID_, slot0.cont_id_, slot0.teamID_)
end
...
function slot0.GetChipData(slot0)
	slot1, slot2 = BattleTeamData:GetMimirInfo(BattleConst.STAGE_TYPE_NEW.MYTHIC_FINAL, slot0.activityID_, slot0.cont_id_, slot0.teamID_)
