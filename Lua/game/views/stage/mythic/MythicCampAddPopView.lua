...
function slot0.UIName(slot0)
	return "UI/Mythic/MythicGodUpUI"
end
...
function slot0.GetRaceEffect(slot0)
	...
	for slot8, slot9 in pairs(BattleTeamData:GetSingleTeam(BattleConst.STAGE_TYPE_NEW.MYTHIC_FINAL, slot8, slot9, slot0.teamID_)) do
		if slot9 ~= 0 then
