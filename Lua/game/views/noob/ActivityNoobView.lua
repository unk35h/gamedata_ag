...
function slot0.UIName(slot0)
	return "UI/Activity/ActivityNewbieUI_new"
end
...
function slot0.OnEnter(slot0)
	...
	manager.redPoint:bindUIandKey(slot0.tree_:GetItemRedPointContainerById(2, 2), RedPointConst.NEWBIE_SIGN .. "_2")
...
function slot0.OnExit(slot0)
	...
	manager.redPoint:unbindUIandKey(slot0.tree_:GetItemRedPointContainerById(2, 2), RedPointConst.NEWBIE_SIGN .. "_2")
