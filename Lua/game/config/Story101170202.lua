return {
	Play117022001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117022001].content)
			...
			slot9 = slot9 + 0.3
			slot12 = uv0:FormatText(StoryWordCfg[117022001].content)
	...
	Play117022002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = uv0.actors_["1033_split_6"]

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				if slot2.GetComponent(slot2, "Image") then
					uv0.var_.alphaMatValue1033_split_6 = slot4
					uv0.var_.alphaOldValue1033_split_6 = slot4.color.a
				end
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot6 = Mathf.Lerp(uv0.var_.alphaOldValue1033_split_6, 1, (uv0.time_ - slot3) / slot4)

				if uv0.var_.alphaMatValue1033_split_6 then
					slot7 = uv0.var_.alphaMatValue1033_split_6.color
					slot7.a = slot6
					uv0.var_.alphaMatValue1033_split_6.color = slot7
				end
			end

			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 and uv0.var_.alphaMatValue1033_split_6 then
				slot5 = uv0.var_.alphaMatValue1033_split_6
				slot6 = slot5.color
				slot6.a = 1
				slot5.color = slot6
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_6, Vector3.New(0, -420, 0), (uv0.time_ - slot6) / slot7)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117022002].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117022", "117022002", "story_v_out_117022.awb") / 1000 > 0 and slot12 < slot16 and uv0.duration_ < slot16 + slot11 then
					slot12 = slot16
					uv0.duration_ = slot16 + slot11
				end

				if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
					uv0:RecordAudio("117022002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_117022", "117022002", "story_v_out_117022.awb"))
				else
			...
			slot14 = uv0:FormatText(StoryWordCfg[117022002].content)
	...
	Play117022003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.6 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117022003].content)
				uv0.typewritter.percent = 0
			...
			slot11 = slot11 + 0.3
			slot14 = uv0:FormatText(StoryWordCfg[117022003].content)
			slot16 = string.split(slot14, ".")
	...
	Play117022004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot5 = Mathf.Lerp(uv0.var_.alphaOldValue1033_split_6, 1, (uv0.time_ - slot2) / slot3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117022004].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117022", "117022004", "story_v_out_117022.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
					slot11 = slot15
					uv0.duration_ = slot15 + slot10
				end

				if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
					uv0:RecordAudio("117022004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117022", "117022004", "story_v_out_117022.awb"))
				else
			...
			slot13 = uv0:FormatText(StoryWordCfg[117022004].content)
	...
	Play117022005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot11 = Mathf.Lerp(uv0.var_.alphaOldValue1033_split_6, 0, (uv0.time_ - slot8) / slot9)
			...
			slot10 = uv0.bgs_.TI0102.transform

			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.moveOldPosTI0102 = slot10.localPosition
			end
			...
			slot13 = uv0.bgs_.TI0102.transform

			if 2.034 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPosTI0102 = slot13.localPosition
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117022005].content)
				uv0.typewritter.percent = 0
			...
			slot16 = slot16 + 0.3
			slot19 = uv0:FormatText(StoryWordCfg[117022005].content)
	...
	Play117022006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117022006].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[117022006].content)
	...
	Play117022007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117022007].content)
				uv0.typewritter.percent = 0
			...
			slot4 = slot4 + 0.3
			slot7 = uv0:FormatText(StoryWordCfg[117022007].content)
	...
	Play117022008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117022008].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117022", "117022008", "story_v_out_117022.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("117022008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117022", "117022008", "story_v_out_117022.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[117022008].content)
			slot6 = string.split(slot4, ".")
