	...
	Play112112001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112112", "112112001", "story_v_out_112112.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112112", "112112001", "story_v_out_112112.awb") / 1000 > 0 and slot19 < slot24 and uv0.duration_ < slot24 + slot18 then
						slot19 = slot24
						uv0.duration_ = slot24 + slot18
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						uv0:RecordAudio("112112001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_112112", "112112001", "story_v_out_112112.awb"))
					else
			...
			slot18 = slot18 + 0.3
			slot21 = uv0:FormatText(StoryWordCfg[112112001].content)
	...
	Play112112002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112112", "112112002", "story_v_out_112112.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112112", "112112002", "story_v_out_112112.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("112112002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_112112", "112112002", "story_v_out_112112.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[112112002].content)
	...
	Play112112003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112112", "112112003", "story_v_out_112112.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112112", "112112003", "story_v_out_112112.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("112112003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_112112", "112112003", "story_v_out_112112.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[112112003].content)
	...
	Play112112004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112112", "112112004", "story_v_out_112112.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112112", "112112004", "story_v_out_112112.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("112112004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_112112", "112112004", "story_v_out_112112.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[112112004].content)
	...
	Play112112005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112005].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[112112005].content)
	...
	Play112112006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112006].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[112112006].content)
	...
	Play112112007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112112", "112112007", "story_v_out_112112.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112112", "112112007", "story_v_out_112112.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("112112007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_112112", "112112007", "story_v_out_112112.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[112112007].content)
	...
	Play112112008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112112", "112112008", "story_v_out_112112.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112112", "112112008", "story_v_out_112112.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("112112008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_112112", "112112008", "story_v_out_112112.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[112112008].content)
			slot18 = string.split(slot16, ".")
	...
	Play112112009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112112", "112112009", "story_v_out_112112.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112112", "112112009", "story_v_out_112112.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("112112009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_112112", "112112009", "story_v_out_112112.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[112112009].content)
			slot13 = string.split(slot11, ".")
	...
	Play112112010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				...
				if uv0.var_.characterEffect1081ui_story then
					uv0.var_.characterEffect1081ui_story.fillFlat = true
					uv0.var_.characterEffect1081ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot8)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112112", "112112010", "story_v_out_112112.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112112", "112112010", "story_v_out_112112.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("112112010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_112112", "112112010", "story_v_out_112112.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[112112010].content)
			slot13 = string.split(slot11, ".")
	...
	Play112112011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112112", "112112011", "story_v_out_112112.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112112", "112112011", "story_v_out_112112.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("112112011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_112112", "112112011", "story_v_out_112112.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[112112011].content)
			slot14 = string.split(slot12, ".")
	...
	Play112112012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112012].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[112112012].content)
	...
	Play112112013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112112", "112112013", "story_v_out_112112.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112112", "112112013", "story_v_out_112112.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("112112013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_112112", "112112013", "story_v_out_112112.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[112112013].content)
			slot14 = string.split(slot12, ".")
	...
	Play112112014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112014].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[112112014].content)
			slot9 = string.split(slot7, ".")
	...
	Play112112015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112112", "112112015", "story_v_out_112112.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112112", "112112015", "story_v_out_112112.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("112112015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_112112", "112112015", "story_v_out_112112.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[112112015].content)
			slot14 = string.split(slot12, ".")
	...
	Play112112016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112016].content)
				uv0.typewritter.percent = 0
			...
			slot12 = uv0:FormatText(StoryWordCfg[112112016].content)
			slot14 = string.split(slot12, ".")
	...
	Play112112017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112017].content)
				uv0.typewritter.percent = 0
			...
			slot15 = uv0:FormatText(StoryWordCfg[112112017].content)
	...
	Play112112018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112112018].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[112112018].content)
			slot6 = string.split(slot4, ".")
