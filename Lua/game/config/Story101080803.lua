return {
	Play108083001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[108083001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_108083", "108083001", "story_v_out_108083.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_108083", "108083001", "story_v_out_108083.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("108083001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_108083", "108083001", "story_v_out_108083.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[108083001].content)
	...
	Play108083002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[108083002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_108083", "108083002", "story_v_out_108083.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_108083", "108083002", "story_v_out_108083.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("108083002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_108083", "108083002", "story_v_out_108083.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[108083002].content)
	...
	Play108083003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[108083003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_108083", "108083003", "story_v_out_108083.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_108083", "108083003", "story_v_out_108083.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("108083003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_108083", "108083003", "story_v_out_108083.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[108083003].content)
	...
	Play108083004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(-0.85, -1.116, -5), (uv0.time_ - slot10) / slot11)
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 then
				slot9.localPosition = Vector3.New(-0.85, -1.116, -5)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[108083004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_108083", "108083004", "story_v_out_108083.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_108083", "108083004", "story_v_out_108083.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("108083004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_108083", "108083004", "story_v_out_108083.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[108083004].content)
	...
	Play108083005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[108083005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_108083", "108083005", "story_v_out_108083.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_108083", "108083005", "story_v_out_108083.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("108083005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_108083", "108083005", "story_v_out_108083.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[108083005].content)
			slot9 = string.split(slot7, ".")
	...
	Play108083006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[108083006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_108083", "108083006", "story_v_out_108083.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_108083", "108083006", "story_v_out_108083.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("108083006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_108083", "108083006", "story_v_out_108083.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[108083006].content)
	...
	Play108083007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[108083007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_108083", "108083007", "story_v_out_108083.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_108083", "108083007", "story_v_out_108083.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("108083007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_108083", "108083007", "story_v_out_108083.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[108083007].content)
	...
	Play108083008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[108083008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_108083", "108083008", "story_v_out_108083.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_108083", "108083008", "story_v_out_108083.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("108083008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_108083", "108083008", "story_v_out_108083.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[108083008].content)
			slot9 = string.split(slot7, ".")
