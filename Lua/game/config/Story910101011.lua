return {
	Play910101001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6 = uv0.actors_["1070_split_1"].transform

			if 1 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0.var_.moveOldPos1070_split_1 = slot6.localPosition
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1070_split_1, Vector3.New(0, -350, -180), (uv0.time_ - slot7) / slot8)
			end
			...
			slot9 = uv0.actors_["1070_split_1"]

			if 1 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				if slot9.GetComponent(slot9, "Image") then
					uv0.var_.alphaMatValue1070_split_1 = slot11
					uv0.var_.alphaOldValue1070_split_1 = slot11.color.a
				end
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot13 = Mathf.Lerp(uv0.var_.alphaOldValue1070_split_1, 1, (uv0.time_ - slot10) / slot11)

				if uv0.var_.alphaMatValue1070_split_1 then
					slot14 = uv0.var_.alphaMatValue1070_split_1.color
					slot14.a = slot13
					uv0.var_.alphaMatValue1070_split_1.color = slot14
				end
			end

			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 and uv0.var_.alphaMatValue1070_split_1 then
				slot12 = uv0.var_.alphaMatValue1070_split_1
				slot13 = slot12.color
				slot13.a = 1
				slot12.color = slot13
			end
			...
			if 1 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[910101001].content)
			...
			slot12 = slot12 + 0.3
			slot15 = uv0:FormatText(StoryWordCfg[910101001].content)
	...
	Play910101002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[910101002].content)
				uv0.typewritter.percent = 0
			...
			slot8 = uv0:FormatText(StoryWordCfg[910101002].content)
	...
	Play910101003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[910101003].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[910101003].content)
