return {
	Play104101001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot9 = uv0.actors_["2070_tpose"].transform

			if 1.79999995231628 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0.var_.moveOldPos2070_tpose = slot9.localPosition
			end

			slot11 = 0.001

			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2070_tpose, Vector3.New(0, -0.54, -2.5), (uv0.time_ - slot10) / slot11)
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 then
				slot9.localPosition = Vector3.New(0, -0.54, -2.5)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101001", "story_v_out_104101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104101", "104101001", "story_v_out_104101.awb") / 1000 > 0 and slot15 < slot20 and uv0.duration_ < slot20 + slot14 then
						slot15 = slot20
						uv0.duration_ = slot20 + slot14
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("104101001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104101", "104101001", "story_v_out_104101.awb"))
					else
			...
			slot14 = slot14 + 0.3
			slot17 = uv0:FormatText(StoryWordCfg[104101001].content)
	...
	Play104101002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.shakeOldPosMainCamera = slot7.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101002].content)
				uv0.typewritter.percent = 0
			...
			slot13 = uv0:FormatText(StoryWordCfg[104101002].content)
	...
	Play104101003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101003].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[104101003].content)
	...
	Play104101004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101004].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[104101004].content)
	...
	Play104101005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot5 = uv0.bgs_.S0408

			if 1.5 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				if slot5.GetComponent(slot5, "SpriteRenderer") then
					uv0.var_.alphaOldValueS0408 = slot7.material:GetColor("_Color").a
					uv0.var_.alphaMatValueS0408 = slot7.material
				end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot9 = Mathf.Lerp(uv0.var_.alphaOldValueS0408, 1, (uv0.time_ - slot6) / slot7)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				if slot8.GetComponent(slot8, "SpriteRenderer") then
					uv0.var_.alphaOldValueB13 = slot10.material:GetColor("_Color").a
					uv0.var_.alphaMatValueB13 = slot10.material
				end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot12 = Mathf.Lerp(uv0.var_.alphaOldValueB13, 0, (uv0.time_ - slot9) / slot10)
			...
			if 3 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101005", "story_v_out_104101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104101", "104101005", "story_v_out_104101.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("104101005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104101", "104101005", "story_v_out_104101.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[104101005].content)
	...
	Play104101006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = uv0.actors_["2019_tpose"]

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 and uv0.var_.characterEffect2019_tpose == nil then
				uv0.var_.characterEffect2019_tpose = slot2.GetComponentInChildren(slot2, typeof(CharacterEffect))
			end
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				...
				if uv0.var_.characterEffect2019_tpose then
					...
					uv0.var_.characterEffect2019_tpose.fillRatio = Mathf.Lerp(0, 0.5, slot5)
				end
			end
			...
			slot5 = uv0.actors_["2019_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0.var_.moveOldPos2019_tpose = slot5.localPosition
			end

			slot7 = 0.001

			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2019_tpose, Vector3.New(10, -0.9, 1.7), (uv0.time_ - slot6) / slot7)
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 then
				slot5.localPosition = Vector3.New(10, -0.9, 1.7)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101006].content)
				uv0.typewritter.percent = 0
			...
			slot11 = uv0:FormatText(StoryWordCfg[104101006].content)
	...
	Play104101007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101007].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[104101007].content)
			slot6 = string.split(slot4, ".")
	...
	Play104101008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101008", "story_v_out_104101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104101", "104101008", "story_v_out_104101.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("104101008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104101", "104101008", "story_v_out_104101.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[104101008].content)
			slot6 = string.split(slot4, ".")
	...
	Play104101009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101009", "story_v_out_104101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104101", "104101009", "story_v_out_104101.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("104101009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104101", "104101009", "story_v_out_104101.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[104101009].content)
	...
	Play104101011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101011].content)
				uv0.typewritter.percent = 0
			...
			slot13 = uv0:FormatText(StoryWordCfg[104101011].content)
			slot15 = string.split(slot13, ".")
	...
	Play104101012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101012].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[104101012].content)
			slot8 = string.split(slot6, ".")
	...
	Play104101013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101013].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[104101013].content)
			slot6 = string.split(slot4, ".")
	...
	Play104101014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = uv0.bgs_.S0408a

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				if slot2.GetComponent(slot2, "SpriteRenderer") then
					uv0.var_.alphaOldValueS0408a = slot4.material:GetColor("_Color").a
					uv0.var_.alphaMatValueS0408a = slot4.material
				end
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot6 = Mathf.Lerp(uv0.var_.alphaOldValueS0408a, 0, (uv0.time_ - slot3) / slot4)
			...
			slot8 = uv0.bgs_.S0408a.transform

			if 1.5 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPosS0408a = slot8.localPosition
			end
			...
			if 1.8 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101014].content)
				uv0.typewritter.percent = 0
			...
			slot13 = slot13 + 0.3
			slot16 = uv0:FormatText(StoryWordCfg[104101014].content)
			slot18 = string.split(slot16, ".")
	...
	Play104101015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101015", "story_v_out_104101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104101", "104101015", "story_v_out_104101.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("104101015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104101", "104101015", "story_v_out_104101.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[104101015].content)
			slot15 = string.split(slot13, ".")
	...
	Play104101016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101016].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[104101016].content)
			slot9 = string.split(slot7, ".")
	...
	Play104101017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101017", "story_v_out_104101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104101", "104101017", "story_v_out_104101.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("104101017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_104101", "104101017", "story_v_out_104101.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[104101017].content)
	...
	Play104101018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101018", "story_v_out_104101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104101", "104101018", "story_v_out_104101.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("104101018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_104101", "104101018", "story_v_out_104101.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[104101018].content)
	...
	Play104101019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101019].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[104101019].content)
			slot9 = string.split(slot7, ".")
	...
	Play104101020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104101020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104101", "104101020", "story_v_out_104101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104101", "104101020", "story_v_out_104101.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("104101020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104101", "104101020", "story_v_out_104101.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[104101020].content)
			slot6 = string.split(slot4, ".")
