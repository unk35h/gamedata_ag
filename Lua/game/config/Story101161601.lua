return {
	Play116161001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.bgs_.SK0103.transform

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosSK0103 = slot7.localPosition
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161001", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161001", "story_v_out_116161.awb") / 1000 > 0 and slot13 < slot18 and uv0.duration_ < slot18 + slot12 then
						slot13 = slot18
						uv0.duration_ = slot18 + slot12
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("116161001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_116161", "116161001", "story_v_out_116161.awb"))
					else
			...
			slot12 = slot12 + 0.3
			slot15 = uv0:FormatText(StoryWordCfg[116161001].content)
	...
	Play116161002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.bgs_.SK0112.transform

			if 2 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosSK0112 = slot7.localPosition
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161002", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161002", "story_v_out_116161.awb") / 1000 > 0 and slot13 < slot18 and uv0.duration_ < slot18 + slot12 then
						slot13 = slot18
						uv0.duration_ = slot18 + slot12
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("116161002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_116161", "116161002", "story_v_out_116161.awb"))
					else
			...
			slot12 = slot12 + 0.3
			slot15 = uv0:FormatText(StoryWordCfg[116161002].content)
			slot17 = string.split(slot15, ".")
	...
	Play116161003 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.state_ = "playing"
		slot1.duration_ = 6.89966666666667
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.bgs_.SK0107.transform

			if 2 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosSK0107 = slot7.localPosition
			end
			...
			if 3.96666666666667 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161003", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161003", "story_v_out_116161.awb") / 1000 > 0 and slot13 < slot18 and uv0.duration_ < slot18 + slot12 then
						slot13 = slot18
						uv0.duration_ = slot18 + slot12
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("116161003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_116161", "116161003", "story_v_out_116161.awb"))
					else
			...
			slot12 = slot12 + 0.3
			slot15 = uv0:FormatText(StoryWordCfg[116161003].content)
			slot17 = string.split(slot15, ".")
	...
	Play116161004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.bgs_.SK0106.transform

			if 2 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosSK0106 = slot7.localPosition
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161004", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161004", "story_v_out_116161.awb") / 1000 > 0 and slot13 < slot18 and uv0.duration_ < slot18 + slot12 then
						slot13 = slot18
						uv0.duration_ = slot18 + slot12
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("116161004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_116161", "116161004", "story_v_out_116161.awb"))
					else
			...
			slot12 = slot12 + 0.3
			slot15 = uv0:FormatText(StoryWordCfg[116161004].content)
			slot17 = string.split(slot15, ".")
	...
	Play116161005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.state_ = "playing"
		slot1.duration_ = 5.71666666666667
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2.01666666666667 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161005", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161005", "story_v_out_116161.awb") / 1000 > 0 and slot8 < slot13 and uv0.duration_ < slot13 + slot7 then
						slot8 = slot13
						uv0.duration_ = slot13 + slot7
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("116161005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116161", "116161005", "story_v_out_116161.awb"))
					else
			...
			slot7 = slot7 + 0.3
			slot10 = uv0:FormatText(StoryWordCfg[116161005].content)
	...
	Play116161006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161006].content)
				uv0.typewritter.percent = 0
			...
			slot5 = slot5 + 0.3
			slot8 = uv0:FormatText(StoryWordCfg[116161006].content)
	...
	Play116161007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161007].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161007].content)
	...
	Play116161008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161008", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161008", "story_v_out_116161.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("116161008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_116161", "116161008", "story_v_out_116161.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[116161008].content)
			slot17 = string.split(slot15, ".")
	...
	Play116161009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161009].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161009].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot13 = uv0.actors_["10025ui_story"]

			if 1 < uv0.time_ and uv0.time_ <= slot14 + slot0 and uv0.var_.characterEffect10025ui_story == nil then
				uv0.var_.characterEffect10025ui_story = slot13.GetComponentInChildren(slot13, typeof(CharacterEffect))
			end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				...
				if uv0.var_.characterEffect10025ui_story then
					...
					uv0.var_.characterEffect10025ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot16)
				end
			end
			...
			if 1 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161010].content)
				uv0.typewritter.percent = 0
			...
			slot16 = slot16 + 0.3
			slot19 = uv0:FormatText(StoryWordCfg[116161010].content)
	...
	Play116161011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161011", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161011", "story_v_out_116161.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116161011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116161", "116161011", "story_v_out_116161.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116161011].content)
	...
	Play116161012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161012].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161012].content)
	...
	Play116161013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161013", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161013", "story_v_out_116161.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116161013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116161", "116161013", "story_v_out_116161.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116161013].content)
	...
	Play116161014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161014].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161014].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161015].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161015].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161016].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161016].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161017", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161017", "story_v_out_116161.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116161017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116161", "116161017", "story_v_out_116161.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116161017].content)
			slot11 = string.split(slot9, ".")
	...
	Play116161019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161019].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161019].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161020", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161020", "story_v_out_116161.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116161020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116161", "116161020", "story_v_out_116161.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116161020].content)
			slot11 = string.split(slot9, ".")
	...
	Play116161021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161021].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161021].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot17 = uv0.actors_["1011ui_story"].transform

			if 3.8 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				uv0.var_.moveOldPos1011ui_story = slot17.localPosition
			end

			slot19 = 0.001

			if slot18 <= uv0.time_ and uv0.time_ < slot18 + slot19 then
				slot17.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(1.1, -0.76, -5.4), (uv0.time_ - slot18) / slot19)
			...
			if uv0.time_ >= slot18 + slot19 and uv0.time_ < slot18 + slot19 + slot0 then
				slot17.localPosition = Vector3.New(1.1, -0.76, -5.4)
			...
			slot21 = uv0.actors_["1011ui_story"]

			if 3.8 < uv0.time_ and uv0.time_ <= slot22 + slot0 and uv0.var_.characterEffect1011ui_story == nil then
				uv0.var_.characterEffect1011ui_story = slot21.GetComponentInChildren(slot21, typeof(CharacterEffect))
			end
			...
			if slot22 <= uv0.time_ and uv0.time_ < slot22 + slot23 then
				...
				if uv0.var_.characterEffect1011ui_story then
					...
					uv0.var_.characterEffect1011ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot24)
				end
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot28 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161022].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161022", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161022", "story_v_out_116161.awb") / 1000 > 0 and slot29 < slot34 and uv0.duration_ < slot34 + slot28 then
						slot29 = slot34
						uv0.duration_ = slot34 + slot28
					end

					if slot32.prefab_name ~= "" and uv0.actors_[slot32.prefab_name] ~= nil then
						uv0:RecordAudio("116161022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot32.prefab_name].transform, "story_v_out_116161", "116161022", "story_v_out_116161.awb"))
					else
			...
			slot28 = slot28 + 0.3
			slot31 = uv0:FormatText(StoryWordCfg[116161022].content)
	...
	Play116161023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161023].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161023].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161024", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161024", "story_v_out_116161.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("116161024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_116161", "116161024", "story_v_out_116161.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[116161024].content)
			slot10 = string.split(slot8, ".")
	...
	Play116161025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161025", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161025", "story_v_out_116161.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("116161025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_116161", "116161025", "story_v_out_116161.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[116161025].content)
	...
	Play116161026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161026].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161026", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161026", "story_v_out_116161.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116161026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116161", "116161026", "story_v_out_116161.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116161026].content)
			slot14 = string.split(slot12, ".")
	...
	Play116161027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161027].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161027", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161027", "story_v_out_116161.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("116161027", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116161", "116161027", "story_v_out_116161.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116161027].content)
	...
	Play116161028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161028].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161028", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161028", "story_v_out_116161.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116161028", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116161", "116161028", "story_v_out_116161.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116161028].content)
			slot14 = string.split(slot12, ".")
	...
	Play116161029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161029].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161029", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161029", "story_v_out_116161.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116161029", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116161", "116161029", "story_v_out_116161.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116161029].content)
			slot14 = string.split(slot12, ".")
	...
	Play116161030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161030].content)
				uv0.typewritter.percent = 0
			...
			slot15 = slot15 + 0.3
			slot18 = uv0:FormatText(StoryWordCfg[116161030].content)
			slot20 = string.split(slot18, ".")
	...
	Play116161031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161031].content)
				uv0.typewritter.percent = 0
			...
			slot8 = uv0:FormatText(StoryWordCfg[116161031].content)
			slot10 = string.split(slot8, ".")
	...
	Play116161032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161032].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161032", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161032", "story_v_out_116161.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116161032", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116161", "116161032", "story_v_out_116161.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116161032].content)
			slot14 = string.split(slot12, ".")
	...
	Play116161033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161033].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161033].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161034].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161034].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161035].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161035", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161035", "story_v_out_116161.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116161035", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116161", "116161035", "story_v_out_116161.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116161035].content)
			slot11 = string.split(slot9, ".")
	...
	Play116161036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161036].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161036].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161037].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161037", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161037", "story_v_out_116161.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116161037", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116161", "116161037", "story_v_out_116161.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116161037].content)
			slot11 = string.split(slot9, ".")
	...
	Play116161038 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161038].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161038].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161039 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161039].content)
				uv0.typewritter.percent = 0
			...
			slot5 = uv0:FormatText(StoryWordCfg[116161039].content)
	...
	Play116161040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161040].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161040", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161040", "story_v_out_116161.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116161040", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116161", "116161040", "story_v_out_116161.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116161040].content)
			slot11 = string.split(slot9, ".")
	...
	Play116161041 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161041].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161041].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161042 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161042].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161042].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161043 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161043].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161043].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161044 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161044].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161044].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161045 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161045].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[116161045].content)
	...
	Play116161046 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161046].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161046].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161047 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161047].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161047", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161047", "story_v_out_116161.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116161047", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116161", "116161047", "story_v_out_116161.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116161047].content)
			slot11 = string.split(slot9, ".")
	...
	Play116161048 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161048].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161048].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161049 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_10025")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161049].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161049", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161049", "story_v_out_116161.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("116161049", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116161", "116161049", "story_v_out_116161.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161049].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161050 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161050].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161050].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161051 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161051].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161051].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161052 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161052].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161052", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161052", "story_v_out_116161.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116161052", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116161", "116161052", "story_v_out_116161.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116161052].content)
			slot14 = string.split(slot12, ".")
	...
	Play116161053 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161053].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161053].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161054 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161054].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161054].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161055 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161055].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161055", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161055", "story_v_out_116161.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116161055", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116161", "116161055", "story_v_out_116161.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116161055].content)
			slot11 = string.split(slot9, ".")
	...
	Play116161056 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161056].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161056].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161057 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161057].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161057", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161057", "story_v_out_116161.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116161057", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116161", "116161057", "story_v_out_116161.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116161057].content)
			slot11 = string.split(slot9, ".")
	...
	Play116161058 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161058].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116161058].content)
			slot9 = string.split(slot7, ".")
	...
	Play116161059 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161059].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116161059].content)
			slot6 = string.split(slot4, ".")
	...
	Play116161060 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116161060].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116161", "116161060", "story_v_out_116161.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116161", "116161060", "story_v_out_116161.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116161060", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116161", "116161060", "story_v_out_116161.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116161060].content)
			slot11 = string.split(slot9, ".")
