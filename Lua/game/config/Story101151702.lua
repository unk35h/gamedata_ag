	...
	Play115172001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.999999999999 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172001].content)
			...
			slot12 = slot12 + 0.3
			slot15 = uv0:FormatText(StoryWordCfg[115172001].content)
	...
	Play115172002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172002].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[115172002].content)
	...
	Play115172003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172003].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_115172", "115172003", "story_v_out_115172.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
					slot11 = slot15
					uv0.duration_ = slot15 + slot10
				end

				if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
					uv0:RecordAudio("115172003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_115172", "115172003", "story_v_out_115172.awb"))
				else
			...
			slot13 = uv0:FormatText(StoryWordCfg[115172003].content)
	...
	Play115172004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172004].content)
				uv0.typewritter.percent = 0
			...
			slot9 = uv0:FormatText(StoryWordCfg[115172004].content)
	...
	Play115172005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172005].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_115172", "115172005", "story_v_out_115172.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
					slot6 = slot10
					uv0.duration_ = slot10 + slot5
				end

				if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
					uv0:RecordAudio("115172005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_115172", "115172005", "story_v_out_115172.awb"))
				else
			...
			slot8 = uv0:FormatText(StoryWordCfg[115172005].content)
	...
	Play115172006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172006].content)
				uv0.typewritter.percent = 0
			...
			slot9 = uv0:FormatText(StoryWordCfg[115172006].content)
			slot11 = string.split(slot9, ".")
	...
	Play115172007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_4029")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172007].content)
				uv0.typewritter.percent = 0
			...
			slot11 = uv0:FormatText(StoryWordCfg[115172007].content)
	...
	Play115172008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172008].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_115172", "115172008", "story_v_out_115172.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("115172008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_115172", "115172008", "story_v_out_115172.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[115172008].content)
			slot6 = string.split(slot4, ".")
	...
	Play115172009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172009].content)
				uv0.typewritter.percent = 0
			...
			slot5 = slot5 + 0.3
			slot8 = uv0:FormatText(StoryWordCfg[115172009].content)
			slot10 = string.split(slot8, ".")
	...
	Play115172010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172010].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_115172", "115172010", "story_v_out_115172.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
					slot11 = slot15
					uv0.duration_ = slot15 + slot10
				end

				if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
					uv0:RecordAudio("115172010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_115172", "115172010", "story_v_out_115172.awb"))
				else
			...
			slot13 = uv0:FormatText(StoryWordCfg[115172010].content)
			slot15 = string.split(slot13, ".")
	...
	Play115172011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1016ui_story, Vector3.New(1.1, -1, -5.6), (uv0.time_ - slot7) / slot8)
			...
			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 then
				slot6.localPosition = Vector3.New(1.1, -1, -5.6)
			...
			slot9 = uv0.actors_["1016ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect1016ui_story == nil then
				uv0.var_.characterEffect1016ui_story = slot9.GetComponentInChildren(slot9, typeof(CharacterEffect))
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172011].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_115172", "115172011", "story_v_out_115172.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
					slot13 = slot17
					uv0.duration_ = slot17 + slot12
				end

				if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
					uv0:RecordAudio("115172011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_115172", "115172011", "story_v_out_115172.awb"))
				else
			...
			slot15 = uv0:FormatText(StoryWordCfg[115172011].content)
			slot17 = string.split(slot15, ".")
	...
	Play115172012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				...
				if uv0.var_.characterEffect1016ui_story then
					uv0.var_.characterEffect1016ui_story.fillFlat = true
					uv0.var_.characterEffect1016ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot7)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172012].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_115172", "115172012", "story_v_out_115172.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("115172012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_115172", "115172012", "story_v_out_115172.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[115172012].content)
			slot13 = string.split(slot11, ".")
	...
	Play115172013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172013].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_115172", "115172013", "story_v_out_115172.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
					slot10 = slot14
					uv0.duration_ = slot14 + slot9
				end

				if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
					uv0:RecordAudio("115172013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_115172", "115172013", "story_v_out_115172.awb"))
				else
			...
			slot12 = uv0:FormatText(StoryWordCfg[115172013].content)
	...
	Play115172014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172014].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_115172", "115172014", "story_v_out_115172.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
					slot3 = slot7
					uv0.duration_ = slot7 + slot2
				end

				if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
					uv0:RecordAudio("115172014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_115172", "115172014", "story_v_out_115172.awb"))
				else
			...
			slot5 = uv0:FormatText(StoryWordCfg[115172014].content)
	...
	Play115172015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172015].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[115172015].content)
	...
	Play115172016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172016].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[115172016].content)
			slot6 = string.split(slot4, ".")
	...
	Play115172017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1052")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[115172017].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_115172", "115172017", "story_v_out_115172.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
					slot7 = slot11
					uv0.duration_ = slot11 + slot6
				end

				if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
					uv0:RecordAudio("115172017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_115172", "115172017", "story_v_out_115172.awb"))
				else
			...
			slot9 = uv0:FormatText(StoryWordCfg[115172017].content)
			slot11 = string.split(slot9, ".")
