	...
	Play900202003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv1.narr_chapter_text.text = uv0:FormatText(StoryWordCfg[900202001].content)
				uv1.narr_time_text.text = uv0:FormatText(StoryWordCfg[900202002].content)
			...
			if 0.0334 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv1.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1038_split_9")
				uv1.narr_item_content.text = uv0:FormatText(StoryWordCfg[900202003].content)
	...
	Play900202004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202004].content)
	...
	Play900202005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1033_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202005].content)
	...
	Play900202006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1119_1_split_4")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202006].content)
	...
	Play900202007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202007].content)
	...
	Play900202008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1033_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202008].content)
	...
	Play900202009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202009].content)
	...
	Play900202010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202010].content)
	...
	Play900202011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1033_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202011].content)
	...
	Play900202012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202012].content)
	...
	Play900202013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1033_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202013].content)
	...
	Play900202014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1033_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202014].content)
	...
	Play900202015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202015].content)
	...
	Play900202016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1119_1_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202016].content)
	...
	Play900202017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900202017].content)
