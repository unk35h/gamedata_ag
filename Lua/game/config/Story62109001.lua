	...
	Play62109001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62109001].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62109", "62109001", "story_v_chess_62109.awb") / 1000 > 0 and slot19 < slot24 and uv0.duration_ < slot24 + slot18 then
					slot19 = slot24
					uv0.duration_ = slot24 + slot18
				end

				if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
					uv0:RecordAudio("62109001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_chess_62109", "62109001", "story_v_chess_62109.awb"))
				else
			...
			slot18 = slot18 + 0.3
			slot21 = uv0:FormatText(StoryWordCfg[62109001].content)
	...
	Play62109002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62109002].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[62109002].content)
	...
	Play62109003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62109003].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[62109003].content)
	...
	Play62109004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62109004].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62109", "62109004", "story_v_chess_62109.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
					slot10 = slot14
					uv0.duration_ = slot14 + slot9
				end

				if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
					uv0:RecordAudio("62109004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_chess_62109", "62109004", "story_v_chess_62109.awb"))
				else
			...
			slot12 = uv0:FormatText(StoryWordCfg[62109004].content)
	...
	Play62109005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62109005].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[62109005].content)
			slot9 = string.split(slot7, ".")
	...
	Play62109006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62109006].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62109", "62109006", "story_v_chess_62109.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
					slot7 = slot11
					uv0.duration_ = slot11 + slot6
				end

				if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
					uv0:RecordAudio("62109006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_chess_62109", "62109006", "story_v_chess_62109.awb"))
				else
			...
			slot9 = uv0:FormatText(StoryWordCfg[62109006].content)
	...
	Play62109007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62109007].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62109", "62109007", "story_v_chess_62109.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
					slot4 = slot8
					uv0.duration_ = slot8 + slot3
				end

				if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
					uv0:RecordAudio("62109007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_chess_62109", "62109007", "story_v_chess_62109.awb"))
				else
			...
			slot6 = uv0:FormatText(StoryWordCfg[62109007].content)
	...
	Play62109008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62109008].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62109", "62109008", "story_v_chess_62109.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
					slot3 = slot7
					uv0.duration_ = slot7 + slot2
				end

				if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
					uv0:RecordAudio("62109008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_chess_62109", "62109008", "story_v_chess_62109.awb"))
				else
			...
			slot5 = uv0:FormatText(StoryWordCfg[62109008].content)
	...
	Play62109009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62109009].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[62109009].content)
			slot9 = string.split(slot7, ".")
