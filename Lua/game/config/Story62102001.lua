	...
	Play62102001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2030_tpose, Vector3.New(0, -1.25, -3.5), (uv0.time_ - slot7) / slot8)
			...
			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 then
				slot6.localPosition = Vector3.New(0, -1.25, -3.5)
			...
			slot10 = uv0.actors_["2030_tpose"]

			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 and uv0.var_.characterEffect2030_tpose == nil then
				uv0.var_.characterEffect2030_tpose = slot10.GetComponentInChildren(slot10, typeof(CharacterEffect))
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62102001].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62102", "62102001", "story_v_chess_62102.awb") / 1000 > 0 and slot18 < slot23 and uv0.duration_ < slot23 + slot17 then
					slot18 = slot23
					uv0.duration_ = slot23 + slot17
				end

				if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
					uv0:RecordAudio("62102001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_chess_62102", "62102001", "story_v_chess_62102.awb"))
				else
			...
			slot17 = slot17 + 0.3
			slot20 = uv0:FormatText(StoryWordCfg[62102001].content)
	...
	Play62101002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62102002].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[62102002].content)
	...
	Play62101003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62102003].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62102", "62102003", "story_v_chess_62102.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
					slot14 = slot18
					uv0.duration_ = slot18 + slot13
				end

				if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
					uv0:RecordAudio("62102003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_chess_62102", "62102003", "story_v_chess_62102.awb"))
				else
			...
			slot16 = uv0:FormatText(StoryWordCfg[62102003].content)
