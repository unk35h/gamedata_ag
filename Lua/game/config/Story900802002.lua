	...
	Play900802001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv1.narr_time_text.text = uv0:FormatText(StoryWordCfg[900802022].content)
			...
			if 0.0334 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv1.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1048")
				uv1.narr_item_content.text = uv0:FormatText(StoryWordCfg[900802001].content)
	...
	Play900802002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802002].content)
	...
	Play900802003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802003].content)
	...
	Play900802004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802004].content)
	...
	Play900802005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802005].content)
	...
	Play900802006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802006].content)
	...
	Play900802007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1059")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802007].content)
	...
	Play900802008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802008].content)
	...
	Play900802009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1059")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802009].content)
	...
	Play900802010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802010].content)
	...
	Play900802011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1059")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802011].content)
	...
	Play900802012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802012].content)
	...
	Play900802013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1059")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802013].content)
	...
	Play900802014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802014].content)
	...
	Play900802015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802015].content)
	...
	Play900802016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1059")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802016].content)
	...
	Play900802017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1048")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802017].content)
	...
	Play900802018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1059")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802018].content)
	...
	Play900802019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1048")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802019].content)
	...
	Play900802020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802020].content)
	...
	Play900802021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900802021].content)
