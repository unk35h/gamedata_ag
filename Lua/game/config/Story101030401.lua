return {
	Play103041001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041001].content)
			...
			slot11 = slot11 + 0.3
			slot14 = uv0:FormatText(StoryWordCfg[103041001].content)
	...
	Play103041002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041002", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041002", "story_v_out_103041.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103041002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103041", "103041002", "story_v_out_103041.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103041002].content)
	...
	Play103041003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041003", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041003", "story_v_out_103041.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("103041003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_103041", "103041003", "story_v_out_103041.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[103041003].content)
	...
	Play103041004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041004].content)
				uv0.typewritter.percent = 0
			...
			slot13 = uv0:FormatText(StoryWordCfg[103041004].content)
	...
	Play103041005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041005", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041005", "story_v_out_103041.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("103041005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_103041", "103041005", "story_v_out_103041.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[103041005].content)
			slot15 = string.split(slot13, ".")
	...
	Play103041006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041006", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041006", "story_v_out_103041.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("103041006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_103041", "103041006", "story_v_out_103041.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[103041006].content)
	...
	Play103041007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041007", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041007", "story_v_out_103041.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("103041007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_103041", "103041007", "story_v_out_103041.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[103041007].content)
	...
	Play103041008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos4010ui_story, Vector3.New(-1.1, -1.64, -4.6), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(-1.1, -1.64, -4.6)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041008", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041008", "story_v_out_103041.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("103041008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_103041", "103041008", "story_v_out_103041.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[103041008].content)
	...
	Play103041009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041009", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041009", "story_v_out_103041.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("103041009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_103041", "103041009", "story_v_out_103041.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[103041009].content)
			slot18 = string.split(slot16, ".")
	...
	Play103041010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041010", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041010", "story_v_out_103041.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103041010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103041", "103041010", "story_v_out_103041.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103041010].content)
			slot14 = string.split(slot12, ".")
	...
	Play103041011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019ui_story, Vector3.New(1.1, -1.13, -5.3), (uv0.time_ - slot12) / slot13)
				slot17 = manager.ui.mainCamera.transform.position - slot11.position
				slot11.forward = Vector3.New(slot17.x, slot17.y, slot17.z)
				slot18 = slot11.localEulerAngles
				slot18.z = 0
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(1.1, -1.13, -5.3)
				slot16 = manager.ui.mainCamera.transform.position - slot11.position
				slot11.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot11.localEulerAngles
				slot17.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041011", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041011", "story_v_out_103041.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("103041011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_103041", "103041011", "story_v_out_103041.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[103041011].content)
			slot21 = string.split(slot19, ".")
	...
	Play103041012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041012", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041012", "story_v_out_103041.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("103041012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103041", "103041012", "story_v_out_103041.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[103041012].content)
	...
	Play103041013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041013", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041013", "story_v_out_103041.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("103041013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_103041", "103041013", "story_v_out_103041.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[103041013].content)
			slot15 = string.split(slot13, ".")
	...
	Play103041014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103041014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103041", "103041014", "story_v_out_103041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103041", "103041014", "story_v_out_103041.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("103041014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_103041", "103041014", "story_v_out_103041.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[103041014].content)
			slot23 = string.split(slot21, ".")
