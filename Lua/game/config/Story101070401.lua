	...
	Play107041001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1050ui_story, Vector3.New(0.85, -1.16, -5.28), (uv0.time_ - slot11) / slot12)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[107041001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_107041", "107041001", "story_v_out_107041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_107041", "107041001", "story_v_out_107041.awb") / 1000 > 0 and slot16 < slot21 and uv0.duration_ < slot21 + slot15 then
						slot16 = slot21
						uv0.duration_ = slot21 + slot15
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("107041001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_107041", "107041001", "story_v_out_107041.awb"))
					else
			...
			slot15 = slot15 + 0.3
			slot18 = uv0:FormatText(StoryWordCfg[107041001].content)
	...
	Play107041002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[107041002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_107041", "107041002", "story_v_out_107041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_107041", "107041002", "story_v_out_107041.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("107041002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_107041", "107041002", "story_v_out_107041.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[107041002].content)
	...
	Play107041003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[107041003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_107041", "107041003", "story_v_out_107041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_107041", "107041003", "story_v_out_107041.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("107041003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_107041", "107041003", "story_v_out_107041.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[107041003].content)
			slot13 = string.split(slot11, ".")
	...
	Play107041004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[107041004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_107041", "107041004", "story_v_out_107041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_107041", "107041004", "story_v_out_107041.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("107041004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_107041", "107041004", "story_v_out_107041.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[107041004].content)
	...
	Play107041005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[107041005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_107041", "107041005", "story_v_out_107041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_107041", "107041005", "story_v_out_107041.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("107041005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_107041", "107041005", "story_v_out_107041.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[107041005].content)
	...
	Play107041006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[107041006].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[107041006].content)
	...
	Play107041007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[107041007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_107041", "107041007", "story_v_out_107041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_107041", "107041007", "story_v_out_107041.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("107041007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_107041", "107041007", "story_v_out_107041.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[107041007].content)
			slot10 = string.split(slot8, ".")
