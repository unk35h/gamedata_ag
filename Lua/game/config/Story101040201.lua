return {
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				if slot6.GetComponent(slot6, "SpriteRenderer") then
					uv0.var_.alphaOldValueB08c = slot8.material:GetColor("_Color").a
					uv0.var_.alphaMatValueB08c = slot8.material
				end
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot10 = Mathf.Lerp(uv0.var_.alphaOldValueB08c, 1, (uv0.time_ - slot7) / slot8)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021001].content)
			...
			slot12 = slot12 + 0.3
			slot15 = uv0:FormatText(StoryWordCfg[104021001].content)
	...
	Play104021002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021002", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021002", "story_v_out_104021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("104021002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104021", "104021002", "story_v_out_104021.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[104021002].content)
	...
	Play104021003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1013")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021003", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021003", "story_v_out_104021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("104021003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104021", "104021003", "story_v_out_104021.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[104021003].content)
			slot6 = string.split(slot4, ".")
	...
	Play104021005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1013")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021005", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021005", "story_v_out_104021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("104021005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104021", "104021005", "story_v_out_104021.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[104021005].content)
			slot6 = string.split(slot4, ".")
	...
	Play104021006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021006].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[104021006].content)
			slot6 = string.split(slot4, ".")
	...
	Play104021007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021007", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021007", "story_v_out_104021.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("104021007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104021", "104021007", "story_v_out_104021.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[104021007].content)
	...
	Play104021008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1013")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021008", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021008", "story_v_out_104021.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
						slot8 = slot12
						uv0.duration_ = slot12 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						uv0:RecordAudio("104021008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_104021", "104021008", "story_v_out_104021.awb"))
					else
			...
			slot10 = uv0:FormatText(StoryWordCfg[104021008].content)
	...
	Play104021009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021009].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[104021009].content)
	...
	Play104021010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021010].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[104021010].content)
			slot6 = string.split(slot4, ".")
	...
	Play104021011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021011", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021011", "story_v_out_104021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("104021011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104021", "104021011", "story_v_out_104021.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[104021011].content)
	...
	Play104021012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1013ui_story, Vector3.New(0.85, -0.78, -5.4), (uv0.time_ - slot9) / slot10)
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0.85, -0.78, -5.4)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021012", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021012", "story_v_out_104021.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("104021012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104021", "104021012", "story_v_out_104021.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[104021012].content)
	...
	Play104021013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021013", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021013", "story_v_out_104021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("104021013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104021", "104021013", "story_v_out_104021.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[104021013].content)
			slot14 = string.split(slot12, ".")
	...
	Play104021014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021014", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021014", "story_v_out_104021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("104021014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104021", "104021014", "story_v_out_104021.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[104021014].content)
			slot14 = string.split(slot12, ".")
	...
	Play104021015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021015", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021015", "story_v_out_104021.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("104021015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104021", "104021015", "story_v_out_104021.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[104021015].content)
			slot8 = string.split(slot6, ".")
	...
	Play104021016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021016", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021016", "story_v_out_104021.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("104021016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104021", "104021016", "story_v_out_104021.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[104021016].content)
			slot8 = string.split(slot6, ".")
	...
	Play104021017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021017", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021017", "story_v_out_104021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("104021017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104021", "104021017", "story_v_out_104021.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[104021017].content)
			slot14 = string.split(slot12, ".")
	...
	Play104021018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021018", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021018", "story_v_out_104021.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("104021018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104021", "104021018", "story_v_out_104021.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[104021018].content)
			slot8 = string.split(slot6, ".")
	...
	Play104021019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021019", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021019", "story_v_out_104021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("104021019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104021", "104021019", "story_v_out_104021.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[104021019].content)
			slot14 = string.split(slot12, ".")
	...
	Play104021020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021020", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021020", "story_v_out_104021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("104021020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104021", "104021020", "story_v_out_104021.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[104021020].content)
			slot14 = string.split(slot12, ".")
	...
	Play104021021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021021].content)
				uv0.typewritter.percent = 0
			...
			slot13 = uv0:FormatText(StoryWordCfg[104021021].content)
			slot15 = string.split(slot13, ".")
	...
	Play104021022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.actors_["2018_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPos2018_tpose = slot7.localPosition
			end

			slot9 = 0.001

			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2018_tpose, Vector3.New(0, -0.55, -0.1), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0, -0.55, -0.1)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021022].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021022", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021022", "story_v_out_104021.awb") / 1000 > 0 and slot12 < slot16 and uv0.duration_ < slot16 + slot11 then
						slot12 = slot16
						uv0.duration_ = slot16 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						uv0:RecordAudio("104021022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_104021", "104021022", "story_v_out_104021.awb"))
					else
			...
			slot14 = uv0:FormatText(StoryWordCfg[104021022].content)
	...
	Play104021023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.actors_["2018_tpose"]

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 and uv0.var_.characterEffect2018_tpose == nil then
				uv0.var_.characterEffect2018_tpose = slot7.GetComponentInChildren(slot7, typeof(CharacterEffect))
			end
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				...
				if uv0.var_.characterEffect2018_tpose then
					...
					uv0.var_.characterEffect2018_tpose.fillRatio = Mathf.Lerp(0, 0.5, slot10)
				end
			end
			...
			slot10 = uv0.actors_["2018_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.moveOldPos2018_tpose = slot10.localPosition
			end

			slot12 = 0.001

			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2018_tpose, Vector3.New(10, -0.55, -0.1), (uv0.time_ - slot11) / slot12)
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(10, -0.55, -0.1)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2022_tpose, Vector3.New(-1.92, -0.6, 0.3), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(-1.92, -0.6, 0.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021023", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021023", "story_v_out_104021.awb") / 1000 > 0 and slot18 < slot22 and uv0.duration_ < slot22 + slot17 then
						slot18 = slot22
						uv0.duration_ = slot22 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						uv0:RecordAudio("104021023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_104021", "104021023", "story_v_out_104021.awb"))
					else
			...
			slot20 = uv0:FormatText(StoryWordCfg[104021023].content)
	...
	Play104021024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021024", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021024", "story_v_out_104021.awb") / 1000 > 0 and slot15 < slot19 and uv0.duration_ < slot19 + slot14 then
						slot15 = slot19
						uv0.duration_ = slot19 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						uv0:RecordAudio("104021024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_104021", "104021024", "story_v_out_104021.awb"))
					else
			...
			slot17 = uv0:FormatText(StoryWordCfg[104021024].content)
	...
	Play104021025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.actors_["2021_tpose"]

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 and uv0.var_.characterEffect2021_tpose == nil then
				uv0.var_.characterEffect2021_tpose = slot1.GetComponentInChildren(slot1, typeof(CharacterEffect))
			end
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				...
				if uv0.var_.characterEffect2021_tpose then
					...
					uv0.var_.characterEffect2021_tpose.fillRatio = Mathf.Lerp(0, 0.5, slot4)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104021025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104021", "104021025", "story_v_out_104021.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104021", "104021025", "story_v_out_104021.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("104021025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104021", "104021025", "story_v_out_104021.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[104021025].content)
