	...
	Play900601003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv1.narr_chapter_text.text = uv0:FormatText(StoryWordCfg[900601001].content)
				uv1.narr_time_text.text = uv0:FormatText(StoryWordCfg[900601002].content)
			...
			if 0.0334 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv1.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1033_split_6")
				uv1.narr_item_content.text = uv0:FormatText(StoryWordCfg[900601003].content)
	...
	Play900601004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_10022_split_2")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601004].content)
	...
	Play900601005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_3022")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601005].content)
	...
	Play900601006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601006].content)
	...
	Play900601007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1038_split_9")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601007].content)
	...
	Play900601008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601008].content)
	...
	Play900601009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1119_1_split_6")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601009].content)
	...
	Play900601010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601010].content)
	...
	Play900601011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1038_split_9")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601011].content)
	...
	Play900601012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_10026_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601012].content)
	...
	Play900601013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_10026_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601013].content)
	...
	Play900601014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_10026_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601014].content)
	...
	Play900601015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1038_split_5")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601015].content)
	...
	Play900601016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1033_split_5")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601016].content)
	...
	Play900601017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1119_1_split_6")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601017].content)
	...
	Play900601018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_10026_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601018].content)
	...
	Play900601019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601019].content)
	...
	Play900601020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1033_split_6")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601020].content)
	...
	Play900601021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900601021].content)
