return {
	Play110151001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151001", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151001", "story_v_out_110151.awb") / 1000 > 0 and slot21 < slot26 and uv0.duration_ < slot26 + slot20 then
						slot21 = slot26
						uv0.duration_ = slot26 + slot20
					end

					if slot24.prefab_name ~= "" and uv0.actors_[slot24.prefab_name] ~= nil then
						uv0:RecordAudio("110151001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot24.prefab_name].transform, "story_v_out_110151", "110151001", "story_v_out_110151.awb"))
					else
			...
			slot20 = slot20 + 0.3
			slot23 = uv0:FormatText(StoryWordCfg[110151001].content)
	...
	Play110151002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151002].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110151002].content)
	...
	Play110151003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151003", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151003", "story_v_out_110151.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("110151003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_110151", "110151003", "story_v_out_110151.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[110151003].content)
	...
	Play110151004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151004", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151004", "story_v_out_110151.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("110151004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_110151", "110151004", "story_v_out_110151.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[110151004].content)
	...
	Play110151005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151005", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151005", "story_v_out_110151.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("110151005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_110151", "110151005", "story_v_out_110151.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[110151005].content)
			slot18 = string.split(slot16, ".")
	...
	Play110151006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151006", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151006", "story_v_out_110151.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("110151006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_110151", "110151006", "story_v_out_110151.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[110151006].content)
			slot17 = string.split(slot15, ".")
	...
	Play110151007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot9 = uv0.actors_["1111ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect1111ui_story == nil then
				uv0.var_.characterEffect1111ui_story = slot9.GetComponentInChildren(slot9, typeof(CharacterEffect))
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151007", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151007", "story_v_out_110151.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("110151007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_110151", "110151007", "story_v_out_110151.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[110151007].content)
			slot17 = string.split(slot15, ".")
	...
	Play110151008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151008].content)
				uv0.typewritter.percent = 0
			...
			slot12 = uv0:FormatText(StoryWordCfg[110151008].content)
	...
	Play110151009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151009", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151009", "story_v_out_110151.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("110151009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_110151", "110151009", "story_v_out_110151.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[110151009].content)
			slot9 = string.split(slot7, ".")
	...
	Play110151010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151010].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151010].content)
	...
	Play110151011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151011", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151011", "story_v_out_110151.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("110151011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_110151", "110151011", "story_v_out_110151.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[110151011].content)
			slot14 = string.split(slot12, ".")
	...
	Play110151012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151012].content)
				uv0.typewritter.percent = 0
			...
			slot12 = uv0:FormatText(StoryWordCfg[110151012].content)
			slot14 = string.split(slot12, ".")
	...
	Play110151013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151013].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151013].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot8 = uv0.bgs_.OS0103.transform

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPosOS0103 = slot8.localPosition
			end
			...
			slot11 = uv0.bgs_.OS0103.transform

			if 0.034 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0.var_.moveOldPosOS0103 = slot11.localPosition
			end
			...
			if 2.933999999999 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151014].content)
				uv0.typewritter.percent = 0
			...
			slot16 = slot16 + 0.3
			slot19 = uv0:FormatText(StoryWordCfg[110151014].content)
	...
	Play110151015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1184")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151015", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151015", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151015", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151015].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151016", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151016", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151016", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151016].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151017", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151017", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151017", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151017].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151018].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151018].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1111")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151019", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151019", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151019", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151019].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151020", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151020", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151020", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151020].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1184")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151021].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151021", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151021", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151021", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151021].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151022].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151022", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151022", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151022", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151022].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151023", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151023", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151023", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151023].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151024", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151024", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151024", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151024].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151025", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151025", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151025", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151025].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1111")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151026].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151026", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151026", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151026", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151026].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1111")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151027].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151027", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151027", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151027", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151027", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151027].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1111")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151028].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151028", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151028", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151028", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151028", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151028].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151029].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151029", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151029", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151029", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151029", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151029].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151030].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151030", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151030", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151030", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151030", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151030].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151031].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151031", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151031", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151031", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151031", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151031].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151032].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151032", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151032", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151032", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151032", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151032].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1184")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151033].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151033", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151033", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151033", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151033", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151033].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151034].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151034", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151034", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151034", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151034", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151034].content)
			slot6 = string.split(slot4, ".")
	...
	Play110151035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110151035].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110151", "110151035", "story_v_out_110151.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110151", "110151035", "story_v_out_110151.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110151035", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110151", "110151035", "story_v_out_110151.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110151035].content)
			slot6 = string.split(slot4, ".")
