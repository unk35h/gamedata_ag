return {
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				if slot8.GetComponent(slot8, "SpriteRenderer") then
					uv0.var_.alphaOldValueB02c = slot10.material:GetColor("_Color").a
					uv0.var_.alphaMatValueB02c = slot10.material
				end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot12 = Mathf.Lerp(uv0.var_.alphaOldValueB02c, 1, (uv0.time_ - slot9) / slot10)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101001", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101001", "story_v_out_102101.awb") / 1000 > 0 and slot20 < slot25 and uv0.duration_ < slot25 + slot19 then
						slot20 = slot25
						uv0.duration_ = slot25 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						uv0:RecordAudio("102101001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_102101", "102101001", "story_v_out_102101.awb"))
					else
			...
			slot19 = slot19 + 0.3
			slot22 = uv0:FormatText(StoryWordCfg[102101001].content)
	...
	Play102101002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101002", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101002", "story_v_out_102101.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102101002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102101", "102101002", "story_v_out_102101.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102101002].content)
	...
	Play102101003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101003", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101003", "story_v_out_102101.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("102101003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102101", "102101003", "story_v_out_102101.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[102101003].content)
	...
	Play102101004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101004", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101004", "story_v_out_102101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102101004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102101", "102101004", "story_v_out_102101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102101004].content)
	...
	Play102101005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101005", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101005", "story_v_out_102101.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("102101005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_102101", "102101005", "story_v_out_102101.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[102101005].content)
	...
	Play102101006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101006", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101006", "story_v_out_102101.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("102101006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_102101", "102101006", "story_v_out_102101.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[102101006].content)
			slot7 = string.split(slot5, ".")
	...
	Play102101007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101007", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101007", "story_v_out_102101.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("102101007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_102101", "102101007", "story_v_out_102101.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[102101007].content)
	...
	Play102101008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101008", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101008", "story_v_out_102101.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102101008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102101", "102101008", "story_v_out_102101.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102101008].content)
			slot20 = string.split(slot18, ".")
	...
	Play102101009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101009", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101009", "story_v_out_102101.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("102101009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_102101", "102101009", "story_v_out_102101.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[102101009].content)
			slot7 = string.split(slot5, ".")
	...
	Play102101010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot8 = uv0.actors_["10002_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPos10002_tpose = slot8.localPosition
			end

			slot10 = 0.001

			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(10, -1.25, -5.2), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(10, -1.25, -5.2)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(0.85, -1.16, -5), (uv0.time_ - slot13) / slot14)
				slot18 = manager.ui.mainCamera.transform.position - slot12.position
				slot12.forward = Vector3.New(slot18.x, slot18.y, slot18.z)
				slot19 = slot12.localEulerAngles
				slot19.z = 0
			...
			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 then
				slot12.localPosition = Vector3.New(0.85, -1.16, -5)
				slot17 = manager.ui.mainCamera.transform.position - slot12.position
				slot12.forward = Vector3.New(slot17.x, slot17.y, slot17.z)
				slot18 = slot12.localEulerAngles
				slot18.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101010", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101010", "story_v_out_102101.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("102101010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102101", "102101010", "story_v_out_102101.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[102101010].content)
			slot21 = string.split(slot19, ".")
	...
	Play102101011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101011", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101011", "story_v_out_102101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102101011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102101", "102101011", "story_v_out_102101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102101011].content)
			slot14 = string.split(slot12, ".")
	...
	Play102101012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101012", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101012", "story_v_out_102101.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102101012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102101", "102101012", "story_v_out_102101.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102101012].content)
			slot20 = string.split(slot18, ".")
	...
	Play102101013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101013", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101013", "story_v_out_102101.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102101013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102101", "102101013", "story_v_out_102101.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102101013].content)
			slot20 = string.split(slot18, ".")
	...
	Play102101014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101014", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101014", "story_v_out_102101.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("102101014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102101", "102101014", "story_v_out_102101.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[102101014].content)
	...
	Play102101015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101015", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101015", "story_v_out_102101.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("102101015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102101", "102101015", "story_v_out_102101.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[102101015].content)
			slot17 = string.split(slot15, ".")
	...
	Play102101016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(-0.85, -0.76, -5.4), (uv0.time_ - slot15) / slot16)
			...
			if uv0.time_ >= slot15 + slot16 and uv0.time_ < slot15 + slot16 + slot0 then
				slot14.localPosition = Vector3.New(-0.85, -0.76, -5.4)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101016", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101016", "story_v_out_102101.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("102101016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102101", "102101016", "story_v_out_102101.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[102101016].content)
	...
	Play102101017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101017", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101017", "story_v_out_102101.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("102101017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102101", "102101017", "story_v_out_102101.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[102101017].content)
			slot17 = string.split(slot15, ".")
	...
	Play102101018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101018", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101018", "story_v_out_102101.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102101018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102101", "102101018", "story_v_out_102101.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102101018].content)
			slot20 = string.split(slot18, ".")
	...
	Play102101019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101019].content)
				uv0.typewritter.percent = 0
			...
			slot17 = uv0:FormatText(StoryWordCfg[102101019].content)
	...
	Play102101020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101020", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101020", "story_v_out_102101.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("102101020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_102101", "102101020", "story_v_out_102101.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[102101020].content)
	...
	Play102101021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101021].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101021", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101021", "story_v_out_102101.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("102101021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102101", "102101021", "story_v_out_102101.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[102101021].content)
	...
	Play102101022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101022].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101022", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101022", "story_v_out_102101.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102101022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102101", "102101022", "story_v_out_102101.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102101022].content)
			slot20 = string.split(slot18, ".")
	...
	Play102101023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101023", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101023", "story_v_out_102101.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("102101023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102101", "102101023", "story_v_out_102101.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[102101023].content)
			slot21 = string.split(slot19, ".")
	...
	Play102101024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101024", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101024", "story_v_out_102101.awb") / 1000 > 0 and slot15 < slot19 and uv0.duration_ < slot19 + slot14 then
						slot15 = slot19
						uv0.duration_ = slot19 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						uv0:RecordAudio("102101024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_102101", "102101024", "story_v_out_102101.awb"))
					else
			...
			slot17 = uv0:FormatText(StoryWordCfg[102101024].content)
			slot19 = string.split(slot17, ".")
	...
	Play102101025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102101025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102101", "102101025", "story_v_out_102101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102101", "102101025", "story_v_out_102101.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("102101025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102101", "102101025", "story_v_out_102101.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[102101025].content)
			slot8 = string.split(slot6, ".")
