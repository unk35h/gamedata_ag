	...
	Play900501003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv1.narr_chapter_text.text = uv0:FormatText(StoryWordCfg[900501001].content)
				uv1.narr_time_text.text = uv0:FormatText(StoryWordCfg[900501002].content)
			...
			if 0.0334 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv1.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_10022_split_1")
				uv1.narr_item_content.text = uv0:FormatText(StoryWordCfg[900501003].content)
	...
	Play900501004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501004].content)
	...
	Play900501005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1033_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501005].content)
	...
	Play900501006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501006].content)
	...
	Play900501007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501007].content)
	...
	Play900501008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1119_1_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501008].content)
	...
	Play900501009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1119_1_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501009].content)
	...
	Play900501010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1119_1_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501010].content)
	...
	Play900501011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1033_split_1")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501011].content)
	...
	Play900501012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501012].content)
	...
	Play900501013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501013].content)
	...
	Play900501014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_head.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1033_split_6")
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501014].content)
	...
	Play900501015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv1.time_ and uv1.time_ <= slot1 + slot0 then
				...
				uv0.narr_item_content.text = uv1:FormatText(StoryWordCfg[900501015].content)
