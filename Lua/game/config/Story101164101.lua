return {
	Play116411001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411001].content)
			...
			slot11 = slot11 + 0.3
			slot14 = uv0:FormatText(StoryWordCfg[116411001].content)
	...
	Play116411002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411002", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411002", "story_v_out_116411.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("116411002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_116411", "116411002", "story_v_out_116411.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[116411002].content)
	...
	Play116411003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411003].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116411003].content)
	...
	Play116411004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411004", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411004", "story_v_out_116411.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116411004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411004", "story_v_out_116411.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116411004].content)
	...
	Play116411005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411005].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116411005].content)
			slot9 = string.split(slot7, ".")
	...
	Play116411006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411006].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116411006].content)
	...
	Play116411007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411007].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116411007].content)
			slot6 = string.split(slot4, ".")
	...
	Play116411008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411008].content)
				uv0.typewritter.percent = 0
			...
			slot8 = slot8 + 0.3
			slot11 = uv0:FormatText(StoryWordCfg[116411008].content)
	...
	Play116411009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411009", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411009", "story_v_out_116411.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116411009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411009", "story_v_out_116411.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116411009].content)
			slot14 = string.split(slot12, ".")
	...
	Play116411010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411010].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116411010].content)
			slot9 = string.split(slot7, ".")
	...
	Play116411011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot9 = uv0.actors_["10025ui_story"].transform

			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0.var_.moveOldPos10025ui_story = slot9.localPosition
			end

			slot11 = 0.001

			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(0, -1.15, -5.3), (uv0.time_ - slot10) / slot11)
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 then
				slot9.localPosition = Vector3.New(0, -1.15, -5.3)
			...
			slot12 = uv0.actors_["10025ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.var_.moveOldPos10025ui_story = slot12.localPosition
			end
			...
			slot15 = uv0.actors_["10025ui_story"]

			if 2 < uv0.time_ and uv0.time_ <= slot16 + slot0 and uv0.var_.characterEffect10025ui_story == nil then
				uv0.var_.characterEffect10025ui_story = slot15.GetComponentInChildren(slot15, typeof(CharacterEffect))
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411011", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411011", "story_v_out_116411.awb") / 1000 > 0 and slot21 < slot26 and uv0.duration_ < slot26 + slot20 then
						slot21 = slot26
						uv0.duration_ = slot26 + slot20
					end

					if slot24.prefab_name ~= "" and uv0.actors_[slot24.prefab_name] ~= nil then
						uv0:RecordAudio("116411011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot24.prefab_name].transform, "story_v_out_116411", "116411011", "story_v_out_116411.awb"))
					else
			...
			slot20 = slot20 + 0.3
			slot23 = uv0:FormatText(StoryWordCfg[116411011].content)
	...
	Play116411012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411012].content)
				uv0.typewritter.percent = 0
			...
			slot10 = slot10 + 0.3
			slot13 = uv0:FormatText(StoryWordCfg[116411012].content)
			slot15 = string.split(slot13, ".")
	...
	Play116411013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411013", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411013", "story_v_out_116411.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("116411013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116411", "116411013", "story_v_out_116411.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116411013].content)
			slot6 = string.split(slot4, ".")
	...
	Play116411014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411014", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411014", "story_v_out_116411.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116411014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411014", "story_v_out_116411.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116411014].content)
			slot14 = string.split(slot12, ".")
	...
	Play116411015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_shadowm")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411015", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411015", "story_v_out_116411.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("116411015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116411", "116411015", "story_v_out_116411.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[116411015].content)
			slot9 = string.split(slot7, ".")
	...
	Play116411016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411016", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411016", "story_v_out_116411.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116411016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411016", "story_v_out_116411.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116411016].content)
			slot14 = string.split(slot12, ".")
	...
	Play116411017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411017].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116411017].content)
			slot9 = string.split(slot7, ".")
	...
	Play116411018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411018", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411018", "story_v_out_116411.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("116411018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116411", "116411018", "story_v_out_116411.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116411018].content)
			slot13 = string.split(slot11, ".")
	...
	Play116411019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot11 = uv0.actors_["10025ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0.var_.moveOldPos10025ui_story = slot11.localPosition
			end
			...
			slot16 = uv0.actors_["10025ui_story"]

			if 3.8 < uv0.time_ and uv0.time_ <= slot17 + slot0 and uv0.var_.characterEffect10025ui_story == nil then
				uv0.var_.characterEffect10025ui_story = slot16.GetComponentInChildren(slot16, typeof(CharacterEffect))
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411019", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411019", "story_v_out_116411.awb") / 1000 > 0 and slot20 < slot25 and uv0.duration_ < slot25 + slot19 then
						slot20 = slot25
						uv0.duration_ = slot25 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						uv0:RecordAudio("116411019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_116411", "116411019", "story_v_out_116411.awb"))
					else
			...
			slot19 = slot19 + 0.3
			slot22 = uv0:FormatText(StoryWordCfg[116411019].content)
	...
	Play116411020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411020].content)
				uv0.typewritter.percent = 0
			...
			slot10 = slot10 + 0.3
			slot13 = uv0:FormatText(StoryWordCfg[116411020].content)
			slot15 = string.split(slot13, ".")
	...
	Play116411021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411021].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411021", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411021", "story_v_out_116411.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116411021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411021", "story_v_out_116411.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116411021].content)
			slot14 = string.split(slot12, ".")
	...
	Play116411022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411022].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116411022].content)
			slot9 = string.split(slot7, ".")
	...
	Play116411023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3.99999999999999 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411023", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411023", "story_v_out_116411.awb") / 1000 > 0 and slot20 < slot25 and uv0.duration_ < slot25 + slot19 then
						slot20 = slot25
						uv0.duration_ = slot25 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						uv0:RecordAudio("116411023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_116411", "116411023", "story_v_out_116411.awb"))
					else
			...
			slot19 = slot19 + 0.3
			slot22 = uv0:FormatText(StoryWordCfg[116411023].content)
			slot24 = string.split(slot22, ".")
	...
	Play116411024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411024", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411024", "story_v_out_116411.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116411024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411024", "story_v_out_116411.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116411024].content)
			slot14 = string.split(slot12, ".")
	...
	Play116411025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411025].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116411025].content)
			slot9 = string.split(slot7, ".")
	...
	Play116411026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411026].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116411", "116411026", "story_v_out_116411.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116411", "116411026", "story_v_out_116411.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116411026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116411", "116411026", "story_v_out_116411.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116411026].content)
			slot14 = string.split(slot12, ".")
	...
	Play116411027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot4 = uv0.bgs_.I05f.transform

			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPosI05f = slot4.localPosition
			end
			...
			if 1.23333333333333 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411027].content)
				uv0.typewritter.percent = 0
			...
			slot12 = slot12 + 0.3
			slot15 = uv0:FormatText(StoryWordCfg[116411027].content)
	...
	Play116411028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411028].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116411028].content)
			slot6 = string.split(slot4, ".")
	...
	Play116411029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411029].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116411029].content)
			slot6 = string.split(slot4, ".")
	...
	Play116411030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116411030].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[116411030].content)
