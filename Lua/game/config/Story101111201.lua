return {
	Play111121001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121001].content)
			...
			slot6 = slot6 + 0.3
			slot9 = uv0:FormatText(StoryWordCfg[111121001].content)
	...
	Play111121002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121002].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[111121002].content)
	...
	Play111121004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121004", "story_v_out_111121.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111121", "111121004", "story_v_out_111121.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("111121004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111121", "111121004", "story_v_out_111121.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[111121004].content)
			slot6 = string.split(slot4, ".")
	...
	Play111121005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121005", "story_v_out_111121.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111121", "111121005", "story_v_out_111121.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("111121005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111121", "111121005", "story_v_out_111121.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[111121005].content)
			slot6 = string.split(slot4, ".")
	...
	Play111121006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121006", "story_v_out_111121.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111121", "111121006", "story_v_out_111121.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("111121006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_111121", "111121006", "story_v_out_111121.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[111121006].content)
	...
	Play111121007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot8 = uv0.actors_["1094ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 and uv0.var_.characterEffect1094ui_story == nil then
				uv0.var_.characterEffect1094ui_story = slot8.GetComponentInChildren(slot8, typeof(CharacterEffect))
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				...
				if uv0.var_.characterEffect1094ui_story then
					...
					uv0.var_.characterEffect1094ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot11)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121007", "story_v_out_111121.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111121", "111121007", "story_v_out_111121.awb") / 1000 > 0 and slot12 < slot17 and uv0.duration_ < slot17 + slot11 then
						slot12 = slot17
						uv0.duration_ = slot17 + slot11
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("111121007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_111121", "111121007", "story_v_out_111121.awb"))
					else
			...
			slot11 = slot11 + 0.3
			slot14 = uv0:FormatText(StoryWordCfg[111121007].content)
	...
	Play111121008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121008", "story_v_out_111121.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111121", "111121008", "story_v_out_111121.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("111121008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111121", "111121008", "story_v_out_111121.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[111121008].content)
	...
	Play111121009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121009].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111121009].content)
	...
	Play111121010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121010].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[111121010].content)
			slot6 = string.split(slot4, ".")
	...
	Play111121011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				slot7 = Mathf.Lerp(uv0.var_.alphaOldValueD09a, 0, (uv0.time_ - slot4) / slot5)
			...
			slot6 = uv0.bgs_.D10_1

			if 1.5 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				if slot6.GetComponent(slot6, "SpriteRenderer") then
					uv0.var_.alphaOldValueD10_1 = slot8.material:GetColor("_Color").a
					uv0.var_.alphaMatValueD10_1 = slot8.material
				end
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot10 = Mathf.Lerp(uv0.var_.alphaOldValueD10_1, 1, (uv0.time_ - slot7) / slot8)
			...
			if 3 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121011].content)
				uv0.typewritter.percent = 0
			...
			slot14 = slot14 + 0.3
			slot17 = uv0:FormatText(StoryWordCfg[111121011].content)
	...
	Play111121012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121012].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[111121012].content)
			slot6 = string.split(slot4, ".")
	...
	Play111121013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121013", "story_v_out_111121.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111121", "111121013", "story_v_out_111121.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("111121013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111121", "111121013", "story_v_out_111121.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[111121013].content)
	...
	Play111121014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111121014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111121", "111121014", "story_v_out_111121.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111121", "111121014", "story_v_out_111121.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("111121014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_111121", "111121014", "story_v_out_111121.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[111121014].content)
			slot9 = string.split(slot7, ".")
