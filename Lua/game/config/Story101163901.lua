return {
	Play116391001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391001].content)
			...
			slot13 = slot13 + 0.3
			slot16 = uv0:FormatText(StoryWordCfg[116391001].content)
	...
	Play116391002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391002].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391002].content)
	...
	Play116391003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391003].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391003].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391004].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391004].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391005", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391005", "story_v_out_116391.awb") / 1000 > 0 and slot14 < slot19 and uv0.duration_ < slot19 + slot13 then
						slot14 = slot19
						uv0.duration_ = slot19 + slot13
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						uv0:RecordAudio("116391005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_116391", "116391005", "story_v_out_116391.awb"))
					else
			...
			slot13 = slot13 + 0.3
			slot16 = uv0:FormatText(StoryWordCfg[116391005].content)
			slot18 = string.split(slot16, ".")
	...
	Play116391006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391006].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116391006].content)
	...
	Play116391007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391007].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391007].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391008].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391008].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391009].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391009].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391010", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391010", "story_v_out_116391.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116391010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116391", "116391010", "story_v_out_116391.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116391010].content)
	...
	Play116391011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391011].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116391011].content)
			slot9 = string.split(slot7, ".")
	...
	Play116391012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391012].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[116391012].content)
	...
	Play116391013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391013].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[116391013].content)
			slot8 = string.split(slot6, ".")
	...
	Play116391014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391014", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391014", "story_v_out_116391.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
						slot8 = slot12
						uv0.duration_ = slot12 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						uv0:RecordAudio("116391014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_116391", "116391014", "story_v_out_116391.awb"))
					else
			...
			slot10 = uv0:FormatText(StoryWordCfg[116391014].content)
	...
	Play116391015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391015].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391015].content)
			slot6 = string.split(slot4, ".")
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				...
				if uv0.var_.characterEffect10025ui_story then
					...
					uv0.var_.characterEffect10025ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot10)
				end
			end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10024ui_story, Vector3.New(-1.1, -1.05, -5.4), (uv0.time_ - slot11) / slot12)
			...
			slot13 = uv0.actors_["10025ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPos10025ui_story = slot13.localPosition
			end

			slot15 = 0.001

			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(1.1, -1.15, -5.3), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(1.1, -1.15, -5.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391016", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391016", "story_v_out_116391.awb") / 1000 > 0 and slot18 < slot22 and uv0.duration_ < slot22 + slot17 then
						slot18 = slot22
						uv0.duration_ = slot22 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						uv0:RecordAudio("116391016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_116391", "116391016", "story_v_out_116391.awb"))
					else
			...
			slot20 = uv0:FormatText(StoryWordCfg[116391016].content)
	...
	Play116391017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391017", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391017", "story_v_out_116391.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116391017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116391", "116391017", "story_v_out_116391.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116391017].content)
	...
	Play116391018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(1.1, -1.15, -5.3), (uv0.time_ - slot5) / slot6)
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(1.1, -1.15, -5.3)
			...
			slot9 = uv0.actors_["10024ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect10024ui_story == nil then
				uv0.var_.characterEffect10024ui_story = slot9.GetComponentInChildren(slot9, typeof(CharacterEffect))
			end
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				...
				if uv0.var_.characterEffect10024ui_story then
					...
					uv0.var_.characterEffect10024ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot12)
				end
			end
			...
			slot12 = uv0.actors_["10025ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 and uv0.var_.characterEffect10025ui_story == nil then
				uv0.var_.characterEffect10025ui_story = slot12.GetComponentInChildren(slot12, typeof(CharacterEffect))
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391018", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391018", "story_v_out_116391.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("116391018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_116391", "116391018", "story_v_out_116391.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[116391018].content)
	...
	Play116391019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391019", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391019", "story_v_out_116391.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116391019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116391", "116391019", "story_v_out_116391.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116391019].content)
			slot14 = string.split(slot12, ".")
	...
	Play116391020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391020].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[116391020].content)
			slot12 = string.split(slot10, ".")
	...
	Play116391021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(1.1, -1.15, -5.3), (uv0.time_ - slot10) / slot11)
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 then
				slot9.localPosition = Vector3.New(1.1, -1.15, -5.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391021].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391021", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391021", "story_v_out_116391.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("116391021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_116391", "116391021", "story_v_out_116391.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[116391021].content)
	...
	Play116391022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391022].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391022", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391022", "story_v_out_116391.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("116391022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116391", "116391022", "story_v_out_116391.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[116391022].content)
	...
	Play116391023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391023", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391023", "story_v_out_116391.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("116391023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116391", "116391023", "story_v_out_116391.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[116391023].content)
			slot8 = string.split(slot6, ".")
	...
	Play116391024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391024", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391024", "story_v_out_116391.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("116391024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116391", "116391024", "story_v_out_116391.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[116391024].content)
			slot7 = string.split(slot5, ".")
	...
	Play116391025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot9 = uv0.actors_["10024ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0.var_.moveOldPos10024ui_story = slot9.localPosition
			end

			slot11 = 0.001

			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10024ui_story, Vector3.New(-1.1, -1.05, -5.4), (uv0.time_ - slot10) / slot11)
				slot15 = manager.ui.mainCamera.transform.position - slot9.position
				slot9.forward = Vector3.New(slot15.x, slot15.y, slot15.z)
				slot16 = slot9.localEulerAngles
				slot16.z = 0
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(1.1, -1.15, -5.3), (uv0.time_ - slot13) / slot14)
			...
			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 then
				slot12.localPosition = Vector3.New(1.1, -1.15, -5.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391025", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391025", "story_v_out_116391.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("116391025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_116391", "116391025", "story_v_out_116391.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[116391025].content)
			slot20 = string.split(slot18, ".")
	...
	Play116391026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				...
				if uv0.var_.characterEffect10025ui_story then
					uv0.var_.characterEffect10025ui_story.fillFlat = true
					uv0.var_.characterEffect10025ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot14)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391026].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391026", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391026", "story_v_out_116391.awb") / 1000 > 0 and slot15 < slot19 and uv0.duration_ < slot19 + slot14 then
						slot15 = slot19
						uv0.duration_ = slot19 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						uv0:RecordAudio("116391026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_116391", "116391026", "story_v_out_116391.awb"))
					else
			...
			slot17 = uv0:FormatText(StoryWordCfg[116391026].content)
	...
	Play116391027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391027].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391027", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391027", "story_v_out_116391.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("116391027", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116391", "116391027", "story_v_out_116391.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[116391027].content)
			slot8 = string.split(slot6, ".")
	...
	Play116391028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391028].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391028", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391028", "story_v_out_116391.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("116391028", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116391", "116391028", "story_v_out_116391.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[116391028].content)
			slot7 = string.split(slot5, ".")
	...
	Play116391029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = uv0.actors_["10024ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 and uv0.var_.characterEffect10024ui_story == nil then
				uv0.var_.characterEffect10024ui_story = slot2.GetComponentInChildren(slot2, typeof(CharacterEffect))
			end
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				...
				if uv0.var_.characterEffect10024ui_story then
					uv0.var_.characterEffect10024ui_story.fillFlat = true
					uv0.var_.characterEffect10024ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot5)
				end
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10024ui_story, Vector3.New(-1.1, -1.05, -5.4), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10025ui_story, Vector3.New(1.1, -1.15, -5.3), (uv0.time_ - slot12) / slot13)
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(1.1, -1.15, -5.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391029].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391029", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391029", "story_v_out_116391.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("116391029", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_116391", "116391029", "story_v_out_116391.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[116391029].content)
			slot20 = string.split(slot18, ".")
	...
	Play116391030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391030].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391030", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391030", "story_v_out_116391.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("116391030", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116391", "116391030", "story_v_out_116391.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[116391030].content)
			slot7 = string.split(slot5, ".")
	...
	Play116391031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391031].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391031", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391031", "story_v_out_116391.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("116391031", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_116391", "116391031", "story_v_out_116391.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[116391031].content)
			slot20 = string.split(slot18, ".")
	...
	Play116391032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391032].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116391032].content)
			slot9 = string.split(slot7, ".")
	...
	Play116391033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391033].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391033", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391033", "story_v_out_116391.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("116391033", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_116391", "116391033", "story_v_out_116391.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[116391033].content)
			slot17 = string.split(slot15, ".")
	...
	Play116391034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391034].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391034", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391034", "story_v_out_116391.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("116391034", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116391", "116391034", "story_v_out_116391.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[116391034].content)
			slot8 = string.split(slot6, ".")
	...
	Play116391035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391035].content)
				uv0.typewritter.percent = 0
			...
			slot13 = slot13 + 0.3
			slot16 = uv0:FormatText(StoryWordCfg[116391035].content)
			slot18 = string.split(slot16, ".")
	...
	Play116391036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_116391", "116391036", "story_v_out_116391.awb") / 1000 > 0 and slot2 < slot3 and uv0.duration_ < slot3 + slot1 then
				slot2 = slot3
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391036].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391036", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391036", "story_v_out_116391.awb") / 1000 > 0 and slot5 < slot8 and uv0.duration_ < slot8 + slot4 then
						slot5 = slot8
						uv0.duration_ = slot8 + slot4
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("116391036", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116391", "116391036", "story_v_out_116391.awb"))
					else
						uv0:AudioAction("play", "voice", "story_v_out_116391", "116391036", "story_v_out_116391.awb")
					end
				end
			...
			slot7 = uv0:FormatText(StoryWordCfg[116391036].content)
			slot9 = string.split(slot7, ".")
	...
	Play116391037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391037].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391037].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391038 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391038].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391038].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391039 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391039].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391039].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391040].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391040].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391041 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391041].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391041].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391042 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391042].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391042].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391043 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391043].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391043", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391043", "story_v_out_116391.awb") / 1000 > 0 and slot15 < slot20 and uv0.duration_ < slot20 + slot14 then
						slot15 = slot20
						uv0.duration_ = slot20 + slot14
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("116391043", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_116391", "116391043", "story_v_out_116391.awb"))
					else
			...
			slot14 = slot14 + 0.3
			slot17 = uv0:FormatText(StoryWordCfg[116391043].content)
			slot19 = string.split(slot17, ".")
	...
	Play116391044 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391044].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391044", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391044", "story_v_out_116391.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("116391044", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116391", "116391044", "story_v_out_116391.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[116391044].content)
			slot8 = string.split(slot6, ".")
	...
	Play116391045 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391045].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391045", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391045", "story_v_out_116391.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("116391045", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116391", "116391045", "story_v_out_116391.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[116391045].content)
			slot8 = string.split(slot6, ".")
	...
	Play116391046 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391046].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391046", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391046", "story_v_out_116391.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("116391046", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_116391", "116391046", "story_v_out_116391.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[116391046].content)
			slot20 = string.split(slot18, ".")
	...
	Play116391047 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391047].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391047", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391047", "story_v_out_116391.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116391047", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116391", "116391047", "story_v_out_116391.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116391047].content)
			slot14 = string.split(slot12, ".")
	...
	Play116391048 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.actors_["10024ui_story"].transform

			if 2 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPos10024ui_story = slot7.localPosition
			end
			...
			slot13 = uv0.bgs_.SK0209.transform

			if 2 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPosSK0209 = slot13.localPosition
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391048].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391048", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391048", "story_v_out_116391.awb") / 1000 > 0 and slot19 < slot24 and uv0.duration_ < slot24 + slot18 then
						slot19 = slot24
						uv0.duration_ = slot24 + slot18
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						uv0:RecordAudio("116391048", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_116391", "116391048", "story_v_out_116391.awb"))
					else
			...
			slot18 = slot18 + 0.3
			slot21 = uv0:FormatText(StoryWordCfg[116391048].content)
	...
	Play116391049 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391049].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[116391049].content)
			slot8 = string.split(slot6, ".")
	...
	Play116391050 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391050].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391050].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391051 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391051].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391051].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391052 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391052].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391052].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391053 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391053].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391053].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391054 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391054].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391054", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391054", "story_v_out_116391.awb") / 1000 > 0 and slot8 < slot13 and uv0.duration_ < slot13 + slot7 then
						slot8 = slot13
						uv0.duration_ = slot13 + slot7
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("116391054", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116391", "116391054", "story_v_out_116391.awb"))
					else
			...
			slot7 = slot7 + 0.3
			slot10 = uv0:FormatText(StoryWordCfg[116391054].content)
			slot12 = string.split(slot10, ".")
	...
	Play116391055 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391055].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391055].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391056 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391056].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391056].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391057 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391057].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391057", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391057", "story_v_out_116391.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("116391057", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_116391", "116391057", "story_v_out_116391.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[116391057].content)
	...
	Play116391058 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391058].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391058", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391058", "story_v_out_116391.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("116391058", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116391", "116391058", "story_v_out_116391.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391058].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391059 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_10025")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391059].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391059", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391059", "story_v_out_116391.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("116391059", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116391", "116391059", "story_v_out_116391.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391059].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391060 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391060].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391060", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391060", "story_v_out_116391.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116391060", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116391", "116391060", "story_v_out_116391.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116391060].content)
			slot11 = string.split(slot9, ".")
	...
	Play116391061 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391061].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391061].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391062 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.bgs_.SK0209a.transform

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPosSK0209a = slot1.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391062].content)
				uv0.typewritter.percent = 0
			...
			slot9 = uv0:FormatText(StoryWordCfg[116391062].content)
			slot11 = string.split(slot9, ".")
	...
	Play116391063 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391063].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391063].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391064 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391064].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391064].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391074 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391074].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391074", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391074", "story_v_out_116391.awb") / 1000 > 0 and slot15 < slot20 and uv0.duration_ < slot20 + slot14 then
						slot15 = slot20
						uv0.duration_ = slot20 + slot14
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("116391074", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_116391", "116391074", "story_v_out_116391.awb"))
					else
			...
			slot14 = slot14 + 0.3
			slot17 = uv0:FormatText(StoryWordCfg[116391074].content)
			slot19 = string.split(slot17, ".")
	...
	Play116391075 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391075].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391075", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391075", "story_v_out_116391.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("116391075", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_116391", "116391075", "story_v_out_116391.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[116391075].content)
			slot10 = string.split(slot8, ".")
	...
	Play116391076 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391076].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116391", "116391076", "story_v_out_116391.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116391", "116391076", "story_v_out_116391.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("116391076", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_116391", "116391076", "story_v_out_116391.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[116391076].content)
			slot10 = string.split(slot8, ".")
	...
	Play116391077 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391077].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116391077].content)
			slot9 = string.split(slot7, ".")
	...
	Play116391078 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391078].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391078].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391079 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391079].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391079].content)
			slot6 = string.split(slot4, ".")
	...
	Play116391080 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116391080].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116391080].content)
			slot6 = string.split(slot4, ".")
