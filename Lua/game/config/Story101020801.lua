return {
	Play102081001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot8 = uv0.actors_["2022_tpose"]

			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 and uv0.var_.characterEffect2022_tpose == nil then
				uv0.var_.characterEffect2022_tpose = slot8.GetComponentInChildren(slot8, typeof(CharacterEffect))
			end
			...
			slot16 = uv0.actors_["2022_tpose"].transform

			if 1.79999995231628 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				uv0.var_.moveOldPos2022_tpose = slot16.localPosition
			end

			slot18 = 0.001

			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				slot16.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2022_tpose, Vector3.New(0, -0.6, 0.3), (uv0.time_ - slot17) / slot18)
			...
			if uv0.time_ >= slot17 + slot18 and uv0.time_ < slot17 + slot18 + slot0 then
				slot16.localPosition = Vector3.New(0, -0.6, 0.3)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot22 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081001", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081001", "story_v_out_102081.awb") / 1000 > 0 and slot23 < slot28 and uv0.duration_ < slot28 + slot22 then
						slot23 = slot28
						uv0.duration_ = slot28 + slot22
					end

					if slot26.prefab_name ~= "" and uv0.actors_[slot26.prefab_name] ~= nil then
						uv0:RecordAudio("102081001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot26.prefab_name].transform, "story_v_out_102081", "102081001", "story_v_out_102081.awb"))
					else
			...
			slot22 = slot22 + 0.3
			slot25 = uv0:FormatText(StoryWordCfg[102081001].content)
	...
	Play102081002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot4 = uv0.actors_["2018_tpose"]

			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 and uv0.var_.characterEffect2018_tpose == nil then
				uv0.var_.characterEffect2018_tpose = slot4.GetComponentInChildren(slot4, typeof(CharacterEffect))
			end
			...
			slot7 = uv0.actors_["2022_tpose"]

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 and uv0.var_.characterEffect2022_tpose == nil then
				uv0.var_.characterEffect2022_tpose = slot7.GetComponentInChildren(slot7, typeof(CharacterEffect))
			end
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				...
				if uv0.var_.characterEffect2022_tpose then
					...
					uv0.var_.characterEffect2022_tpose.fillRatio = Mathf.Lerp(0, 0.5, slot10)
				end
			end
			...
			slot10 = uv0.actors_["2022_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.moveOldPos2022_tpose = slot10.localPosition
			end

			slot12 = 0.001

			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2022_tpose, Vector3.New(10, -0.6, 0.3), (uv0.time_ - slot11) / slot12)
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(10, -0.6, 0.3)
			...
			slot13 = uv0.actors_["2018_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPos2018_tpose = slot13.localPosition
			end

			slot15 = 0.001

			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2018_tpose, Vector3.New(0, -0.55, -0.1), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0, -0.55, -0.1)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081002", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081002", "story_v_out_102081.awb") / 1000 > 0 and slot18 < slot22 and uv0.duration_ < slot22 + slot17 then
						slot18 = slot22
						uv0.duration_ = slot22 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						uv0:RecordAudio("102081002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_102081", "102081002", "story_v_out_102081.awb"))
					else
			...
			slot20 = uv0:FormatText(StoryWordCfg[102081002].content)
	...
	Play102081003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot5 = uv0.actors_["2018_tpose"]

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.var_.characterEffect2018_tpose == nil then
				uv0.var_.characterEffect2018_tpose = slot5.GetComponentInChildren(slot5, typeof(CharacterEffect))
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				...
				if uv0.var_.characterEffect2018_tpose then
					...
					uv0.var_.characterEffect2018_tpose.fillRatio = Mathf.Lerp(0, 0.5, slot8)
				end
			end
			...
			slot8 = uv0.actors_["2018_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPos2018_tpose = slot8.localPosition
			end

			slot10 = 0.001

			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2018_tpose, Vector3.New(10, -0.55, -0.1), (uv0.time_ - slot9) / slot10)
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(10, -0.55, -0.1)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081003", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081003", "story_v_out_102081.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("102081003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102081", "102081003", "story_v_out_102081.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[102081003].content)
	...
	Play102081004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081004", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081004", "story_v_out_102081.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("102081004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102081", "102081004", "story_v_out_102081.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[102081004].content)
	...
	Play102081005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081005].content)
				uv0.typewritter.percent = 0
			...
			slot15 = uv0:FormatText(StoryWordCfg[102081005].content)
	...
	Play102081006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081006", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081006", "story_v_out_102081.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("102081006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102081", "102081006", "story_v_out_102081.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[102081006].content)
	...
	Play102081007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081007", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081007", "story_v_out_102081.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("102081007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102081", "102081007", "story_v_out_102081.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[102081007].content)
			slot17 = string.split(slot15, ".")
	...
	Play102081008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081008].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[102081008].content)
	...
	Play102081009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0, -1.25, -5.2), (uv0.time_ - slot14) / slot15)
				slot19 = manager.ui.mainCamera.transform.position - slot13.position
				slot13.forward = Vector3.New(slot19.x, slot19.y, slot19.z)
				slot20 = slot13.localEulerAngles
				slot20.z = 0
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0, -1.25, -5.2)
				slot18 = manager.ui.mainCamera.transform.position - slot13.position
				slot13.forward = Vector3.New(slot18.x, slot18.y, slot18.z)
				slot19 = slot13.localEulerAngles
				slot19.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081009", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081009", "story_v_out_102081.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("102081009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102081", "102081009", "story_v_out_102081.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[102081009].content)
	...
	Play102081010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081010", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081010", "story_v_out_102081.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102081010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102081", "102081010", "story_v_out_102081.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102081010].content)
	...
	Play102081011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081011", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081011", "story_v_out_102081.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("102081011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102081", "102081011", "story_v_out_102081.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[102081011].content)
			slot23 = string.split(slot21, ".")
	...
	Play102081012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081012", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081012", "story_v_out_102081.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("102081012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102081", "102081012", "story_v_out_102081.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[102081012].content)
			slot21 = string.split(slot19, ".")
	...
	Play102081013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081013", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081013", "story_v_out_102081.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("102081013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102081", "102081013", "story_v_out_102081.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[102081013].content)
			slot13 = string.split(slot11, ".")
	...
	Play102081014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081014", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081014", "story_v_out_102081.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102081014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102081", "102081014", "story_v_out_102081.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102081014].content)
	...
	Play102081015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081015", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081015", "story_v_out_102081.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102081015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102081", "102081015", "story_v_out_102081.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102081015].content)
			slot14 = string.split(slot12, ".")
	...
	Play102081016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081016", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081016", "story_v_out_102081.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("102081016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102081", "102081016", "story_v_out_102081.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[102081016].content)
			slot13 = string.split(slot11, ".")
	...
	Play102081017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081017", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081017", "story_v_out_102081.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("102081017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102081", "102081017", "story_v_out_102081.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[102081017].content)
			slot13 = string.split(slot11, ".")
	...
	Play102081018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081018", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081018", "story_v_out_102081.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("102081018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102081", "102081018", "story_v_out_102081.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[102081018].content)
	...
	Play102081019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081019", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081019", "story_v_out_102081.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("102081019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102081", "102081019", "story_v_out_102081.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[102081019].content)
			slot13 = string.split(slot11, ".")
	...
	Play102081020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0, -1.25, -5.2), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(0, -1.25, -5.2)
				slot9 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot9.x, slot9.y, slot9.z)
				slot10 = slot4.localEulerAngles
				slot10.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081020", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081020", "story_v_out_102081.awb") / 1000 > 0 and slot12 < slot16 and uv0.duration_ < slot16 + slot11 then
						slot12 = slot16
						uv0.duration_ = slot16 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						uv0:RecordAudio("102081020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_102081", "102081020", "story_v_out_102081.awb"))
					else
			...
			slot14 = uv0:FormatText(StoryWordCfg[102081020].content)
	...
	Play102081021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081021].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[102081021].content)
			slot9 = string.split(slot7, ".")
	...
	Play102081022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081022].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081022", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081022", "story_v_out_102081.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("102081022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_102081", "102081022", "story_v_out_102081.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[102081022].content)
	...
	Play102081023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(10, -1.25, -5.2), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(10, -1.25, -5.2)
				slot9 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot9.x, slot9.y, slot9.z)
				slot10 = slot4.localEulerAngles
				slot10.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081023].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[102081023].content)
	...
	Play102081024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081024", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081024", "story_v_out_102081.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102081024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102081", "102081024", "story_v_out_102081.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102081024].content)
			slot14 = string.split(slot12, ".")
	...
	Play102081025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081025", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081025", "story_v_out_102081.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102081025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102081", "102081025", "story_v_out_102081.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102081025].content)
			slot20 = string.split(slot18, ".")
	...
	Play102081026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081026].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081026", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081026", "story_v_out_102081.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("102081026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102081", "102081026", "story_v_out_102081.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[102081026].content)
			slot17 = string.split(slot15, ".")
	...
	Play102081027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081027].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081027", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081027", "story_v_out_102081.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102081027", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102081", "102081027", "story_v_out_102081.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102081027].content)
			slot20 = string.split(slot18, ".")
	...
	Play102081028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_2018")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081028].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081028", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081028", "story_v_out_102081.awb") / 1000 > 0 and slot12 < slot16 and uv0.duration_ < slot16 + slot11 then
						slot12 = slot16
						uv0.duration_ = slot16 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						uv0:RecordAudio("102081028", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_102081", "102081028", "story_v_out_102081.awb"))
					else
			...
			slot14 = uv0:FormatText(StoryWordCfg[102081028].content)
			slot16 = string.split(slot14, ".")
	...
	Play102081029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081029].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[102081029].content)
	...
	Play102081030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081030].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081030", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081030", "story_v_out_102081.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102081030", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102081", "102081030", "story_v_out_102081.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102081030].content)
			slot14 = string.split(slot12, ".")
	...
	Play102081031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081031].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[102081031].content)
			slot12 = string.split(slot10, ".")
	...
	Play102081032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081032].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081032", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081032", "story_v_out_102081.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102081032", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102081", "102081032", "story_v_out_102081.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102081032].content)
			slot14 = string.split(slot12, ".")
	...
	Play102081033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot3 = uv0.actors_["2022_tpose"]

			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 and uv0.var_.characterEffect2022_tpose == nil then
				uv0.var_.characterEffect2022_tpose = slot3.GetComponentInChildren(slot3, typeof(CharacterEffect))
			end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(20, -1.16, -5), (uv0.time_ - slot14) / slot15)
				slot19 = manager.ui.mainCamera.transform.position - slot13.position
				slot13.forward = Vector3.New(slot19.x, slot19.y, slot19.z)
				slot20 = slot13.localEulerAngles
				slot20.z = 0
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(20, -1.16, -5)
				slot18 = manager.ui.mainCamera.transform.position - slot13.position
				slot13.forward = Vector3.New(slot18.x, slot18.y, slot18.z)
				slot19 = slot13.localEulerAngles
				slot19.z = 0
			...
			slot16 = uv0.actors_["2021_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				uv0.var_.moveOldPos2021_tpose = slot16.localPosition
			end
			...
			slot20 = uv0.actors_["2022_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				uv0.var_.moveOldPos2022_tpose = slot20.localPosition
			end

			slot22 = 0.001

			if slot21 <= uv0.time_ and uv0.time_ < slot21 + slot22 then
				slot20.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2022_tpose, Vector3.New(1.92, -0.6, 0.3), (uv0.time_ - slot21) / slot22)
			...
			if uv0.time_ >= slot21 + slot22 and uv0.time_ < slot21 + slot22 + slot0 then
				slot20.localPosition = Vector3.New(1.92, -0.6, 0.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot24 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081033].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081033", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081033", "story_v_out_102081.awb") / 1000 > 0 and slot25 < slot29 and uv0.duration_ < slot29 + slot24 then
						slot25 = slot29
						uv0.duration_ = slot29 + slot24
					end

					if slot27.prefab_name ~= "" and uv0.actors_[slot27.prefab_name] ~= nil then
						uv0:RecordAudio("102081033", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot27.prefab_name].transform, "story_v_out_102081", "102081033", "story_v_out_102081.awb"))
					else
			...
			slot27 = uv0:FormatText(StoryWordCfg[102081033].content)
	...
	Play102081034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				...
				if uv0.var_.characterEffect2022_tpose then
					uv0.var_.characterEffect2022_tpose.fillFlat = true
					uv0.var_.characterEffect2022_tpose.fillRatio = Mathf.Lerp(0, 0.5, slot7)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081034].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081034", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081034", "story_v_out_102081.awb") / 1000 > 0 and slot12 < slot16 and uv0.duration_ < slot16 + slot11 then
						slot12 = slot16
						uv0.duration_ = slot16 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						uv0:RecordAudio("102081034", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_102081", "102081034", "story_v_out_102081.awb"))
					else
			...
			slot14 = uv0:FormatText(StoryWordCfg[102081034].content)
			slot16 = string.split(slot14, ".")
	...
	Play102081035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot4 = uv0.actors_["2021_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPos2021_tpose = slot4.localPosition
			end
			...
			slot7 = uv0.actors_["2022_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPos2022_tpose = slot7.localPosition
			end

			slot9 = 0.001

			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2022_tpose, Vector3.New(10, -0.6, 0.3), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(10, -0.6, 0.3)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102081035].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102081", "102081035", "story_v_out_102081.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102081", "102081035", "story_v_out_102081.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102081035", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102081", "102081035", "story_v_out_102081.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102081035].content)
			slot20 = string.split(slot18, ".")
