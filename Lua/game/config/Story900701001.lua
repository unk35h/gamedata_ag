return {
	Play900701001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701001].content)
			...
			slot9 = slot9 + 0.3
			slot12 = uv0:FormatText(StoryWordCfg[900701001].content)
	...
	Play900701002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701002].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701002].content)
	...
	Play900701003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = uv0.actors_["10022_split_6"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				uv0.var_.moveOldPos10022_split_6 = slot2.localPosition
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10022_split_6, Vector3.New(-390, -350, -180), (uv0.time_ - slot3) / slot4)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				if slot5.GetComponent(slot5, "Image") then
					uv0.var_.alphaMatValue10022_split_6 = slot7
					uv0.var_.alphaOldValue10022_split_6 = slot7.color.a
				end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot9 = Mathf.Lerp(uv0.var_.alphaOldValue10022_split_6, 1, (uv0.time_ - slot6) / slot7)

				if uv0.var_.alphaMatValue10022_split_6 then
					slot10 = uv0.var_.alphaMatValue10022_split_6.color
					slot10.a = slot9
					uv0.var_.alphaMatValue10022_split_6.color = slot10
				end
			end

			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 and uv0.var_.alphaMatValue10022_split_6 then
				slot8 = uv0.var_.alphaMatValue10022_split_6
				slot9 = slot8.color
				slot9.a = 1
				slot8.color = slot9
			end

			slot8 = uv0.actors_["10022_split_6"]

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 and slot8.GetComponent(slot8, "Image") then
				uv0.var_.highlightMatValue10022_split_6 = slot10
			end
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 and uv0.var_.highlightMatValue10022_split_6 then
				slot11 = 1

				slot8.transform:SetSiblingIndex(1)

				slot12 = uv0.var_.highlightMatValue10022_split_6
				slot13 = slot12.color
				slot13.r = slot11
				slot13.g = slot11
				slot13.b = slot11
			...
			if 0.2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701003].content)
				uv0.typewritter.percent = 0
			...
			slot11 = slot11 + 0.3
			slot14 = uv0:FormatText(StoryWordCfg[900701003].content)
	...
	Play900701004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = uv0.actors_["1033_split_5"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				uv0.var_.moveOldPos1033_split_5 = slot2.localPosition
				slot2.localScale = Vector3.New(1, 1, 1)

				uv0:CheckSpriteTmpPos("1033_split_5", 4)
			end

			slot4 = 0.001

			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_5, Vector3.New(390, -420, 0), (uv0.time_ - slot3) / slot4)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				if slot5.GetComponent(slot5, "Image") then
					uv0.var_.alphaMatValue1033_split_5 = slot7
					uv0.var_.alphaOldValue1033_split_5 = slot7.color.a
				end

				uv0.var_.alphaOldValue1033_split_5 = 0
			end

			slot7 = 0.2

			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot9 = Mathf.Lerp(uv0.var_.alphaOldValue1033_split_5, 1, (uv0.time_ - slot6) / slot7)

				if uv0.var_.alphaMatValue1033_split_5 then
					slot10 = uv0.var_.alphaMatValue1033_split_5.color
					slot10.a = slot9
					uv0.var_.alphaMatValue1033_split_5.color = slot10
				end
			end

			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 and uv0.var_.alphaMatValue1033_split_5 then
				slot8 = uv0.var_.alphaMatValue1033_split_5
				slot9 = slot8.color
				slot9.a = 1
				slot8.color = slot9
			end

			slot8 = uv0.actors_["1033_split_5"]

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 and slot8.GetComponent(slot8, "Image") then
				uv0.var_.highlightMatValue1033_split_5 = slot10
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				...
				if uv0.var_.highlightMatValue1033_split_5 then
					slot12 = Mathf.Lerp(0.5, 1, slot11)
					slot13 = uv0.var_.highlightMatValue1033_split_5
					slot14 = slot13.color
					slot14.r = slot12
					slot14.g = slot12
					slot14.b = slot12
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 and uv0.var_.highlightMatValue1033_split_5 then
				slot11 = 1

				slot8.transform:SetSiblingIndex(1)

				slot12 = uv0.var_.highlightMatValue1033_split_5
				slot13 = slot12.color
				slot13.r = slot11
				slot13.g = slot11
				slot13.b = slot11
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				...
				if uv0.var_.highlightMatValue10022_split_6 then
					...
					slot16 = uv0.var_.highlightMatValue10022_split_6
					slot17 = slot16.color
					slot17.r = slot15
					slot17.g = slot15
					slot17.b = slot15
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 and uv0.var_.highlightMatValue10022_split_6 then
				slot14 = 0.5
				slot15 = uv0.var_.highlightMatValue10022_split_6
				slot16 = slot15.color
				slot16.r = slot14
				slot16.g = slot14
				slot16.b = slot14
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701004].content)
				uv0.typewritter.percent = 0
			...
			slot17 = uv0:FormatText(StoryWordCfg[900701004].content)
	...
	Play900701005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701005].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701005].content)
			slot6 = string.split(slot4, ".")
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				...
				if uv0.var_.highlightMatValue1033_split_5 then
					...
					slot6 = uv0.var_.highlightMatValue1033_split_5
					slot7 = slot6.color
					slot7.r = slot5
					slot7.g = slot5
					slot7.b = slot5
			...
			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 and uv0.var_.highlightMatValue1033_split_5 then
				slot4 = 0.5
				slot5 = uv0.var_.highlightMatValue1033_split_5
				slot6 = slot5.color
				slot6.r = slot4
				slot6.g = slot4
				slot6.b = slot4
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701006].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701006].content)
	...
	Play900701007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701007].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701007].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701008].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701008].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.actors_["1033_split_5"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPos1033_split_5 = slot1.localPosition
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_5, Vector3.New(390, -420, 0), (uv0.time_ - slot2) / slot3)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701009].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[900701009].content)
	...
	Play900701010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701010].content)
				uv0.typewritter.percent = 0
			...
			slot14 = uv0:FormatText(StoryWordCfg[900701010].content)
			slot16 = string.split(slot14, ".")
	...
	Play900701011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701011].content)
				uv0.typewritter.percent = 0
			...
			slot14 = uv0:FormatText(StoryWordCfg[900701011].content)
			slot16 = string.split(slot14, ".")
	...
	Play900701012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0:CheckSpriteTmpPos("1033_split_2", 4)
			end

			slot4 = 0.001

			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_2, Vector3.New(390, -420, 0), (uv0.time_ - slot3) / slot4)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701012].content)
				uv0.typewritter.percent = 0
			...
			slot17 = uv0:FormatText(StoryWordCfg[900701012].content)
			slot19 = string.split(slot17, ".")
	...
	Play900701013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.actors_["1033_split_2"].transform

			if 0.466666666666667 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPos1033_split_2 = slot7.localPosition
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_2, Vector3.New(0, -2000, 0), (uv0.time_ - slot8) / slot9)
			end
			...
			if uv0.actors_["1033_split_1"] == nil then
				slot11 = Object.Instantiate(uv0.imageGo_, uv0.canvasGo_.transform)

				slot11.transform:SetSiblingIndex(1)

				slot11.name = slot10
				slot12 = slot11:GetComponent(typeof(Image))
				slot12.sprite = getSpriteWithoutAtlas("Textures/Character/Portrait/" .. slot10)
			...
			slot11 = uv0.actors_["1033_split_1"].transform

			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0.var_.moveOldPos1033_split_1 = slot11.localPosition
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_1, Vector3.New(-390, -420, 0), (uv0.time_ - slot12) / slot13)
			end
			...
			slot14 = uv0.actors_["10022_split_6"].transform

			if 0.466666666666667 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				uv0.var_.moveOldPos10022_split_6 = slot14.localPosition
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10022_split_6, Vector3.New(0, -2000, -180), (uv0.time_ - slot15) / slot16)
			end

			if uv0.time_ >= slot15 + slot16 and uv0.time_ < slot15 + slot16 + slot0 then
				slot14.localPosition = Vector3.New(0, -2000, -180)
			end

			if uv0.actors_["1038_split_1"] == nil then
				slot18 = Object.Instantiate(uv0.imageGo_, uv0.canvasGo_.transform)

				slot18.transform:SetSiblingIndex(1)

				slot18.name = slot17
				slot19 = slot18:GetComponent(typeof(Image))
				slot19.sprite = getSpriteWithoutAtlas("Textures/Character/Portrait/" .. slot17)

				slot19:SetNativeSize()

				slot18.transform.localPosition = Vector3.New(0, 100000, 0)
				uv0.actors_[slot17] = slot18
			end

			slot18 = uv0.actors_["1038_split_1"].transform

			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				uv0.var_.moveOldPos1038_split_1 = slot18.localPosition
			...
			if slot19 <= uv0.time_ and uv0.time_ < slot19 + slot20 then
				slot18.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1038_split_1, Vector3.New(390, -400, 0), (uv0.time_ - slot19) / slot20)
			end

			if uv0.time_ >= slot19 + slot20 and uv0.time_ < slot19 + slot20 + slot0 then
				slot18.localPosition = Vector3.New(390, -400, 0)
			end

			slot21 = uv0.actors_["1038_split_1"]

			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot22 + slot0 and slot21.GetComponent(slot21, "Image") then
				uv0.var_.highlightMatValue1038_split_1 = slot23
			end
			...
			if slot22 <= uv0.time_ and uv0.time_ < slot22 + slot23 then
				...
				if uv0.var_.highlightMatValue1038_split_1 then
					slot25 = Mathf.Lerp(1, 0.5, slot24)
					slot26 = uv0.var_.highlightMatValue1038_split_1
					slot27 = slot26.color
					slot27.r = slot25
					slot27.g = slot25
					slot27.b = slot25
			...
			if uv0.time_ >= slot22 + slot23 and uv0.time_ < slot22 + slot23 + slot0 and uv0.var_.highlightMatValue1038_split_1 then
				slot24 = 0.5
				slot25 = uv0.var_.highlightMatValue1038_split_1
				slot26 = slot25.color
				slot26.r = slot24
				slot26.g = slot24
				slot26.b = slot24
			...
			slot24 = uv0.actors_["1033_split_1"]

			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot25 + slot0 and slot24.GetComponent(slot24, "Image") then
				uv0.var_.highlightMatValue1033_split_1 = slot26
			end
			...
			if slot25 <= uv0.time_ and uv0.time_ < slot25 + slot26 then
				...
				if uv0.var_.highlightMatValue1033_split_1 then
					slot28 = Mathf.Lerp(0.5, 1, slot27)
					slot29 = uv0.var_.highlightMatValue1033_split_1
					slot30 = slot29.color
					slot30.r = slot28
					slot30.g = slot28
					slot30.b = slot28
			...
			if uv0.time_ >= slot25 + slot26 and uv0.time_ < slot25 + slot26 + slot0 and uv0.var_.highlightMatValue1033_split_1 then
				slot27 = 1

				slot24.transform:SetSiblingIndex(1)

				slot28 = uv0.var_.highlightMatValue1033_split_1
				slot29 = slot28.color
				slot29.r = slot27
				slot29.g = slot27
				slot29.b = slot27
			...
			slot27 = uv0.actors_["1033_split_1"]

			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot28 + slot0 then
				if slot27.GetComponent(slot27, "Image") then
					uv0.var_.alphaMatValue1033_split_1 = slot29
					uv0.var_.alphaOldValue1033_split_1 = slot29.color.a
				end
			...
			if slot28 <= uv0.time_ and uv0.time_ < slot28 + slot29 then
				slot31 = Mathf.Lerp(uv0.var_.alphaOldValue1033_split_1, 1, (uv0.time_ - slot28) / slot29)

				if uv0.var_.alphaMatValue1033_split_1 then
					slot32 = uv0.var_.alphaMatValue1033_split_1.color
					slot32.a = slot31
					uv0.var_.alphaMatValue1033_split_1.color = slot32
				end
			end

			if uv0.time_ >= slot28 + slot29 and uv0.time_ < slot28 + slot29 + slot0 and uv0.var_.alphaMatValue1033_split_1 then
				slot30 = uv0.var_.alphaMatValue1033_split_1
				slot31 = slot30.color
				slot31.a = 1
				slot30.color = slot31
			end

			slot30 = uv0.actors_["1038_split_1"]

			if 1.36666666666667 < uv0.time_ and uv0.time_ <= slot31 + slot0 then
				if slot30.GetComponent(slot30, "Image") then
					uv0.var_.alphaMatValue1038_split_1 = slot32
					uv0.var_.alphaOldValue1038_split_1 = slot32.color.a
				end
			...
			if slot31 <= uv0.time_ and uv0.time_ < slot31 + slot32 then
				slot34 = Mathf.Lerp(uv0.var_.alphaOldValue1038_split_1, 1, (uv0.time_ - slot31) / slot32)

				if uv0.var_.alphaMatValue1038_split_1 then
					slot35 = uv0.var_.alphaMatValue1038_split_1.color
					slot35.a = slot34
					uv0.var_.alphaMatValue1038_split_1.color = slot35
				end
			end

			if uv0.time_ >= slot31 + slot32 and uv0.time_ < slot31 + slot32 + slot0 and uv0.var_.alphaMatValue1038_split_1 then
				slot33 = uv0.var_.alphaMatValue1038_split_1
				slot34 = slot33.color
				slot34.a = 1
				slot33.color = slot34
			end
			...
			if 1.50066666666667 < uv0.time_ and uv0.time_ <= slot33 + slot0 then
				uv0.dialog_:SetActive(true)
				...
				slot35 = LeanTween.value(uv0.dialog_, 0, 1, 0.3)

				slot35:setOnUpdate(LuaHelper.FloatAction(function (slot0)
					uv0.dialogCg_.alpha = slot0
				end))
				slot35:setOnComplete(System.Action(function ()
					LeanTween.cancel(uv0.dialog_)
					uv1:setOnUpdate(nil):setOnComplete(nil)
				end))
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701013].content)
				uv0.typewritter.percent = 0
			...
			slot33 = slot33 + 0.3
			slot36 = uv0:FormatText(StoryWordCfg[900701013].content)
			slot38 = string.split(slot36, ".")

			if #string.split(slot36, "\n") >= 4 or #slot38 >= 4 then
				slot34 = slot34 * 3
			end

			if slot33 <= uv0.time_ and uv0.time_ < slot33 + slot34 then
				uv0.typewritter.percent = (uv0.time_ - slot33) / slot34
	...
	Play900701014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot4 = uv0.actors_["1033_split_1"]

			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 and slot4.GetComponent(slot4, "Image") then
				uv0.var_.highlightMatValue1033_split_1 = slot6
			end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				...
				if uv0.var_.highlightMatValue1033_split_1 then
					slot8 = Mathf.Lerp(1, 0.5, slot7)
					slot9 = uv0.var_.highlightMatValue1033_split_1
					slot10 = slot9.color
					slot10.r = slot8
					slot10.g = slot8
					slot10.b = slot8
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 and uv0.var_.highlightMatValue1033_split_1 then
				slot7 = 0.5
				slot8 = uv0.var_.highlightMatValue1033_split_1
				slot9 = slot8.color
				slot9.r = slot7
				slot9.g = slot7
				slot9.b = slot7
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701014].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701014].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701015].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701015].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701016].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701016].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.actors_["1033_split_2"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPos1033_split_2 = slot1.localPosition
				slot1.localScale = Vector3.New(1, 1, 1)

				uv0:CheckSpriteTmpPos("1033_split_2", 2)
			end

			slot3 = 0.001

			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_2, Vector3.New(-390, -420, 0), (uv0.time_ - slot2) / slot3)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701017].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[900701017].content)
			slot9 = string.split(slot7, ".")
	...
	Play900701018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6 = uv0.actors_["1033_split_1"].transform

			if 0.466666666666667 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0.var_.moveOldPos1033_split_1 = slot6.localPosition
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_1, Vector3.New(0, -2000, 0), (uv0.time_ - slot7) / slot8)
			end
			...
			slot9 = uv0.actors_["1033_split_2"].transform

			if 0.500666666666667 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0.var_.moveOldPos1033_split_2 = slot9.localPosition
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_2, Vector3.New(390, -420, 0), (uv0.time_ - slot10) / slot11)
			end
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1038_split_1, Vector3.New(0, -2000, 0), (uv0.time_ - slot13) / slot14)
			end
			...
			slot15 = uv0.actors_["10022_split_6"].transform

			if 0.500666666666667 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				uv0.var_.moveOldPos10022_split_6 = slot15.localPosition
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				slot15.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10022_split_6, Vector3.New(-390, -350, -180), (uv0.time_ - slot16) / slot17)
			end
			...
			slot18 = uv0.actors_["10022_split_6"]

			if 0.5 < uv0.time_ and uv0.time_ <= slot19 + slot0 and slot18.GetComponent(slot18, "Image") then
				uv0.var_.highlightMatValue10022_split_6 = slot20
			end
			...
			if slot19 <= uv0.time_ and uv0.time_ < slot19 + slot20 then
				...
				if uv0.var_.highlightMatValue10022_split_6 then
					...
					slot23 = uv0.var_.highlightMatValue10022_split_6
					slot24 = slot23.color
					slot24.r = slot22
					slot24.g = slot22
					slot24.b = slot22
			...
			if uv0.time_ >= slot19 + slot20 and uv0.time_ < slot19 + slot20 + slot0 and uv0.var_.highlightMatValue10022_split_6 then
				slot21 = 0.5
				slot22 = uv0.var_.highlightMatValue10022_split_6
				slot23 = slot22.color
				slot23.r = slot21
				slot23.g = slot21
				slot23.b = slot21
			...
			slot21 = uv0.actors_["1033_split_1"]

			if 0.5 < uv0.time_ and uv0.time_ <= slot22 + slot0 and slot21.GetComponent(slot21, "Image") then
				uv0.var_.highlightMatValue1033_split_1 = slot23
			end
			...
			if slot22 <= uv0.time_ and uv0.time_ < slot22 + slot23 then
				...
				if uv0.var_.highlightMatValue1033_split_1 then
					...
					slot26 = uv0.var_.highlightMatValue1033_split_1
					slot27 = slot26.color
					slot27.r = slot25
					slot27.g = slot25
					slot27.b = slot25
			...
			if uv0.time_ >= slot22 + slot23 and uv0.time_ < slot22 + slot23 + slot0 and uv0.var_.highlightMatValue1033_split_1 then
				slot24 = 1

				slot21.transform:SetSiblingIndex(1)

				slot25 = uv0.var_.highlightMatValue1033_split_1
				slot26 = slot25.color
				slot26.r = slot24
				slot26.g = slot24
				slot26.b = slot24
			...
			if 1.33333333333333 < uv0.time_ and uv0.time_ <= slot24 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701018].content)
				uv0.typewritter.percent = 0
			...
			slot24 = slot24 + 0.3
			slot27 = uv0:FormatText(StoryWordCfg[900701018].content)
	...
	Play900701019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701019].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701019].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701020].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701020].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701021].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701021].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701022].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701022].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701023].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701023].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701024].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701024].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701025].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701025].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701026].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701026].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701027].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701027].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			if uv0.actors_["10022_split_7"] == nil then
				slot2 = Object.Instantiate(uv0.imageGo_, uv0.canvasGo_.transform)
			...
			slot2 = uv0.actors_["10022_split_7"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				uv0.var_.moveOldPos10022_split_7 = slot2.localPosition
				slot2.localScale = Vector3.New(1, 1, 1)

				uv0:CheckSpriteTmpPos("10022_split_7", 2)
			end

			slot4 = 0.001

			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10022_split_7, Vector3.New(-390, -350, -180), (uv0.time_ - slot3) / slot4)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701028].content)
				uv0.typewritter.percent = 0
			...
			slot8 = uv0:FormatText(StoryWordCfg[900701028].content)
	...
	Play900701029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot5 = uv0.actors_["10022_split_7"]

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and slot5.GetComponent(slot5, "Image") then
				uv0.var_.highlightMatValue10022_split_7 = slot7
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				...
				if uv0.var_.highlightMatValue10022_split_7 then
					slot9 = Mathf.Lerp(1, 0.5, slot8)
					slot10 = uv0.var_.highlightMatValue10022_split_7
					slot11 = slot10.color
					slot11.r = slot9
					slot11.g = slot9
					slot11.b = slot9
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 and uv0.var_.highlightMatValue10022_split_7 then
				slot8 = 0.5
				slot9 = uv0.var_.highlightMatValue10022_split_7
				slot10 = slot9.color
				slot10.r = slot8
				slot10.g = slot8
				slot10.b = slot8
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701029].content)
				uv0.typewritter.percent = 0
			...
			slot14 = uv0:FormatText(StoryWordCfg[900701029].content)
			slot16 = string.split(slot14, ".")
	...
	Play900701030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot10 = uv0.actors_["10022_split_7"].transform

			if 1.966 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.moveOldPos10022_split_7 = slot10.localPosition
				slot10.localScale = Vector3.New(1, 1, 1)

				uv0:CheckSpriteTmpPos("10022_split_7", 7)
			end

			slot12 = 0.001

			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10022_split_7, Vector3.New(0, -2000, 0), (uv0.time_ - slot11) / slot12)
			end
			...
			if 3 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701030].content)
				uv0.typewritter.percent = 0
			...
			slot21 = slot21 + 0.3
			slot24 = uv0:FormatText(StoryWordCfg[900701030].content)
	...
	Play900701031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.bgs_.OM0602.transform

			if 0.0339999999999998 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPosOM0602 = slot1.localPosition
			end
			...
			if 0.566666666666667 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701031].content)
				uv0.typewritter.percent = 0
			...
			slot7 = slot7 + 0.3
			slot10 = uv0:FormatText(StoryWordCfg[900701031].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1119_1_split_1")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701032].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701032].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_3021")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701033].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701033].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701034].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701034].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701035].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701035].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1138_split_7")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701036].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701036].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701037].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701037].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701038 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701038].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701038].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701039 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701039].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701039].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701040].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701040].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701041 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1119_1_split_6")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701041].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701041].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701042 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.bgs_.OM0602.transform

			if 0.966 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosOM0602 = slot7.localPosition
			end
			...
			slot10 = uv0.bgs_.OM0601.transform

			if 1 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.moveOldPosOM0601 = slot10.localPosition
			end
			...
			slot13 = uv0.bgs_.OM0601.transform

			if 1.034 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPosOM0601 = slot13.localPosition
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701042].content)
				uv0.typewritter.percent = 0
			...
			slot16 = slot16 + 0.3
			slot19 = uv0:FormatText(StoryWordCfg[900701042].content)
	...
	Play900701043 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.bgs_.OM0601.transform

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPosOM0601 = slot1.localPosition
			end
			...
			if 0.625 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701043].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[900701043].content)
			slot9 = string.split(slot7, ".")
	...
	Play900701044 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701044].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701044].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701045 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.367333333333333 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701045].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[900701045].content)
			slot9 = string.split(slot7, ".")
	...
	Play900701046 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				uv0.var_.shakeOldPos = slot2.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				if slot5.GetComponent(slot5, "SpriteRenderer") then
					uv0.var_.alphaOldValueOM0601 = slot7.material:GetColor("_Color").a
					uv0.var_.alphaMatValueOM0601 = slot7.material
				end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot9 = Mathf.Lerp(uv0.var_.alphaOldValueOM0601, 0, (uv0.time_ - slot6) / slot7)
			...
			if 2.38333333333333 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_3021")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701046].content)
				uv0.typewritter.percent = 0
			...
			slot18 = slot18 + 0.3
			slot21 = uv0:FormatText(StoryWordCfg[900701046].content)
	...
	Play900701047 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot10 = uv0.bgs_.OM0602.transform

			if 1.5 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.moveOldPosOM0602 = slot10.localPosition
			end
			...
			slot13 = uv0.bgs_.OM0602.transform

			if 1.534 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPosOM0602 = slot13.localPosition
			end
			...
			if 2.5 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701047].content)
				uv0.typewritter.percent = 0
			...
			slot16 = slot16 + 0.3
			slot19 = uv0:FormatText(StoryWordCfg[900701047].content)
			slot21 = string.split(slot19, ".")
	...
	Play900701048 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701048].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701048].content)
			slot6 = string.split(slot4, ".")
	...
	Play900701049 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.2 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701049].content)
				uv0.typewritter.percent = 0
			...
			slot7 = slot7 + 0.3
			slot10 = uv0:FormatText(StoryWordCfg[900701049].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701050 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701050].content)
				uv0.typewritter.percent = 0
			...
			slot10 = slot10 + 0.3
			slot13 = uv0:FormatText(StoryWordCfg[900701050].content)
	...
	Play900701051 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701051].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[900701051].content)
	...
	Play900701052 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701052].content)
				uv0.typewritter.percent = 0
			...
			slot4 = slot4 + 0.3
			slot7 = uv0:FormatText(StoryWordCfg[900701052].content)
			slot9 = string.split(slot7, ".")
	...
	Play900701053 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.actors_["10022_split_3"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPos10022_split_3 = slot7.localPosition
				slot7.localScale = Vector3.New(1, 1, 1)

				uv0:CheckSpriteTmpPos("10022_split_3", 4)
			end

			slot9 = 0.001

			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10022_split_3, Vector3.New(390, -350, -180), (uv0.time_ - slot8) / slot9)
			end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				...
				if uv0.var_.highlightMatValue10022_split_3 then
					...
					slot15 = uv0.var_.highlightMatValue10022_split_3
					slot16 = slot15.color
					slot16.r = slot14
					slot16.g = slot14
					slot16.b = slot14
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.highlightMatValue10022_split_3 then
				slot13 = 1

				slot10.transform:SetSiblingIndex(1)

				slot14 = uv0.var_.highlightMatValue10022_split_3
				slot15 = slot14.color
				slot15.r = slot13
				slot15.g = slot13
				slot15.b = slot13
			...
			slot13 = uv0.actors_["1033_split_5"]

			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				if slot13.GetComponent(slot13, "Image") then
					uv0.var_.alphaMatValue1033_split_5 = slot15
					uv0.var_.alphaOldValue1033_split_5 = slot15.color.a
				end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot17 = Mathf.Lerp(uv0.var_.alphaOldValue1033_split_5, 1, (uv0.time_ - slot14) / slot15)

				if uv0.var_.alphaMatValue1033_split_5 then
					slot18 = uv0.var_.alphaMatValue1033_split_5.color
					slot18.a = slot17
					uv0.var_.alphaMatValue1033_split_5.color = slot18
				end
			end

			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 and uv0.var_.alphaMatValue1033_split_5 then
				slot16 = uv0.var_.alphaMatValue1033_split_5
				slot17 = slot16.color
				slot17.a = 1
				slot16.color = slot17
			end

			slot16 = uv0.actors_["10022_split_3"]

			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				if slot16.GetComponent(slot16, "Image") then
					uv0.var_.alphaMatValue10022_split_3 = slot18
					uv0.var_.alphaOldValue10022_split_3 = slot18.color.a
				end
			...
			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				slot20 = Mathf.Lerp(uv0.var_.alphaOldValue10022_split_3, 1, (uv0.time_ - slot17) / slot18)

				if uv0.var_.alphaMatValue10022_split_3 then
					slot21 = uv0.var_.alphaMatValue10022_split_3.color
					slot21.a = slot20
					uv0.var_.alphaMatValue10022_split_3.color = slot21
				end
			end

			if uv0.time_ >= slot17 + slot18 and uv0.time_ < slot17 + slot18 + slot0 and uv0.var_.alphaMatValue10022_split_3 then
				slot19 = uv0.var_.alphaMatValue10022_split_3
				slot20 = slot19.color
				slot20.a = 1
				slot19.color = slot20
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701053].content)
				uv0.typewritter.percent = 0
			...
			slot22 = uv0:FormatText(StoryWordCfg[900701053].content)
	...
	Play900701054 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701054].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701054].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701055 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_5, Vector3.New(0, -2000, 0), (uv0.time_ - slot2) / slot3)
			end
			...
			slot4 = uv0.actors_["10022_split_3"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPos10022_split_3 = slot4.localPosition
				slot4.localScale = Vector3.New(1, 1, 1)

				uv0:CheckSpriteTmpPos("10022_split_3", 7)
			end

			slot6 = 0.001

			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10022_split_3, Vector3.New(0, -2000, -180), (uv0.time_ - slot5) / slot6)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701055].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701055].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701056 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701056].content)
				uv0.typewritter.percent = 0
			...
			slot10 = slot10 + 0.3
			slot13 = uv0:FormatText(StoryWordCfg[900701056].content)
			slot15 = string.split(slot13, ".")
	...
	Play900701057 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0:CheckSpriteTmpPos("1019_split_1", 2)
			end

			slot4 = 0.001

			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019_split_1, Vector3.New(-600, -340, 200), (uv0.time_ - slot3) / slot4)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				if slot11.GetComponent(slot11, "Image") then
					uv0.var_.alphaMatValue1019_split_1 = slot13
					uv0.var_.alphaOldValue1019_split_1 = slot13.color.a
				end
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot15 = Mathf.Lerp(uv0.var_.alphaOldValue1019_split_1, 1, (uv0.time_ - slot12) / slot13)

				if uv0.var_.alphaMatValue1019_split_1 then
					slot16 = uv0.var_.alphaMatValue1019_split_1.color
					slot16.a = slot15
					uv0.var_.alphaMatValue1019_split_1.color = slot16
				end
			end

			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 and uv0.var_.alphaMatValue1019_split_1 then
				slot14 = uv0.var_.alphaMatValue1019_split_1
				slot15 = slot14.color
				slot15.a = 1
				slot14.color = slot15
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701057].content)
				uv0.typewritter.percent = 0
			...
			slot17 = uv0:FormatText(StoryWordCfg[900701057].content)
			slot19 = string.split(slot17, ".")
	...
	Play900701058 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019_split_1, Vector3.New(0, -2000, 200), (uv0.time_ - slot2) / slot3)
			end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1038_split_1, Vector3.New(0, -2000, 0), (uv0.time_ - slot5) / slot6)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 and slot10.GetComponent(slot10, "Image") then
				uv0.var_.highlightMatValue1033_split_4 = slot12
			end
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.highlightMatValue1033_split_4 then
				slot13 = 1

				slot10.transform:SetSiblingIndex(1)

				slot14 = uv0.var_.highlightMatValue1033_split_4
				slot15 = slot14.color
				slot15.r = slot13
				slot15.g = slot13
				slot15.b = slot13
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701058].content)
				uv0.typewritter.percent = 0
			...
			slot16 = uv0:FormatText(StoryWordCfg[900701058].content)
	...
	Play900701059 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019_split_1, Vector3.New(-600, -340, 200), (uv0.time_ - slot2) / slot3)
			end
			...
			slot5 = uv0.actors_["1038_split_2"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0.var_.moveOldPos1038_split_2 = slot5.localPosition
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1038_split_2, Vector3.New(390, -400, 0), (uv0.time_ - slot6) / slot7)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 and slot8.GetComponent(slot8, "Image") then
				uv0.var_.highlightMatValue1019_split_1 = slot10
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				...
				if uv0.var_.highlightMatValue1019_split_1 then
					slot12 = Mathf.Lerp(1, 0.5, slot11)
					slot13 = uv0.var_.highlightMatValue1019_split_1
					slot14 = slot13.color
					slot14.r = slot12
					slot14.g = slot12
					slot14.b = slot12
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 and uv0.var_.highlightMatValue1019_split_1 then
				slot11 = 0.5
			...
			slot11 = uv0.actors_["1038_split_2"]

			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 and slot11.GetComponent(slot11, "Image") then
				uv0.var_.highlightMatValue1038_split_2 = slot13
			end
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				...
				if uv0.var_.highlightMatValue1038_split_2 then
					...
					slot16 = uv0.var_.highlightMatValue1038_split_2
					slot17 = slot16.color
					slot17.r = slot15
					slot17.g = slot15
					slot17.b = slot15
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 and uv0.var_.highlightMatValue1038_split_2 then
				slot14 = 1
			...
			slot14 = uv0.actors_["1033_split_4"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				uv0.var_.moveOldPos1033_split_4 = slot14.localPosition
				slot14.localScale = Vector3.New(1, 1, 1)
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_4, Vector3.New(0, -2000, 0), (uv0.time_ - slot15) / slot16)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701059].content)
				uv0.typewritter.percent = 0
			...
			slot20 = uv0:FormatText(StoryWordCfg[900701059].content)
	...
	Play900701060 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701060].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[900701060].content)
			slot12 = string.split(slot10, ".")
	...
	Play900701061 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_2, Vector3.New(0, -420, 0), (uv0.time_ - slot2) / slot3)
			end
			...
			slot4 = uv0.actors_["1033_split_2"]

			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 and slot4.GetComponent(slot4, "Image") then
				uv0.var_.highlightMatValue1033_split_2 = slot6
			end
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 and uv0.var_.highlightMatValue1033_split_2 then
				slot7 = 1

				slot4.transform:SetSiblingIndex(1)

				slot8 = uv0.var_.highlightMatValue1033_split_2
				slot9 = slot8.color
				slot9.r = slot7
				slot9.g = slot7
				slot9.b = slot7
			...
			slot7 = uv0.actors_["1019_split_1"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPos1019_split_1 = slot7.localPosition
				slot7.localScale = Vector3.New(1, 1, 1)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019_split_1, Vector3.New(0, -2000, 200), (uv0.time_ - slot8) / slot9)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701061].content)
				uv0.typewritter.percent = 0
			...
			slot16 = uv0:FormatText(StoryWordCfg[900701061].content)
			slot18 = string.split(slot16, ".")
	...
	Play900701062 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_2, Vector3.New(0, -2000, 0), (uv0.time_ - slot2) / slot3)
			end
			...
			slot8 = uv0.actors_["1019_split_1"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPos1019_split_1 = slot8.localPosition
				slot8.localScale = Vector3.New(1, 1, 1)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019_split_1, Vector3.New(0, -2000, 200), (uv0.time_ - slot9) / slot10)
			end

			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0, -2000, 200)
			end

			slot11 = uv0.actors_["1038_split_9"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				uv0.var_.moveOldPos1038_split_9 = slot11.localPosition
				slot11.localScale = Vector3.New(-1, 1, 1)

				uv0:CheckSpriteTmpPos("1038_split_9", 4)
			end

			slot13 = 0.001

			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1038_split_9, Vector3.New(390, -400, 0), (uv0.time_ - slot12) / slot13)
			end

			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(390, -400, 0)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701062].content)
				uv0.typewritter.percent = 0
			...
			slot17 = uv0:FormatText(StoryWordCfg[900701062].content)
			slot19 = string.split(slot17, ".")
	...
	Play900701063 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701063].content)
				uv0.typewritter.percent = 0
			...
			slot13 = uv0:FormatText(StoryWordCfg[900701063].content)
			slot15 = string.split(slot13, ".")
	...
	Play900701064 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0:CheckSpriteTmpPos("1038_split_5", 4)
			end

			slot4 = 0.001

			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1038_split_5, Vector3.New(390, -400, 0), (uv0.time_ - slot3) / slot4)
			end
			...
			slot5 = uv0.actors_["1038_split_5"]

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and slot5.GetComponent(slot5, "Image") then
				uv0.var_.highlightMatValue1038_split_5 = slot7
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				...
				if uv0.var_.highlightMatValue1038_split_5 then
					slot9 = Mathf.Lerp(0.5, 1, slot8)
					slot10 = uv0.var_.highlightMatValue1038_split_5
					slot11 = slot10.color
					slot11.r = slot9
					slot11.g = slot9
					slot11.b = slot9
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 and uv0.var_.highlightMatValue1038_split_5 then
				slot8 = 1
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701064].content)
				uv0.typewritter.percent = 0
			...
			slot14 = uv0:FormatText(StoryWordCfg[900701064].content)
			slot16 = string.split(slot14, ".")
	...
	Play900701065 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[900701065].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[900701065].content)
			slot6 = string.split(slot4, ".")
