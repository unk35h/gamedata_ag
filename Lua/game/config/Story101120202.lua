		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				if slot2.GetComponent(slot2, "SpriteRenderer") then
					uv0.var_.alphaOldValueH01a = slot4.material:GetColor("_Color").a
					uv0.var_.alphaMatValueH01a = slot4.material
				end
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot6 = Mathf.Lerp(uv0.var_.alphaOldValueH01a, 1, (uv0.time_ - slot3) / slot4)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112022001].content)
			...
			slot12 = slot12 + 0.3
			slot15 = uv0:FormatText(StoryWordCfg[112022001].content)
	...
	Play112022002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112022002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022002", "story_v_out_112022.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112022", "112022002", "story_v_out_112022.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("112022002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_112022", "112022002", "story_v_out_112022.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[112022002].content)
	...
	Play112022003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112022003].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[112022003].content)
	...
	Play112022004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112022004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022004", "story_v_out_112022.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112022", "112022004", "story_v_out_112022.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("112022004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_112022", "112022004", "story_v_out_112022.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[112022004].content)
			slot15 = string.split(slot13, ".")
	...
	Play112022005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112022005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022005", "story_v_out_112022.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112022", "112022005", "story_v_out_112022.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("112022005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_112022", "112022005", "story_v_out_112022.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[112022005].content)
	...
	Play112022006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112022006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022006", "story_v_out_112022.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112022", "112022006", "story_v_out_112022.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("112022006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_112022", "112022006", "story_v_out_112022.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[112022006].content)
			slot9 = string.split(slot7, ".")
	...
	Play112022007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112022007].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[112022007].content)
	...
	Play112022008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112022008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022008", "story_v_out_112022.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112022", "112022008", "story_v_out_112022.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("112022008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_112022", "112022008", "story_v_out_112022.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[112022008].content)
	...
	Play112022009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112022009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112022", "112022009", "story_v_out_112022.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112022", "112022009", "story_v_out_112022.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("112022009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_112022", "112022009", "story_v_out_112022.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[112022009].content)
			slot17 = string.split(slot15, ".")
	...
	Play112022010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112022010].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[112022010].content)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.6 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if slot4.GetComponent(slot4, "SpriteRenderer") then
					uv0.var_.alphaOldValueH01a = slot6.material:GetColor("_Color").a
					uv0.var_.alphaMatValueH01a = slot6.material
				end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot8 = Mathf.Lerp(uv0.var_.alphaOldValueH01a, 0, (uv0.time_ - slot5) / slot6)
			...
			if 1.599999999999 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112022011].content)
				uv0.typewritter.percent = 0
			...
			slot11 = slot11 + 0.3
			slot14 = uv0:FormatText(StoryWordCfg[112022011].content)
