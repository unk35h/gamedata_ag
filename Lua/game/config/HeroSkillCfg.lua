return {
	...
	[1071101] = {
		...
		strengthen_desc = "",
		simpleDesc = [[
孟章参悟星宿而习得的五式剑法，造成风属性伤害，施放每段普通攻击时会获得「勿」标记。
...
处于「苍震」姿态：「风雷引」会替换为「风雷破」。
「风雷破」：消耗神能造成雷属性伤害，可以在施放「益动势合」或「恒出运昌」的过程中穿插施放该技能，改变「益动势合」或「恒出运昌」的后续伤害，衍生出更强力的招式；穿插施放后，「风雷破」、「益动势合」和「恒出运昌」的剩余冷却时间缩短；穿插施放后，下一次直接施放该技能时会改变攻击模式。
...
<color=#0068C3>神能：处于「青巽」姿态时，每次命中敌人会获得神能。</color>]],
	...
	[1071202] = {
		...
		strengthen_desc = "",
		simpleDesc = [[
处于「青巽」姿态：施放时短暂格挡受到的伤害，召唤多把「玉剑」攻击锁定的敌人。该技能处于冷却状态时，每段普通攻击命中时会召唤不同数量的「玉剑」攻击锁定的敌人。
「玉剑」：造成风属性伤害，并提高风属性伤害。
处于「苍震」姿态：消耗神能施放二段攻击造成伤害，根据穿插「风雷破」的时机，又演化出二式剑术，造成不同的雷属性伤害
第一式：直接施放；
第二式：在第二段前穿插施放「风雷破」。]],
		MaxUseCount = 0,
		id = 1071202,
	...
	[1071203] = {
		...
		strengthen_desc = "",
		simpleDesc = [[
处于「青巽」姿态：神能达到满值后才可施放，造成风属性伤害，自身切换为「苍震」姿态，召唤数道「云雷」攻击锁定的目标，造成雷属性伤害，移除自身全部「勿」标记。当神能耗尽时，自身切换为「青巽」姿态。
处于「苍震」姿态：消耗神能施放三段攻击造成伤害，最后一段攻击在前方召唤数道「云雷」，根据穿插「风雷破」的时机，又演化出四式剑术，造成不同的雷属性伤害。
第一式：直接施放；
第二式：仅在第二段前穿插施放「风雷破」；
第三式：仅在第三段前穿插施放「风雷破」；
第四式：在第二段前和第三段前都穿插施放「风雷破」。]],
	...
	[1071305] = {
		...
		cd = 0,
		strengthen_desc = "",
		simpleDesc = "闪避效果：处于「青巽」姿态，触发多把「玉剑」攻击锁定的敌人；处于「苍震」姿态，下一次施放「益动势合」或「恒出运昌」时，获得硬直和格挡效果。",
		MaxUseCount = 2,
		abilities = "",
		id = 1071305,
		EnergyChange = 0,
...
<color=#0068C3>神能：普通攻击命中后会获得神能。</color>]],
	...
	[1035202] = {
		...
		cd = 9000,
		strengthen_desc = "",
		simpleDesc = "把对剑插入地面，召唤六道圆形涌浪攻击周围的敌人，造成水属性伤害。",
		MaxUseCount = 0,
		id = 1035202,
		EnergyChange = -25,
		desc = {
