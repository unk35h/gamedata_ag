return {
	Play104041001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot10 = uv0.bgs_.B04b

			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if slot10.GetComponent(slot10, "SpriteRenderer") then
					uv0.var_.alphaOldValueB04b = slot12.material:GetColor("_Color").a
					uv0.var_.alphaMatValueB04b = slot12.material
				end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot14 = Mathf.Lerp(uv0.var_.alphaOldValueB04b, 1, (uv0.time_ - slot11) / slot12)
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(-0.85, -1.16, -5), (uv0.time_ - slot15) / slot16)
			...
			if uv0.time_ >= slot15 + slot16 and uv0.time_ < slot15 + slot16 + slot0 then
				slot14.localPosition = Vector3.New(-0.85, -1.16, -5)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104041001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041001", "story_v_out_104041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104041", "104041001", "story_v_out_104041.awb") / 1000 > 0 and slot22 < slot27 and uv0.duration_ < slot27 + slot21 then
						slot22 = slot27
						uv0.duration_ = slot27 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						uv0:RecordAudio("104041001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_104041", "104041001", "story_v_out_104041.awb"))
					else
			...
			slot21 = slot21 + 0.3
			slot24 = uv0:FormatText(StoryWordCfg[104041001].content)
	...
	Play104041002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(0.9, -1.14, -5.21), (uv0.time_ - slot9) / slot10)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104041002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041002", "story_v_out_104041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104041", "104041002", "story_v_out_104041.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("104041002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104041", "104041002", "story_v_out_104041.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[104041002].content)
	...
	Play104041003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(20, -1.14, -5.21), (uv0.time_ - slot5) / slot6)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_2026")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104041003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041003", "story_v_out_104041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104041", "104041003", "story_v_out_104041.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("104041003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104041", "104041003", "story_v_out_104041.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[104041003].content)
	...
	Play104041004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(-0.85, -0.76, -5.4), (uv0.time_ - slot6) / slot7)
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 then
				slot5.localPosition = Vector3.New(-0.85, -0.76, -5.4)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104041004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041004", "story_v_out_104041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104041", "104041004", "story_v_out_104041.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("104041004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104041", "104041004", "story_v_out_104041.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[104041004].content)
			slot15 = string.split(slot13, ".")
	...
	Play104041005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104041005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041005", "story_v_out_104041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104041", "104041005", "story_v_out_104041.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("104041005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104041", "104041005", "story_v_out_104041.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[104041005].content)
	...
	Play104041006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(10, -0.76, -5.4), (uv0.time_ - slot12) / slot13)
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(10, -0.76, -5.4)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104041006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041006", "story_v_out_104041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104041", "104041006", "story_v_out_104041.awb") / 1000 > 0 and slot20 < slot24 and uv0.duration_ < slot24 + slot19 then
						slot20 = slot24
						uv0.duration_ = slot24 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						uv0:RecordAudio("104041006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_104041", "104041006", "story_v_out_104041.awb"))
					else
			...
			slot22 = uv0:FormatText(StoryWordCfg[104041006].content)
	...
	Play104041007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104041007].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[104041007].content)
	...
	Play104041008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(0, -1.14, -5.21), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104041008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041008", "story_v_out_104041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104041", "104041008", "story_v_out_104041.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("104041008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_104041", "104041008", "story_v_out_104041.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[104041008].content)
	...
	Play104041009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104041009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041009", "story_v_out_104041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104041", "104041009", "story_v_out_104041.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("104041009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104041", "104041009", "story_v_out_104041.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[104041009].content)
	...
	Play104041010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104041010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041010", "story_v_out_104041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104041", "104041010", "story_v_out_104041.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("104041010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104041", "104041010", "story_v_out_104041.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[104041010].content)
	...
	Play104041011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104041011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104041", "104041011", "story_v_out_104041.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104041", "104041011", "story_v_out_104041.awb") / 1000 > 0 and slot15 < slot19 and uv0.duration_ < slot19 + slot14 then
						slot15 = slot19
						uv0.duration_ = slot19 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						uv0:RecordAudio("104041011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_104041", "104041011", "story_v_out_104041.awb"))
					else
			...
			slot17 = uv0:FormatText(StoryWordCfg[104041011].content)
