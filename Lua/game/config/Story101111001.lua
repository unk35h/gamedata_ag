return {
	Play111101001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot3 = uv0.bgs_.S0404

			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if slot3.GetComponent(slot3, "SpriteRenderer") then
					uv0.var_.alphaOldValueS0404 = slot5.material:GetColor("_Color").a
					uv0.var_.alphaMatValueS0404 = slot5.material
				end
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				slot7 = Mathf.Lerp(uv0.var_.alphaOldValueS0404, 1, (uv0.time_ - slot4) / slot5)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101001].content)
			...
			slot15 = slot15 + 0.3
			slot18 = uv0:FormatText(StoryWordCfg[111101001].content)
	...
	Play111101002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101002].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[111101002].content)
	...
	Play111101003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101003", "story_v_out_111101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111101", "111101003", "story_v_out_111101.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("111101003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_111101", "111101003", "story_v_out_111101.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[111101003].content)
			slot6 = string.split(slot4, ".")
	...
	Play111101004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101004].content)
				uv0.typewritter.percent = 0
			...
			slot11 = uv0:FormatText(StoryWordCfg[111101004].content)
	...
	Play111101005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot12 = uv0.bgs_.D06a

			if 1 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				if slot12.GetComponent(slot12, "SpriteRenderer") then
					uv0.var_.alphaOldValueD06a = slot14.material:GetColor("_Color").a
					uv0.var_.alphaMatValueD06a = slot14.material
				end
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot16 = Mathf.Lerp(uv0.var_.alphaOldValueD06a, 1, (uv0.time_ - slot13) / slot14)
			...
			slot15 = uv0.bgs_.S0404

			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				if slot15.GetComponent(slot15, "SpriteRenderer") then
					uv0.var_.alphaOldValueS0404 = slot17.material:GetColor("_Color").a
					uv0.var_.alphaMatValueS0404 = slot17.material
				end
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				slot19 = Mathf.Lerp(uv0.var_.alphaOldValueS0404, 0, (uv0.time_ - slot16) / slot17)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101005", "story_v_out_111101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111101", "111101005", "story_v_out_111101.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("111101005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_111101", "111101005", "story_v_out_111101.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[111101005].content)
	...
	Play111101006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101006].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111101006].content)
	...
	Play111101007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101007", "story_v_out_111101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111101", "111101007", "story_v_out_111101.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("111101007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111101", "111101007", "story_v_out_111101.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[111101007].content)
	...
	Play111101008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101008", "story_v_out_111101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111101", "111101008", "story_v_out_111101.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("111101008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111101", "111101008", "story_v_out_111101.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[111101008].content)
	...
	Play111101009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101009", "story_v_out_111101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111101", "111101009", "story_v_out_111101.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("111101009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111101", "111101009", "story_v_out_111101.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[111101009].content)
			slot10 = string.split(slot8, ".")
	...
	Play111101010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101010", "story_v_out_111101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111101", "111101010", "story_v_out_111101.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("111101010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_111101", "111101010", "story_v_out_111101.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[111101010].content)
	...
	Play111101011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101011", "story_v_out_111101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111101", "111101011", "story_v_out_111101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("111101011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111101", "111101011", "story_v_out_111101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[111101011].content)
	...
	Play111101012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101012].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111101012].content)
			slot9 = string.split(slot7, ".")
	...
	Play111101013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101013", "story_v_out_111101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111101", "111101013", "story_v_out_111101.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("111101013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111101", "111101013", "story_v_out_111101.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[111101013].content)
			slot10 = string.split(slot8, ".")
	...
	Play111101014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101014].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111101014].content)
			slot9 = string.split(slot7, ".")
	...
	Play111101015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101015", "story_v_out_111101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111101", "111101015", "story_v_out_111101.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("111101015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111101", "111101015", "story_v_out_111101.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[111101015].content)
			slot11 = string.split(slot9, ".")
	...
	Play111101016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111101", "111101016", "story_v_out_111101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111101", "111101016", "story_v_out_111101.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("111101016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_111101", "111101016", "story_v_out_111101.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[111101016].content)
			slot13 = string.split(slot11, ".")
	...
	Play111101017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111101017].content)
				uv0.typewritter.percent = 0
			...
			slot9 = uv0:FormatText(StoryWordCfg[111101017].content)
			slot11 = string.split(slot9, ".")
