return {
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				if slot2.GetComponent(slot2, "SpriteRenderer") then
					uv0.var_.alphaOldValueST10 = slot4.material:GetColor("_Color").a
					uv0.var_.alphaMatValueST10 = slot4.material
				end
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot6 = Mathf.Lerp(uv0.var_.alphaOldValueST10, 1, (uv0.time_ - slot3) / slot4)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071001].content)
			...
			slot10 = slot10 + 0.3
			slot13 = uv0:FormatText(StoryWordCfg[106071001].content)
	...
	Play106071002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1026ui_story, Vector3.New(-0.83, -1.1, -5.4), (uv0.time_ - slot7) / slot8)
			...
			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 then
				slot6.localPosition = Vector3.New(-0.83, -1.1, -5.4)
			...
			if 0.2 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071002", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071002", "story_v_out_106071.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("106071002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_106071", "106071002", "story_v_out_106071.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[106071002].content)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				...
				if uv0.var_.characterEffect1026ui_story then
					...
					uv0.var_.characterEffect1026ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot7)
				end
			end
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1099ui_story, Vector3.New(0.84, -1.13, -5.3), (uv0.time_ - slot8) / slot9)
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0.84, -1.13, -5.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071003", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071003", "story_v_out_106071.awb") / 1000 > 0 and slot12 < slot16 and uv0.duration_ < slot16 + slot11 then
						slot12 = slot16
						uv0.duration_ = slot16 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						uv0:RecordAudio("106071003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_106071", "106071003", "story_v_out_106071.awb"))
					else
			...
			slot14 = uv0:FormatText(StoryWordCfg[106071003].content)
	...
	Play106071004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071004", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071004", "story_v_out_106071.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("106071004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106071", "106071004", "story_v_out_106071.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[106071004].content)
	...
	Play106071005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071005", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071005", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071005", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071005].content)
	...
	Play106071006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071006", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071006", "story_v_out_106071.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("106071006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_106071", "106071006", "story_v_out_106071.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[106071006].content)
	...
	Play106071007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071007", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071007", "story_v_out_106071.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("106071007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106071", "106071007", "story_v_out_106071.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[106071007].content)
			slot14 = string.split(slot12, ".")
	...
	Play106071008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071008", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071008", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071008", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071008].content)
			slot13 = string.split(slot11, ".")
	...
	Play106071009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1026ui_story, Vector3.New(10, -1.1, -5.4), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(10, -1.1, -5.4)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071009].content)
				uv0.typewritter.percent = 0
			...
			slot19 = uv0:FormatText(StoryWordCfg[106071009].content)
	...
	Play106071010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071010].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[106071010].content)
	...
	Play106071011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				uv0:AudioAction("play", "effect", "se_story_6", "se_story_6_sheath_retraction", "")
			end

			slot4 = 1

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				uv0:AudioAction("stop", "music", "se_story_6", "se_story_6_purple_lightning_loop", "")
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071011].content)
				uv0.typewritter.percent = 0
			...
			slot8 = uv0:FormatText(StoryWordCfg[106071011].content)
	...
	Play106071012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot4 = uv0.actors_["1026ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPos1026ui_story = slot4.localPosition
			end

			slot6 = 0.001

			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1026ui_story, Vector3.New(0, -1.1, -5.4), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071012", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071012", "story_v_out_106071.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("106071012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106071", "106071012", "story_v_out_106071.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[106071012].content)
			slot14 = string.split(slot12, ".")
	...
	Play106071013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071013].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[106071013].content)
	...
	Play106071014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071014", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071014", "story_v_out_106071.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("106071014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106071", "106071014", "story_v_out_106071.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[106071014].content)
			slot14 = string.split(slot12, ".")
	...
	Play106071015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071015", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071015", "story_v_out_106071.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("106071015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_106071", "106071015", "story_v_out_106071.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[106071015].content)
	...
	Play106071016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1026ui_story, Vector3.New(-0.83, -1.1, -5.4), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(-0.83, -1.1, -5.4)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			slot10 = uv0.actors_["1026ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.moveOldPos1026ui_story = slot10.localPosition
			end

			slot12 = 0.001

			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1026ui_story, Vector3.New(0, -1.1, -5.4), (uv0.time_ - slot11) / slot12)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1099ui_story, Vector3.New(0.84, -1.13, -5.3), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0.84, -1.13, -5.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071016", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071016", "story_v_out_106071.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("106071016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_106071", "106071016", "story_v_out_106071.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[106071016].content)
	...
	Play106071017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071017", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071017", "story_v_out_106071.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("106071017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106071", "106071017", "story_v_out_106071.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[106071017].content)
			slot14 = string.split(slot12, ".")
	...
	Play106071018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071018", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071018", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071018", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071018].content)
			slot13 = string.split(slot11, ".")
	...
	Play106071019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071019", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071019", "story_v_out_106071.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("106071019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_106071", "106071019", "story_v_out_106071.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[106071019].content)
			slot15 = string.split(slot13, ".")
	...
	Play106071020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071020", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071020", "story_v_out_106071.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("106071020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_106071", "106071020", "story_v_out_106071.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[106071020].content)
			slot7 = string.split(slot5, ".")
	...
	Play106071021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071021].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071021", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071021", "story_v_out_106071.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("106071021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_106071", "106071021", "story_v_out_106071.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[106071021].content)
			slot8 = string.split(slot6, ".")
	...
	Play106071022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071022].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071022", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071022", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071022", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071022].content)
			slot13 = string.split(slot11, ".")
	...
	Play106071023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071023", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071023", "story_v_out_106071.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("106071023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106071", "106071023", "story_v_out_106071.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[106071023].content)
			slot14 = string.split(slot12, ".")
	...
	Play106071024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071024", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071024", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071024", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071024].content)
			slot13 = string.split(slot11, ".")
	...
	Play106071025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071025", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071025", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071025", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071025].content)
			slot13 = string.split(slot11, ".")
	...
	Play106071026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071026].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071026", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071026", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071026", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071026].content)
			slot13 = string.split(slot11, ".")
	...
	Play106071027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071027].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071027", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071027", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071027", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071027", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071027].content)
			slot13 = string.split(slot11, ".")
	...
	Play106071028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071028].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071028", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071028", "story_v_out_106071.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("106071028", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106071", "106071028", "story_v_out_106071.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[106071028].content)
			slot14 = string.split(slot12, ".")
	...
	Play106071029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071029].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071029", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071029", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071029", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071029", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071029].content)
			slot13 = string.split(slot11, ".")
	...
	Play106071030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071030].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071030", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071030", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071030", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071030", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071030].content)
			slot13 = string.split(slot11, ".")
	...
	Play106071031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071031].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071031", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071031", "story_v_out_106071.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("106071031", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_106071", "106071031", "story_v_out_106071.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[106071031].content)
			slot7 = string.split(slot5, ".")
	...
	Play106071032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071032].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071032", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071032", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071032", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071032", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071032].content)
			slot13 = string.split(slot11, ".")
	...
	Play106071033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1026ui_story, Vector3.New(10, -1.1, -5.4), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(10, -1.1, -5.4)
				slot9 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot9.x, slot9.y, slot9.z)
				slot10 = slot4.localEulerAngles
				slot10.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_6062")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071033].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071033", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071033", "story_v_out_106071.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("106071033", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_106071", "106071033", "story_v_out_106071.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[106071033].content)
			slot15 = string.split(slot13, ".")
	...
	Play106071034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_6062")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071034].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071034", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071034", "story_v_out_106071.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("106071034", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_106071", "106071034", "story_v_out_106071.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[106071034].content)
			slot7 = string.split(slot5, ".")
	...
	Play106071035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1026ui_story, Vector3.New(-0.83, -1.1, -5.4), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(-0.83, -1.1, -5.4)
				slot9 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot9.x, slot9.y, slot9.z)
				slot10 = slot4.localEulerAngles
				slot10.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071035].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071035", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071035", "story_v_out_106071.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("106071035", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_106071", "106071035", "story_v_out_106071.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[106071035].content)
			slot17 = string.split(slot15, ".")
	...
	Play106071036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071036].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071036", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071036", "story_v_out_106071.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("106071036", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_106071", "106071036", "story_v_out_106071.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[106071036].content)
			slot13 = string.split(slot11, ".")
	...
	Play106071037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071037].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071037", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071037", "story_v_out_106071.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("106071037", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106071", "106071037", "story_v_out_106071.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[106071037].content)
			slot14 = string.split(slot12, ".")
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if slot4.GetComponent(slot4, "SpriteRenderer") then
					uv0.var_.alphaOldValueST10 = slot6.material:GetColor("_Color").a
					uv0.var_.alphaMatValueST10 = slot6.material
				end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot8 = Mathf.Lerp(uv0.var_.alphaOldValueST10, 0, (uv0.time_ - slot5) / slot6)
			...
			slot7 = uv0.bgs_.ST10.transform

			if 1.5 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosST10 = slot7.localPosition
			end
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				if slot11.GetComponent(slot11, "SpriteRenderer") then
					uv0.var_.alphaOldValueA00 = slot13.material:GetColor("_Color").a
					uv0.var_.alphaMatValueA00 = slot13.material
				end
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot15 = Mathf.Lerp(uv0.var_.alphaOldValueA00, 1, (uv0.time_ - slot12) / slot13)
			...
			slot15 = uv0.actors_["1099ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				uv0.var_.moveOldPos1099ui_story = slot15.localPosition
			end

			slot17 = 0.001

			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				slot15.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1099ui_story, Vector3.New(20, -1.13, -5.3), (uv0.time_ - slot16) / slot17)
			...
			if uv0.time_ >= slot16 + slot17 and uv0.time_ < slot16 + slot17 + slot0 then
				slot15.localPosition = Vector3.New(20, -1.13, -5.3)
			...
			slot18 = uv0.actors_["1026ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				uv0.var_.moveOldPos1026ui_story = slot18.localPosition
			end

			slot20 = 0.001

			if slot19 <= uv0.time_ and uv0.time_ < slot19 + slot20 then
				slot18.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1026ui_story, Vector3.New(10, -1.1, -5.4), (uv0.time_ - slot19) / slot20)
			...
			if uv0.time_ >= slot19 + slot20 and uv0.time_ < slot19 + slot20 + slot0 then
				slot18.localPosition = Vector3.New(10, -1.1, -5.4)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot23 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071038].content)
				uv0.typewritter.percent = 0
			...
			slot23 = slot23 + 0.3
			slot26 = uv0:FormatText(StoryWordCfg[106071038].content)
	...
	Play106071039 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071039].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071039", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071039", "story_v_out_106071.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("106071039", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_106071", "106071039", "story_v_out_106071.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[106071039].content)
			slot6 = string.split(slot4, ".")
	...
	Play106071040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071040].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071040", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071040", "story_v_out_106071.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("106071040", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_106071", "106071040", "story_v_out_106071.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[106071040].content)
			slot14 = string.split(slot12, ".")
	...
	Play106071041 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071041].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071041", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071041", "story_v_out_106071.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("106071041", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_106071", "106071041", "story_v_out_106071.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[106071041].content)
			slot9 = string.split(slot7, ".")
	...
	Play106071042 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071042].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071042", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071042", "story_v_out_106071.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("106071042", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_106071", "106071042", "story_v_out_106071.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[106071042].content)
			slot10 = string.split(slot8, ".")
	...
	Play106071043 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071043].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071043", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071043", "story_v_out_106071.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("106071043", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_106071", "106071043", "story_v_out_106071.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[106071043].content)
			slot9 = string.split(slot7, ".")
	...
	Play106071044 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071044].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071044", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071044", "story_v_out_106071.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("106071044", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_106071", "106071044", "story_v_out_106071.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[106071044].content)
	...
	Play106071045 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071045].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071045", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071045", "story_v_out_106071.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("106071045", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_106071", "106071045", "story_v_out_106071.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[106071045].content)
			slot9 = string.split(slot7, ".")
	...
	Play106071046 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071046].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071046", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071046", "story_v_out_106071.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("106071046", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_106071", "106071046", "story_v_out_106071.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[106071046].content)
			slot10 = string.split(slot8, ".")
	...
	Play106071047 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[106071047].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_106071", "106071047", "story_v_out_106071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_106071", "106071047", "story_v_out_106071.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("106071047", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_106071", "106071047", "story_v_out_106071.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[106071047].content)
			slot7 = string.split(slot5, ".")
