slot0 = class("ShopSkinContentView", ShopContentViewBase)

function slot0.InitUI(slot0)
	slot0.gameObject_ = Object.Instantiate(Asset.Load("UI/Shop/contentViews/skinView"), slot0.containerGo_.transform)
	slot0.transform_ = slot0.gameObject_.transform

	slot0:BindCfgUI()

	slot0.list_ = LuaList.New(handler(slot0, slot0.IndexItem), slot0.listGo_, ShopSkinItemView)
end
