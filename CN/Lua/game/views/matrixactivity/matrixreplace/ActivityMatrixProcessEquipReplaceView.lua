slot0 = class("ActivityMatrixProcessEquipReplaceView", MatrixProcessEquipReplaceView)

function slot0.InitUI(slot0)
	slot0:BindCfgUI()

	slot0.item_ = ActivityMatrixProcessRewardItem.New(slot0.m_item)
	slot0.list_ = LuaList.New(handler(slot0, slot0.indexItem), slot0.m_list, ActivityMatrixProcessRewardItem)
end
