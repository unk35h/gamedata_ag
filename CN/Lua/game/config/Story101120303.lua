return {
	Play112033001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112033001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_112033", "112033001", "story_v_out_112033.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112033", "112033001", "story_v_out_112033.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("112033001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_112033", "112033001", "story_v_out_112033.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[112033001].content)
	...
	Play112033002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112033002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112033", "112033002", "story_v_out_112033.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112033", "112033002", "story_v_out_112033.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("112033002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_112033", "112033002", "story_v_out_112033.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[112033002].content)
	...
	Play112033003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1027ui_story, Vector3.New(1.1, -0.86, -5.2), (uv0.time_ - slot11) / slot12)
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(1.1, -0.86, -5.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112033003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112033", "112033003", "story_v_out_112033.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112033", "112033003", "story_v_out_112033.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("112033003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_112033", "112033003", "story_v_out_112033.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[112033003].content)
			slot18 = string.split(slot16, ".")
	...
	Play112033004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112033004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112033", "112033004", "story_v_out_112033.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112033", "112033004", "story_v_out_112033.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("112033004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_112033", "112033004", "story_v_out_112033.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[112033004].content)
	...
	Play112033005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112033005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112033", "112033005", "story_v_out_112033.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112033", "112033005", "story_v_out_112033.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("112033005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_112033", "112033005", "story_v_out_112033.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[112033005].content)
			slot13 = string.split(slot11, ".")
	...
	Play112033006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[112033006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_112033", "112033006", "story_v_out_112033.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_112033", "112033006", "story_v_out_112033.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("112033006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_112033", "112033006", "story_v_out_112033.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[112033006].content)
			slot18 = string.split(slot16, ".")
