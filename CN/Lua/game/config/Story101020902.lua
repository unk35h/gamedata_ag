return {
	Play102092001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot12 = uv0.bgs_.B02c

			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				if slot12.GetComponent(slot12, "SpriteRenderer") then
					uv0.var_.alphaOldValueB02c = slot14.material:GetColor("_Color").a
					uv0.var_.alphaMatValueB02c = slot14.material
				end
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot16 = Mathf.Lerp(uv0.var_.alphaOldValueB02c, 1, (uv0.time_ - slot13) / slot14)
			...
			slot17 = uv0.actors_["1084ui_story"].transform

			if 1.8 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				uv0.var_.moveOldPos1084ui_story = slot17.localPosition
			...
			if slot18 <= uv0.time_ and uv0.time_ < slot18 + slot19 then
				slot17.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(0, -1.16, -5), (uv0.time_ - slot18) / slot19)
			...
			if uv0.time_ >= slot18 + slot19 and uv0.time_ < slot18 + slot19 + slot0 then
				slot17.localPosition = Vector3.New(0, -1.16, -5)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot23 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092001", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092001", "story_v_out_102092.awb") / 1000 > 0 and slot24 < slot29 and uv0.duration_ < slot29 + slot23 then
						slot24 = slot29
						uv0.duration_ = slot29 + slot23
					end

					if slot27.prefab_name ~= "" and uv0.actors_[slot27.prefab_name] ~= nil then
						uv0:RecordAudio("102092001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot27.prefab_name].transform, "story_v_out_102092", "102092001", "story_v_out_102092.awb"))
					else
			...
			slot23 = slot23 + 0.3
			slot26 = uv0:FormatText(StoryWordCfg[102092001].content)
	...
	Play102092002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092002].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[102092002].content)
	...
	Play102092003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092003", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092003", "story_v_out_102092.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("102092003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102092", "102092003", "story_v_out_102092.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[102092003].content)
	...
	Play102092004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				slot11.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0.88, -1.25, -5.2), (uv0.time_ - slot12) / slot13)
				slot17 = manager.ui.mainCamera.transform.position - slot11.position
				slot11.forward = Vector3.New(slot17.x, slot17.y, slot17.z)
				slot18 = slot11.localEulerAngles
				slot18.z = 0
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 then
				slot11.localPosition = Vector3.New(0.88, -1.25, -5.2)
				slot16 = manager.ui.mainCamera.transform.position - slot11.position
				slot11.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot11.localEulerAngles
				slot17.z = 0
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0, -1.25, -5.2), (uv0.time_ - slot15) / slot16)
			...
			if uv0.time_ >= slot15 + slot16 and uv0.time_ < slot15 + slot16 + slot0 then
				slot14.localPosition = Vector3.New(0, -1.25, -5.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092004", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092004", "story_v_out_102092.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("102092004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102092", "102092004", "story_v_out_102092.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[102092004].content)
	...
	Play102092005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092005", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092005", "story_v_out_102092.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102092005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102092", "102092005", "story_v_out_102092.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102092005].content)
	...
	Play102092006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092006", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092006", "story_v_out_102092.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("102092006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_102092", "102092006", "story_v_out_102092.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[102092006].content)
	...
	Play102092007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot5 = uv0.actors_["10002_tpose"]

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.var_.characterEffect10002_tpose == nil then
				uv0.var_.characterEffect10002_tpose = slot5.GetComponentInChildren(slot5, typeof(CharacterEffect))
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				...
				if uv0.var_.characterEffect10002_tpose then
					uv0.var_.characterEffect10002_tpose.fillFlat = true
					uv0.var_.characterEffect10002_tpose.fillRatio = Mathf.Lerp(0, 0.5, slot8)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092007", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092007", "story_v_out_102092.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("102092007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102092", "102092007", "story_v_out_102092.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[102092007].content)
			slot21 = string.split(slot19, ".")
	...
	Play102092008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092008", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092008", "story_v_out_102092.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("102092008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102092", "102092008", "story_v_out_102092.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[102092008].content)
	...
	Play102092009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092009", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092009", "story_v_out_102092.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("102092009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102092", "102092009", "story_v_out_102092.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[102092009].content)
	...
	Play102092010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092010", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092010", "story_v_out_102092.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("102092010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_102092", "102092010", "story_v_out_102092.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[102092010].content)
	...
	Play102092011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092011", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092011", "story_v_out_102092.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102092011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102092", "102092011", "story_v_out_102092.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102092011].content)
	...
	Play102092012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092012", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092012", "story_v_out_102092.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102092012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102092", "102092012", "story_v_out_102092.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102092012].content)
			slot14 = string.split(slot12, ".")
	...
	Play102092013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092013", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092013", "story_v_out_102092.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("102092013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102092", "102092013", "story_v_out_102092.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[102092013].content)
			slot13 = string.split(slot11, ".")
	...
	Play102092014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot13 = uv0.actors_["10002_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPos10002_tpose = slot13.localPosition
			end

			slot15 = 0.001

			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0.88, -1.25, -5.2), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0.88, -1.25, -5.2)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092014", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092014", "story_v_out_102092.awb") / 1000 > 0 and slot18 < slot22 and uv0.duration_ < slot22 + slot17 then
						slot18 = slot22
						uv0.duration_ = slot22 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						uv0:RecordAudio("102092014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_102092", "102092014", "story_v_out_102092.awb"))
					else
			...
			slot20 = uv0:FormatText(StoryWordCfg[102092014].content)
	...
	Play102092015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092015", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092015", "story_v_out_102092.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("102092015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_102092", "102092015", "story_v_out_102092.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[102092015].content)
			slot7 = string.split(slot5, ".")
	...
	Play102092016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092016", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092016", "story_v_out_102092.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("102092016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_102092", "102092016", "story_v_out_102092.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[102092016].content)
			slot7 = string.split(slot5, ".")
	...
	Play102092017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092017", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092017", "story_v_out_102092.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("102092017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102092", "102092017", "story_v_out_102092.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[102092017].content)
			slot8 = string.split(slot6, ".")
	...
	Play102092018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092018", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092018", "story_v_out_102092.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("102092018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102092", "102092018", "story_v_out_102092.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[102092018].content)
			slot23 = string.split(slot21, ".")
	...
	Play102092019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092019", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092019", "story_v_out_102092.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102092019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102092", "102092019", "story_v_out_102092.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102092019].content)
			slot14 = string.split(slot12, ".")
	...
	Play102092020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092020", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092020", "story_v_out_102092.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("102092020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_102092", "102092020", "story_v_out_102092.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[102092020].content)
	...
	Play102092021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092021].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092021", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092021", "story_v_out_102092.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
						slot8 = slot12
						uv0.duration_ = slot12 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						uv0:RecordAudio("102092021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_102092", "102092021", "story_v_out_102092.awb"))
					else
			...
			slot10 = uv0:FormatText(StoryWordCfg[102092021].content)
	...
	Play102092022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092022].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092022", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092022", "story_v_out_102092.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102092022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102092", "102092022", "story_v_out_102092.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102092022].content)
			slot14 = string.split(slot12, ".")
	...
	Play102092023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(10, -0.76, -5.4), (uv0.time_ - slot5) / slot6)
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(10, -0.76, -5.4)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0, -1.25, -5.2), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0, -1.25, -5.2)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092023", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092023", "story_v_out_102092.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("102092023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102092", "102092023", "story_v_out_102092.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[102092023].content)
	...
	Play102092024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092024", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092024", "story_v_out_102092.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("102092024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_102092", "102092024", "story_v_out_102092.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[102092024].content)
			slot11 = string.split(slot9, ".")
	...
	Play102092025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092025", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092025", "story_v_out_102092.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("102092025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_102092", "102092025", "story_v_out_102092.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[102092025].content)
			slot9 = string.split(slot7, ".")
	...
	Play102092026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10002_tpose, Vector3.New(0.88, -1.25, -5.2), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0.88, -1.25, -5.2)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092026].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092026", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092026", "story_v_out_102092.awb") / 1000 > 0 and slot18 < slot22 and uv0.duration_ < slot22 + slot17 then
						slot18 = slot22
						uv0.duration_ = slot22 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						uv0:RecordAudio("102092026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_102092", "102092026", "story_v_out_102092.awb"))
					else
			...
			slot20 = uv0:FormatText(StoryWordCfg[102092026].content)
			slot22 = string.split(slot20, ".")
	...
	Play102092027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092027].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092027", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092027", "story_v_out_102092.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102092027", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102092", "102092027", "story_v_out_102092.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102092027].content)
			slot14 = string.split(slot12, ".")
	...
	Play102092028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102092028].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102092", "102092028", "story_v_out_102092.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102092", "102092028", "story_v_out_102092.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102092028", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102092", "102092028", "story_v_out_102092.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102092028].content)
			slot14 = string.split(slot12, ".")
