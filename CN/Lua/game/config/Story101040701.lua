return {
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if slot10.GetComponent(slot10, "SpriteRenderer") then
					uv0.var_.alphaOldValueB06a = slot12.material:GetColor("_Color").a
					uv0.var_.alphaMatValueB06a = slot12.material
				end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot14 = Mathf.Lerp(uv0.var_.alphaOldValueB06a, 1, (uv0.time_ - slot11) / slot12)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071001", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071001", "story_v_out_104071.awb") / 1000 > 0 and slot21 < slot26 and uv0.duration_ < slot26 + slot20 then
						slot21 = slot26
						uv0.duration_ = slot26 + slot20
					end

					if slot24.prefab_name ~= "" and uv0.actors_[slot24.prefab_name] ~= nil then
						uv0:RecordAudio("104071001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot24.prefab_name].transform, "story_v_out_104071", "104071001", "story_v_out_104071.awb"))
					else
			...
			slot20 = slot20 + 0.3
			slot23 = uv0:FormatText(StoryWordCfg[104071001].content)
	...
	Play104071002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071002", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071002", "story_v_out_104071.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("104071002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104071", "104071002", "story_v_out_104071.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[104071002].content)
	...
	Play104071003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071003", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071003", "story_v_out_104071.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("104071003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104071", "104071003", "story_v_out_104071.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[104071003].content)
	...
	Play104071004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot14.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(0, -1.16, -5), (uv0.time_ - slot15) / slot16)
				slot20 = manager.ui.mainCamera.transform.position - slot14.position
				slot14.forward = Vector3.New(slot20.x, slot20.y, slot20.z)
				slot21 = slot14.localEulerAngles
				slot21.z = 0
			...
			if uv0.time_ >= slot15 + slot16 and uv0.time_ < slot15 + slot16 + slot0 then
				slot14.localPosition = Vector3.New(0, -1.16, -5)
				slot19 = manager.ui.mainCamera.transform.position - slot14.position
				slot14.forward = Vector3.New(slot19.x, slot19.y, slot19.z)
				slot20 = slot14.localEulerAngles
				slot20.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071004", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071004", "story_v_out_104071.awb") / 1000 > 0 and slot20 < slot24 and uv0.duration_ < slot24 + slot19 then
						slot20 = slot24
						uv0.duration_ = slot24 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						uv0:RecordAudio("104071004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_104071", "104071004", "story_v_out_104071.awb"))
					else
			...
			slot22 = uv0:FormatText(StoryWordCfg[104071004].content)
	...
	Play104071005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071005", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071005", "story_v_out_104071.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("104071005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104071", "104071005", "story_v_out_104071.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[104071005].content)
	...
	Play104071006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071006].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[104071006].content)
	...
	Play104071007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(0, -1.14, -5.21), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0, -1.14, -5.21)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071007", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071007", "story_v_out_104071.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("104071007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104071", "104071007", "story_v_out_104071.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[104071007].content)
			slot18 = string.split(slot16, ".")
	...
	Play104071008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071008", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071008", "story_v_out_104071.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("104071008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104071", "104071008", "story_v_out_104071.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[104071008].content)
			slot9 = string.split(slot7, ".")
	...
	Play104071009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071009", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071009", "story_v_out_104071.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("104071009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_104071", "104071009", "story_v_out_104071.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[104071009].content)
	...
	Play104071010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1037")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071010", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071010", "story_v_out_104071.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("104071010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104071", "104071010", "story_v_out_104071.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[104071010].content)
			slot9 = string.split(slot7, ".")
	...
	Play104071011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071011", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071011", "story_v_out_104071.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("104071011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_104071", "104071011", "story_v_out_104071.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[104071011].content)
			slot11 = string.split(slot9, ".")
	...
	Play104071012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071012", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071012", "story_v_out_104071.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("104071012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_104071", "104071012", "story_v_out_104071.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[104071012].content)
	...
	Play104071013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1037")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071013", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071013", "story_v_out_104071.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("104071013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104071", "104071013", "story_v_out_104071.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[104071013].content)
			slot9 = string.split(slot7, ".")
	...
	Play104071014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071014", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071014", "story_v_out_104071.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("104071014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_104071", "104071014", "story_v_out_104071.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[104071014].content)
			slot11 = string.split(slot9, ".")
	...
	Play104071015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071015", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071015", "story_v_out_104071.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("104071015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104071", "104071015", "story_v_out_104071.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[104071015].content)
			slot20 = string.split(slot18, ".")
	...
	Play104071016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071016", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071016", "story_v_out_104071.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("104071016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104071", "104071016", "story_v_out_104071.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[104071016].content)
			slot9 = string.split(slot7, ".")
	...
	Play104071017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071017", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071017", "story_v_out_104071.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("104071017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_104071", "104071017", "story_v_out_104071.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[104071017].content)
			slot18 = string.split(slot16, ".")
	...
	Play104071018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071018", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071018", "story_v_out_104071.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("104071018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104071", "104071018", "story_v_out_104071.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[104071018].content)
	...
	Play104071019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071019", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071019", "story_v_out_104071.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("104071019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_104071", "104071019", "story_v_out_104071.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[104071019].content)
	...
	Play104071020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071020", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071020", "story_v_out_104071.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("104071020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104071", "104071020", "story_v_out_104071.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[104071020].content)
			slot9 = string.split(slot7, ".")
	...
	Play104071021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071021].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071021", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071021", "story_v_out_104071.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("104071021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_104071", "104071021", "story_v_out_104071.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[104071021].content)
			slot17 = string.split(slot15, ".")
	...
	Play104071022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071022].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071022", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071022", "story_v_out_104071.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("104071022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_104071", "104071022", "story_v_out_104071.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[104071022].content)
			slot20 = string.split(slot18, ".")
	...
	Play104071023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071023", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071023", "story_v_out_104071.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("104071023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_104071", "104071023", "story_v_out_104071.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[104071023].content)
			slot8 = string.split(slot6, ".")
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				if slot1.GetComponent(slot1, "SpriteRenderer") then
					uv0.var_.alphaOldValueB06a = slot3.material:GetColor("_Color").a
					uv0.var_.alphaMatValueB06a = slot3.material
				end
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot5 = Mathf.Lerp(uv0.var_.alphaOldValueB06a, 0, (uv0.time_ - slot2) / slot3)
			...
			slot4 = uv0.bgs_.B06a.transform

			if 1.5 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPosB06a = slot4.localPosition
			end
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019ui_story, Vector3.New(10, -1.13, -5.3), (uv0.time_ - slot13) / slot14)
			...
			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 then
				slot12.localPosition = Vector3.New(10, -1.13, -5.3)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071024].content)
				uv0.typewritter.percent = 0
			...
			slot20 = uv0:FormatText(StoryWordCfg[104071024].content)
	...
	Play104071025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071025].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[104071025].content)
	...
	Play104071026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071026].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071026", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071026", "story_v_out_104071.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("104071026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104071", "104071026", "story_v_out_104071.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[104071026].content)
			slot6 = string.split(slot4, ".")
	...
	Play104071027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071027].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[104071027].content)
			slot6 = string.split(slot4, ".")
	...
	Play104071028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071028].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[104071028].content)
			slot9 = string.split(slot7, ".")
	...
	Play104071029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071029].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[104071029].content)
			slot6 = string.split(slot4, ".")
	...
	Play104071030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071030].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071030", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071030", "story_v_out_104071.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("104071030", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_104071", "104071030", "story_v_out_104071.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[104071030].content)
			slot6 = string.split(slot4, ".")
	...
	Play104071031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071031].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[104071031].content)
			slot6 = string.split(slot4, ".")
	...
	Play104071032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071032].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071032", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071032", "story_v_out_104071.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("104071032", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_104071", "104071032", "story_v_out_104071.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[104071032].content)
	...
	Play104071033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071033].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071033", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071033", "story_v_out_104071.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("104071033", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_104071", "104071033", "story_v_out_104071.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[104071033].content)
			slot9 = string.split(slot7, ".")
	...
	Play104071034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071034].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_104071", "104071034", "story_v_out_104071.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_104071", "104071034", "story_v_out_104071.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("104071034", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_104071", "104071034", "story_v_out_104071.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[104071034].content)
			slot11 = string.split(slot9, ".")
	...
	Play104071035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071035].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[104071035].content)
	...
	Play104071036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[104071036].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[104071036].content)
			slot6 = string.split(slot4, ".")
