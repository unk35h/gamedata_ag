		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if slot10.GetComponent(slot10, "SpriteRenderer") then
					uv0.var_.alphaOldValueA06 = slot12.material:GetColor("_Color").a
					uv0.var_.alphaMatValueA06 = slot12.material
				end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot14 = Mathf.Lerp(uv0.var_.alphaOldValueA06, 1, (uv0.time_ - slot11) / slot12)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032001", "story_v_out_100032.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100032", "100032001", "story_v_out_100032.awb") / 1000 > 0 and slot22 < slot27 and uv0.duration_ < slot27 + slot21 then
						slot22 = slot27
						uv0.duration_ = slot27 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						uv0:RecordAudio("100032001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_100032", "100032001", "story_v_out_100032.awb"))
					else
			...
			slot21 = slot21 + 0.3
			slot24 = uv0:FormatText(StoryWordCfg[100032001].content)
	...
	Play100032002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1148ui_story, Vector3.New(0.83, -0.85, -5.6), (uv0.time_ - slot9) / slot10)
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0.83, -0.85, -5.6)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032002", "story_v_out_100032.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100032", "100032002", "story_v_out_100032.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("100032002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_100032", "100032002", "story_v_out_100032.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[100032002].content)
	...
	Play100032003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032003", "story_v_out_100032.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100032", "100032003", "story_v_out_100032.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("100032003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_100032", "100032003", "story_v_out_100032.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[100032003].content)
	...
	Play100032004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032004", "story_v_out_100032.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100032", "100032004", "story_v_out_100032.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("100032004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_100032", "100032004", "story_v_out_100032.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[100032004].content)
			slot14 = string.split(slot12, ".")
	...
	Play100032005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032005", "story_v_out_100032.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100032", "100032005", "story_v_out_100032.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("100032005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_100032", "100032005", "story_v_out_100032.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[100032005].content)
	...
	Play100032006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032006", "story_v_out_100032.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100032", "100032006", "story_v_out_100032.awb") / 1000 > 0 and slot12 < slot16 and uv0.duration_ < slot16 + slot11 then
						slot12 = slot16
						uv0.duration_ = slot16 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						uv0:RecordAudio("100032006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_100032", "100032006", "story_v_out_100032.awb"))
					else
			...
			slot14 = uv0:FormatText(StoryWordCfg[100032006].content)
	...
	Play100032007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032007].content)
				uv0.typewritter.percent = 0
			...
			slot12 = uv0:FormatText(StoryWordCfg[100032007].content)
			slot14 = string.split(slot12, ".")
	...
	Play100032008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032008", "story_v_out_100032.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100032", "100032008", "story_v_out_100032.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("100032008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_100032", "100032008", "story_v_out_100032.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[100032008].content)
			slot14 = string.split(slot12, ".")
	...
	Play100032009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032009", "story_v_out_100032.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100032", "100032009", "story_v_out_100032.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("100032009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_100032", "100032009", "story_v_out_100032.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[100032009].content)
	...
	Play100032010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032010].content)
				uv0.typewritter.percent = 0
			...
			slot9 = uv0:FormatText(StoryWordCfg[100032010].content)
	...
	Play100032011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032011", "story_v_out_100032.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100032", "100032011", "story_v_out_100032.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("100032011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_100032", "100032011", "story_v_out_100032.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[100032011].content)
			slot14 = string.split(slot12, ".")
	...
	Play100032012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032012", "story_v_out_100032.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100032", "100032012", "story_v_out_100032.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("100032012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_100032", "100032012", "story_v_out_100032.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[100032012].content)
	...
	Play100032013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100032013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100032", "100032013", "story_v_out_100032.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100032", "100032013", "story_v_out_100032.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("100032013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_100032", "100032013", "story_v_out_100032.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[100032013].content)
