return {
	Play102061001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot8 = uv0.actors_["2025_tpose"]

			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 and uv0.var_.characterEffect2025_tpose == nil then
				uv0.var_.characterEffect2025_tpose = slot8.GetComponentInChildren(slot8, typeof(CharacterEffect))
			end
			...
			slot12 = uv0.bgs_.B02a

			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				if slot12.GetComponent(slot12, "SpriteRenderer") then
					uv0.var_.alphaOldValueB02a = slot14.material:GetColor("_Color").a
					uv0.var_.alphaMatValueB02a = slot14.material
				end
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot16 = Mathf.Lerp(uv0.var_.alphaOldValueB02a, 1, (uv0.time_ - slot13) / slot14)
			...
			slot16 = uv0.actors_["2025_tpose"].transform

			if 1.79999995231628 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				uv0.var_.moveOldPos2025_tpose = slot16.localPosition
			end

			slot18 = 0.001

			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				slot16.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2025_tpose, Vector3.New(0, -1.47, -3.7), (uv0.time_ - slot17) / slot18)
			...
			if uv0.time_ >= slot17 + slot18 and uv0.time_ < slot17 + slot18 + slot0 then
				slot16.localPosition = Vector3.New(0, -1.47, -3.7)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot22 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061001", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061001", "story_v_out_102061.awb") / 1000 > 0 and slot23 < slot28 and uv0.duration_ < slot28 + slot22 then
						slot23 = slot28
						uv0.duration_ = slot28 + slot22
					end

					if slot26.prefab_name ~= "" and uv0.actors_[slot26.prefab_name] ~= nil then
						uv0:RecordAudio("102061001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot26.prefab_name].transform, "story_v_out_102061", "102061001", "story_v_out_102061.awb"))
					else
			...
			slot22 = slot22 + 0.3
			slot25 = uv0:FormatText(StoryWordCfg[102061001].content)
	...
	Play102061002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061002", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061002", "story_v_out_102061.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("102061002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102061", "102061002", "story_v_out_102061.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[102061002].content)
	...
	Play102061003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot5 = uv0.actors_["2025_tpose"]

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.var_.characterEffect2025_tpose == nil then
				uv0.var_.characterEffect2025_tpose = slot5.GetComponentInChildren(slot5, typeof(CharacterEffect))
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				...
				if uv0.var_.characterEffect2025_tpose then
					...
					uv0.var_.characterEffect2025_tpose.fillRatio = Mathf.Lerp(0, 0.5, slot8)
				end
			end
			...
			slot8 = uv0.actors_["2025_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPos2025_tpose = slot8.localPosition
			end

			slot10 = 0.001

			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2025_tpose, Vector3.New(10, -1.47, -3.7), (uv0.time_ - slot9) / slot10)
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(10, -1.47, -3.7)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061003", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061003", "story_v_out_102061.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("102061003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102061", "102061003", "story_v_out_102061.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[102061003].content)
	...
	Play102061004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061004", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061004", "story_v_out_102061.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("102061004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102061", "102061004", "story_v_out_102061.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[102061004].content)
	...
	Play102061005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061005", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061005", "story_v_out_102061.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("102061005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102061", "102061005", "story_v_out_102061.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[102061005].content)
			slot8 = string.split(slot6, ".")
	...
	Play102061006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061006", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061006", "story_v_out_102061.awb") / 1000 > 0 and slot20 < slot24 and uv0.duration_ < slot24 + slot19 then
						slot20 = slot24
						uv0.duration_ = slot24 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						uv0:RecordAudio("102061006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_102061", "102061006", "story_v_out_102061.awb"))
					else
			...
			slot22 = uv0:FormatText(StoryWordCfg[102061006].content)
	...
	Play102061007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061007", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061007", "story_v_out_102061.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("102061007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_102061", "102061007", "story_v_out_102061.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[102061007].content)
	...
	Play102061008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061008", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061008", "story_v_out_102061.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102061008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102061", "102061008", "story_v_out_102061.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102061008].content)
	...
	Play102061009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061009", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061009", "story_v_out_102061.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("102061009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_102061", "102061009", "story_v_out_102061.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[102061009].content)
	...
	Play102061010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061010", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061010", "story_v_out_102061.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("102061010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_102061", "102061010", "story_v_out_102061.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[102061010].content)
			slot21 = string.split(slot19, ".")
	...
	Play102061011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2020_tpose, Vector3.New(1.1, -1.25, -3.5), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(1.1, -1.25, -3.5)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061011", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061011", "story_v_out_102061.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("102061011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102061", "102061011", "story_v_out_102061.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[102061011].content)
	...
	Play102061012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061012", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061012", "story_v_out_102061.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102061012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102061", "102061012", "story_v_out_102061.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102061012].content)
			slot20 = string.split(slot18, ".")
	...
	Play102061013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061013", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061013", "story_v_out_102061.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
						slot8 = slot12
						uv0.duration_ = slot12 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						uv0:RecordAudio("102061013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_102061", "102061013", "story_v_out_102061.awb"))
					else
			...
			slot10 = uv0:FormatText(StoryWordCfg[102061013].content)
	...
	Play102061014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061014", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061014", "story_v_out_102061.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102061014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102061", "102061014", "story_v_out_102061.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102061014].content)
			slot20 = string.split(slot18, ".")
	...
	Play102061015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061015", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061015", "story_v_out_102061.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102061015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102061", "102061015", "story_v_out_102061.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102061015].content)
	...
	Play102061016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061016", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061016", "story_v_out_102061.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102061016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102061", "102061016", "story_v_out_102061.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102061016].content)
			slot20 = string.split(slot18, ".")
	...
	Play102061017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(0, -1.56, -3.7), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0, -1.56, -3.7)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061017", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061017", "story_v_out_102061.awb") / 1000 > 0 and slot12 < slot16 and uv0.duration_ < slot16 + slot11 then
						slot12 = slot16
						uv0.duration_ = slot16 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						uv0:RecordAudio("102061017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_102061", "102061017", "story_v_out_102061.awb"))
					else
			...
			slot14 = uv0:FormatText(StoryWordCfg[102061017].content)
	...
	Play102061018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061018", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061018", "story_v_out_102061.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("102061018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_102061", "102061018", "story_v_out_102061.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[102061018].content)
	...
	Play102061019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061019", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061019", "story_v_out_102061.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("102061019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_102061", "102061019", "story_v_out_102061.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[102061019].content)
	...
	Play102061020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061020", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061020", "story_v_out_102061.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("102061020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_102061", "102061020", "story_v_out_102061.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[102061020].content)
			slot7 = string.split(slot5, ".")
	...
	Play102061021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102061021].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102061", "102061021", "story_v_out_102061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102061", "102061021", "story_v_out_102061.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102061021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102061", "102061021", "story_v_out_102061.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102061021].content)
			slot20 = string.split(slot18, ".")
