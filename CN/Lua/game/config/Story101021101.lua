return {
	Play102111001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111001", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111001", "story_v_out_102111.awb") / 1000 > 0 and slot22 < slot27 and uv0.duration_ < slot27 + slot21 then
						slot22 = slot27
						uv0.duration_ = slot27 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						uv0:RecordAudio("102111001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_102111", "102111001", "story_v_out_102111.awb"))
					else
			...
			slot21 = slot21 + 0.3
			slot24 = uv0:FormatText(StoryWordCfg[102111001].content)
	...
	Play102111002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111002", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111002", "story_v_out_102111.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("102111002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102111", "102111002", "story_v_out_102111.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[102111002].content)
	...
	Play102111003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111003", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111003", "story_v_out_102111.awb") / 1000 > 0 and slot20 < slot24 and uv0.duration_ < slot24 + slot19 then
						slot20 = slot24
						uv0.duration_ = slot24 + slot19
					end

					if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
						uv0:RecordAudio("102111003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_out_102111", "102111003", "story_v_out_102111.awb"))
					else
			...
			slot22 = uv0:FormatText(StoryWordCfg[102111003].content)
	...
	Play102111004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111004", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111004", "story_v_out_102111.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("102111004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102111", "102111004", "story_v_out_102111.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[102111004].content)
	...
	Play102111005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111005", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111005", "story_v_out_102111.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("102111005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_102111", "102111005", "story_v_out_102111.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[102111005].content)
	...
	Play102111006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(0, -1.56, -3.7), (uv0.time_ - slot11) / slot12)
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(0, -1.56, -3.7)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111006", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111006", "story_v_out_102111.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102111006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102111", "102111006", "story_v_out_102111.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102111006].content)
	...
	Play102111007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111007", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111007", "story_v_out_102111.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102111007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102111", "102111007", "story_v_out_102111.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102111007].content)
			slot20 = string.split(slot18, ".")
	...
	Play102111008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111008", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111008", "story_v_out_102111.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("102111008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102111", "102111008", "story_v_out_102111.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[102111008].content)
			slot18 = string.split(slot16, ".")
	...
	Play102111009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(0, -1.16, -5), (uv0.time_ - slot14) / slot15)
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0, -1.16, -5)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111009", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111009", "story_v_out_102111.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("102111009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102111", "102111009", "story_v_out_102111.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[102111009].content)
	...
	Play102111010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(-0.85, -0.76, -5.4), (uv0.time_ - slot11) / slot12)
				slot16 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot10.localEulerAngles
				slot17.z = 0
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(-0.85, -0.76, -5.4)
				slot15 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot15.x, slot15.y, slot15.z)
				slot16 = slot10.localEulerAngles
				slot16.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111010", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111010", "story_v_out_102111.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102111010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102111", "102111010", "story_v_out_102111.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102111010].content)
			slot20 = string.split(slot18, ".")
	...
	Play102111011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111011", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111011", "story_v_out_102111.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("102111011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_102111", "102111011", "story_v_out_102111.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[102111011].content)
			slot17 = string.split(slot15, ".")
	...
	Play102111012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot13 = uv0.actors_["3008ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				uv0.var_.moveOldPos3008ui_story = slot13.localPosition
			end

			slot15 = 0.001

			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				slot13.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(0, -1.56, -3.7), (uv0.time_ - slot14) / slot15)
				slot19 = manager.ui.mainCamera.transform.position - slot13.position
				slot13.forward = Vector3.New(slot19.x, slot19.y, slot19.z)
				slot20 = slot13.localEulerAngles
				slot20.z = 0
			...
			if uv0.time_ >= slot14 + slot15 and uv0.time_ < slot14 + slot15 + slot0 then
				slot13.localPosition = Vector3.New(0, -1.56, -3.7)
				slot18 = manager.ui.mainCamera.transform.position - slot13.position
				slot13.forward = Vector3.New(slot18.x, slot18.y, slot18.z)
				slot19 = slot13.localEulerAngles
				slot19.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111012", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111012", "story_v_out_102111.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("102111012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102111", "102111012", "story_v_out_102111.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[102111012].content)
			slot23 = string.split(slot21, ".")
	...
	Play102111013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot16 = uv0.actors_["2030_tpose"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				uv0.var_.moveOldPos2030_tpose = slot16.localPosition
			end

			slot18 = 0.001

			if slot17 <= uv0.time_ and uv0.time_ < slot17 + slot18 then
				slot16.localPosition = Vector3.Lerp(uv0.var_.moveOldPos2030_tpose, Vector3.New(1.1, -1.25, -3.5), (uv0.time_ - slot17) / slot18)
			...
			if uv0.time_ >= slot17 + slot18 and uv0.time_ < slot17 + slot18 + slot0 then
				slot16.localPosition = Vector3.New(1.1, -1.25, -3.5)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111013", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111013", "story_v_out_102111.awb") / 1000 > 0 and slot21 < slot25 and uv0.duration_ < slot25 + slot20 then
						slot21 = slot25
						uv0.duration_ = slot25 + slot20
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						uv0:RecordAudio("102111013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_102111", "102111013", "story_v_out_102111.awb"))
					else
			...
			slot23 = uv0:FormatText(StoryWordCfg[102111013].content)
	...
	Play102111014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111014", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111014", "story_v_out_102111.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
						slot8 = slot12
						uv0.duration_ = slot12 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						uv0:RecordAudio("102111014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_102111", "102111014", "story_v_out_102111.awb"))
					else
			...
			slot10 = uv0:FormatText(StoryWordCfg[102111014].content)
	...
	Play102111015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111015", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111015", "story_v_out_102111.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
						slot8 = slot12
						uv0.duration_ = slot12 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						uv0:RecordAudio("102111015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_102111", "102111015", "story_v_out_102111.awb"))
					else
			...
			slot10 = uv0:FormatText(StoryWordCfg[102111015].content)
			slot12 = string.split(slot10, ".")
	...
	Play102111016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111016", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111016", "story_v_out_102111.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("102111016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102111", "102111016", "story_v_out_102111.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[102111016].content)
			slot23 = string.split(slot21, ".")
	...
	Play102111017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111017", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111017", "story_v_out_102111.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("102111017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_102111", "102111017", "story_v_out_102111.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[102111017].content)
	...
	Play102111018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111018", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111018", "story_v_out_102111.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("102111018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_102111", "102111018", "story_v_out_102111.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[102111018].content)
			slot9 = string.split(slot7, ".")
	...
	Play102111019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111019].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[102111019].content)
			slot8 = string.split(slot6, ".")
	...
	Play102111020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111020", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111020", "story_v_out_102111.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102111020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102111", "102111020", "story_v_out_102111.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102111020].content)
	...
	Play102111021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111021].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[102111021].content)
			slot12 = string.split(slot10, ".")
	...
	Play102111022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111022].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111022", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111022", "story_v_out_102111.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102111022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102111", "102111022", "story_v_out_102111.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102111022].content)
			slot14 = string.split(slot12, ".")
	...
	Play102111023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3008ui_story, Vector3.New(-1.1, -1.56, -3.7), (uv0.time_ - slot11) / slot12)
				slot16 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot10.localEulerAngles
				slot17.z = 0
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(-1.1, -1.56, -3.7)
				slot15 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot15.x, slot15.y, slot15.z)
				slot16 = slot10.localEulerAngles
				slot16.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111023", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111023", "story_v_out_102111.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("102111023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_102111", "102111023", "story_v_out_102111.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[102111023].content)
			slot20 = string.split(slot18, ".")
	...
	Play102111024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111024", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111024", "story_v_out_102111.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("102111024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_102111", "102111024", "story_v_out_102111.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[102111024].content)
			slot18 = string.split(slot16, ".")
	...
	Play102111025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111025", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111025", "story_v_out_102111.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102111025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102111", "102111025", "story_v_out_102111.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102111025].content)
			slot14 = string.split(slot12, ".")
	...
	Play102111026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111026].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111026", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111026", "story_v_out_102111.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("102111026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102111", "102111026", "story_v_out_102111.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[102111026].content)
	...
	Play102111027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111027].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111027", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111027", "story_v_out_102111.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("102111027", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_102111", "102111027", "story_v_out_102111.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[102111027].content)
			slot14 = string.split(slot12, ".")
	...
	Play102111028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111028].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111028", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111028", "story_v_out_102111.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("102111028", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102111", "102111028", "story_v_out_102111.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[102111028].content)
			slot13 = string.split(slot11, ".")
	...
	Play102111029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot15 = uv0.actors_["3008ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				uv0.var_.moveOldPos3008ui_story = slot15.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111029].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111029", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111029", "story_v_out_102111.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("102111029", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_102111", "102111029", "story_v_out_102111.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[102111029].content)
			slot23 = string.split(slot21, ".")
	...
	Play102111030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos3009ui_story, Vector3.New(0, -1.8, -4.2), (uv0.time_ - slot11) / slot12)
				slot16 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot16.x, slot16.y, slot16.z)
				slot17 = slot10.localEulerAngles
				slot17.z = 0
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(0, -1.8, -4.2)
				slot15 = manager.ui.mainCamera.transform.position - slot10.position
				slot10.forward = Vector3.New(slot15.x, slot15.y, slot15.z)
				slot16 = slot10.localEulerAngles
				slot16.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111030].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111030", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111030", "story_v_out_102111.awb") / 1000 > 0 and slot15 < slot19 and uv0.duration_ < slot19 + slot14 then
						slot15 = slot19
						uv0.duration_ = slot19 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						uv0:RecordAudio("102111030", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_102111", "102111030", "story_v_out_102111.awb"))
					else
			...
			slot17 = uv0:FormatText(StoryWordCfg[102111030].content)
	...
	Play102111031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				...
				if uv0.var_.characterEffect3009ui_story then
					uv0.var_.characterEffect3009ui_story.fillFlat = true
					uv0.var_.characterEffect3009ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot4)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111031].content)
				uv0.typewritter.percent = 0
			...
			slot11 = uv0:FormatText(StoryWordCfg[102111031].content)
			slot13 = string.split(slot11, ".")
	...
	Play102111032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[102111032].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_102111", "102111032", "story_v_out_102111.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_102111", "102111032", "story_v_out_102111.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("102111032", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_102111", "102111032", "story_v_out_102111.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[102111032].content)
			slot13 = string.split(slot11, ".")
