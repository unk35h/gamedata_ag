	...
	Play105061001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105061001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105061", "105061001", "story_v_out_105061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105061", "105061001", "story_v_out_105061.awb") / 1000 > 0 and slot20 < slot25 and uv0.duration_ < slot25 + slot19 then
						slot20 = slot25
						uv0.duration_ = slot25 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						uv0:RecordAudio("105061001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_105061", "105061001", "story_v_out_105061.awb"))
					else
			...
			slot19 = slot19 + 0.3
			slot22 = uv0:FormatText(StoryWordCfg[105061001].content)
	...
	Play105061002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105061002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105061", "105061002", "story_v_out_105061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105061", "105061002", "story_v_out_105061.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("105061002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_105061", "105061002", "story_v_out_105061.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[105061002].content)
	...
	Play105061003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105061003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105061", "105061003", "story_v_out_105061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105061", "105061003", "story_v_out_105061.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("105061003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_105061", "105061003", "story_v_out_105061.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[105061003].content)
	...
	Play105061004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_40131")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105061004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105061", "105061004", "story_v_out_105061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105061", "105061004", "story_v_out_105061.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("105061004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_105061", "105061004", "story_v_out_105061.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[105061004].content)
			slot9 = string.split(slot7, ".")
	...
	Play105061005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_40131")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105061005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105061", "105061005", "story_v_out_105061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105061", "105061005", "story_v_out_105061.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105061005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105061", "105061005", "story_v_out_105061.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105061005].content)
	...
	Play105061006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105061006].content)
				uv0.typewritter.percent = 0
			...
			slot15 = uv0:FormatText(StoryWordCfg[105061006].content)
	...
	Play105061007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_3012")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105061007].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[105061007].content)
	...
	Play105061008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105061008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105061", "105061008", "story_v_out_105061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105061", "105061008", "story_v_out_105061.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105061008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105061", "105061008", "story_v_out_105061.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105061008].content)
			slot6 = string.split(slot4, ".")
	...
	Play105061009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105061009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105061", "105061009", "story_v_out_105061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105061", "105061009", "story_v_out_105061.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105061009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105061", "105061009", "story_v_out_105061.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105061009].content)
			slot6 = string.split(slot4, ".")
	...
	Play105061010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105061010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105061", "105061010", "story_v_out_105061.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105061", "105061010", "story_v_out_105061.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105061010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105061", "105061010", "story_v_out_105061.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105061010].content)
			slot6 = string.split(slot4, ".")
