return {
	Play117102001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102001].content)
			...
			slot13 = slot13 + 0.3
			slot16 = uv0:FormatText(StoryWordCfg[117102001].content)
	...
	Play117102002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102002].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117102", "117102002", "story_v_out_117102.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("117102002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_117102", "117102002", "story_v_out_117102.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[117102002].content)
	...
	Play117102003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102003].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[117102003].content)
	...
	Play117102004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102004].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117102", "117102004", "story_v_out_117102.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
					slot8 = slot12
					uv0.duration_ = slot12 + slot7
				end

				if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
					uv0:RecordAudio("117102004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117102", "117102004", "story_v_out_117102.awb"))
				else
			...
			slot10 = uv0:FormatText(StoryWordCfg[117102004].content)
	...
	Play117102005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102005].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[117102005].content)
			slot9 = string.split(slot7, ".")
	...
	Play117102006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0:CheckSpriteTmpPos("10036_split_5", 4)
			end
			...
			if slot12 <= uv0.time_ and uv0.time_ < slot12 + slot13 then
				...
				if uv0.var_.highlightMatValue10036_split_5 then
					slot15 = Mathf.Lerp(1, 0.5, slot14)
					slot16 = uv0.var_.highlightMatValue10036_split_5
					slot17 = slot16.color
					slot17.r = slot15
					slot17.g = slot15
					slot17.b = slot15
			...
			if uv0.time_ >= slot12 + slot13 and uv0.time_ < slot12 + slot13 + slot0 and uv0.var_.highlightMatValue10036_split_5 then
				slot14 = 0.5
				slot15 = uv0.var_.highlightMatValue10036_split_5
				slot16 = slot15.color
				slot16.r = slot14
				slot16.g = slot14
				slot16.b = slot14
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102006].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117102", "117102006", "story_v_out_117102.awb") / 1000 > 0 and slot15 < slot19 and uv0.duration_ < slot19 + slot14 then
					slot15 = slot19
					uv0.duration_ = slot19 + slot14
				end

				if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
					uv0:RecordAudio("117102006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_117102", "117102006", "story_v_out_117102.awb"))
				else
			...
			slot17 = uv0:FormatText(StoryWordCfg[117102006].content)
	...
	Play117102007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.actors_["10036_split_5"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPos10036_split_5 = slot1.localPosition
				slot1.localScale = Vector3.New(1, 1, 1)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10036_split_5, Vector3.New(390, -445, -290), (uv0.time_ - slot2) / slot3)
			end
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 and uv0.var_.highlightMatValue10036_split_5 then
				slot13 = 1

				slot10.transform:SetSiblingIndex(1)

				slot14 = uv0.var_.highlightMatValue10036_split_5
				slot15 = slot14.color
				slot15.r = slot13
				slot15.g = slot13
				slot15.b = slot13
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102007].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117102", "117102007", "story_v_out_117102.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
					slot14 = slot18
					uv0.duration_ = slot18 + slot13
				end

				if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
					uv0:RecordAudio("117102007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_117102", "117102007", "story_v_out_117102.awb"))
				else
			...
			slot16 = uv0:FormatText(StoryWordCfg[117102007].content)
			slot18 = string.split(slot16, ".")
	...
	Play117102008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102008].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117102", "117102008", "story_v_out_117102.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("117102008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117102", "117102008", "story_v_out_117102.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[117102008].content)
	...
	Play117102009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102009].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117102", "117102009", "story_v_out_117102.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("117102009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117102", "117102009", "story_v_out_117102.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[117102009].content)
			slot6 = string.split(slot4, ".")
	...
	Play117102010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.actors_["10036_split_5"]

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 and slot7.GetComponent(slot7, "Image") then
				uv0.var_.highlightMatValue10036_split_5 = slot9
			end
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				...
				if uv0.var_.highlightMatValue10036_split_5 then
					slot11 = Mathf.Lerp(1, 0.5, slot10)
					slot12 = uv0.var_.highlightMatValue10036_split_5
					slot13 = slot12.color
					slot13.r = slot11
					slot13.g = slot11
					slot13.b = slot11
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 and uv0.var_.highlightMatValue10036_split_5 then
				slot10 = 0.5
				slot11 = uv0.var_.highlightMatValue10036_split_5
				slot12 = slot11.color
				slot12.r = slot10
				slot12.g = slot10
				slot12.b = slot10
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102010].content)
				uv0.typewritter.percent = 0
			...
			slot13 = uv0:FormatText(StoryWordCfg[117102010].content)
	...
	Play117102011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102011].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117102", "117102011", "story_v_out_117102.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
					slot11 = slot15
					uv0.duration_ = slot15 + slot10
				end

				if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
					uv0:RecordAudio("117102011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117102", "117102011", "story_v_out_117102.awb"))
				else
			...
			slot13 = uv0:FormatText(StoryWordCfg[117102011].content)
			slot15 = string.split(slot13, ".")
	...
	Play117102012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102012].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117102", "117102012", "story_v_out_117102.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("117102012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117102", "117102012", "story_v_out_117102.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[117102012].content)
			slot6 = string.split(slot4, ".")
	...
	Play117102013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117102013].content)
				uv0.typewritter.percent = 0
			...
			slot15 = uv0:FormatText(StoryWordCfg[117102013].content)
