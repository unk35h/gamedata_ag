		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				if slot2.GetComponent(slot2, "SpriteRenderer") then
					uv0.var_.alphaOldValueA01b = slot4.material:GetColor("_Color").a
					uv0.var_.alphaMatValueA01b = slot4.material
				end
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot6 = Mathf.Lerp(uv0.var_.alphaOldValueA01b, 1, (uv0.time_ - slot3) / slot4)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012001", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012001", "story_v_out_100012.awb") / 1000 > 0 and slot9 < slot14 and uv0.duration_ < slot14 + slot8 then
						slot9 = slot14
						uv0.duration_ = slot14 + slot8
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("100012001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_100012", "100012001", "story_v_out_100012.awb"))
					else
			...
			slot8 = slot8 + 0.3
			slot11 = uv0:FormatText(StoryWordCfg[100012001].content)
	...
	Play100012002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012002", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012002", "story_v_out_100012.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("100012002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_100012", "100012002", "story_v_out_100012.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[100012002].content)
	...
	Play100012003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1036")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012003", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012003", "story_v_out_100012.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("100012003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_100012", "100012003", "story_v_out_100012.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[100012003].content)
	...
	Play100012004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1036")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012004", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012004", "story_v_out_100012.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("100012004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_100012", "100012004", "story_v_out_100012.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[100012004].content)
			slot6 = string.split(slot4, ".")
	...
	Play100012005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1036")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012005", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012005", "story_v_out_100012.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("100012005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_100012", "100012005", "story_v_out_100012.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[100012005].content)
			slot6 = string.split(slot4, ".")
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				if slot1.GetComponent(slot1, "SpriteRenderer") then
					uv0.var_.alphaOldValueA01b = slot3.material:GetColor("_Color").a
					uv0.var_.alphaMatValueA01b = slot3.material
				end
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot5 = Mathf.Lerp(uv0.var_.alphaOldValueA01b, 0, (uv0.time_ - slot2) / slot3)
			...
			slot4 = uv0.bgs_.A01b.transform

			if 1.5 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPosA01b = slot4.localPosition
			end
			...
			slot8 = uv0.bgs_.S0003

			if 1.5 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				if slot8.GetComponent(slot8, "SpriteRenderer") then
					uv0.var_.alphaOldValueS0003 = slot10.material:GetColor("_Color").a
					uv0.var_.alphaMatValueS0003 = slot10.material
				end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot12 = Mathf.Lerp(uv0.var_.alphaOldValueS0003, 1, (uv0.time_ - slot9) / slot10)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1084")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012007", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012007", "story_v_out_100012.awb") / 1000 > 0 and slot15 < slot20 and uv0.duration_ < slot20 + slot14 then
						slot15 = slot20
						uv0.duration_ = slot20 + slot14
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("100012007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_100012", "100012007", "story_v_out_100012.awb"))
					else
			...
			slot14 = slot14 + 0.3
			slot17 = uv0:FormatText(StoryWordCfg[100012007].content)
	...
	Play100012008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1084")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012008", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012008", "story_v_out_100012.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("100012008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_100012", "100012008", "story_v_out_100012.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[100012008].content)
			slot6 = string.split(slot4, ".")
	...
	Play100012009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012009", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012009", "story_v_out_100012.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("100012009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_100012", "100012009", "story_v_out_100012.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[100012009].content)
			slot6 = string.split(slot4, ".")
	...
	Play100012010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1036")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012010", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012010", "story_v_out_100012.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("100012010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_100012", "100012010", "story_v_out_100012.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[100012010].content)
			slot6 = string.split(slot4, ".")
	...
	Play100012011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1148")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012011", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012011", "story_v_out_100012.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("100012011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_100012", "100012011", "story_v_out_100012.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[100012011].content)
			slot6 = string.split(slot4, ".")
	...
	Play100012012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1084")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012012", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012012", "story_v_out_100012.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("100012012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_100012", "100012012", "story_v_out_100012.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[100012012].content)
			slot6 = string.split(slot4, ".")
	...
	Play100012013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1084")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012013", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012013", "story_v_out_100012.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("100012013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_100012", "100012013", "story_v_out_100012.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[100012013].content)
			slot6 = string.split(slot4, ".")
	...
	Play100012015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012015].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[100012015].content)
			slot6 = string.split(slot4, ".")
	...
	Play100012016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1036")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[100012016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_100012", "100012016", "story_v_out_100012.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_100012", "100012016", "story_v_out_100012.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("100012016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_100012", "100012016", "story_v_out_100012.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[100012016].content)
			slot6 = string.split(slot4, ".")
