return {
	Play111023001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111023", "111023001", "story_v_out_111023.awb") / 1000 > 0 and slot11 < slot12 and uv0.duration_ < slot12 + slot10 then
				slot11 = slot12
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111023001].content)
			...
			slot16 = uv0:FormatText(StoryWordCfg[111023001].content)
	...
	Play111023002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111023", "111023002", "story_v_out_111023.awb") / 1000 > 0 and slot5 < slot6 and uv0.duration_ < slot6 + slot4 then
				slot5 = slot6
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111023002].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[111023002].content)
	...
	Play111023003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111023", "111023003", "story_v_out_111023.awb") / 1000 > 0 and slot14 < slot15 and uv0.duration_ < slot15 + slot13 then
				slot14 = slot15
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111023003].content)
				uv0.typewritter.percent = 0
			...
			slot19 = uv0:FormatText(StoryWordCfg[111023003].content)
	...
	Play111023004 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.state_ = "playing"
		slot1.duration_ = 8.105999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111023", "111023004", "story_v_out_111023.awb") / 1000 > 0 and slot5 < slot6 and uv0.duration_ < slot6 + slot4 then
				slot5 = slot6
				uv0.duration_ = slot6 + slot4
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_shadowm")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111023004].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[111023004].content)
			slot12 = string.split(slot10, ".")
	...
	Play111023005 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.state_ = "playing"
		slot1.duration_ = 10.132999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111023", "111023005", "story_v_out_111023.awb") / 1000 > 0 and slot2 < slot3 and uv0.duration_ < slot3 + slot1 then
				slot2 = slot3
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_shadowm")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111023005].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111023005].content)
	...
	Play111023006 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.state_ = "playing"
		slot1.duration_ = 7.763999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111023", "111023006", "story_v_out_111023.awb") / 1000 > 0 and slot2 < slot3 and uv0.duration_ < slot3 + slot1 then
				slot2 = slot3
				uv0.duration_ = slot3 + slot1
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_shadowm")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111023006].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111023006].content)
			slot9 = string.split(slot7, ".")
	...
	Play111023007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111023", "111023007", "story_v_out_111023.awb") / 1000 > 0 and slot6 < slot7 and uv0.duration_ < slot7 + slot5 then
				slot6 = slot7
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111023007].content)
				uv0.typewritter.percent = 0
			...
			slot11 = uv0:FormatText(StoryWordCfg[111023007].content)
	...
	Play111023008 = function (slot0, slot1)
		slot1.time_ = 0
		slot1.state_ = "playing"
		slot1.duration_ = 9.957999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111023", "111023008", "story_v_out_111023.awb") / 1000 > 0 and slot5 < slot6 and uv0.duration_ < slot6 + slot4 then
				slot5 = slot6
				uv0.duration_ = slot6 + slot4
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_shadowm")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111023008].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[111023008].content)
			slot12 = string.split(slot10, ".")
	...
	Play111023009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111023", "111023009", "story_v_out_111023.awb") / 1000 > 0 and slot7 < slot8 and uv0.duration_ < slot8 + slot6 then
				slot7 = slot8
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111023009].content)
				uv0.typewritter.percent = 0
			...
			slot12 = uv0:FormatText(StoryWordCfg[111023009].content)
	...
	Play111023010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if manager.audio:GetVoiceLength("story_v_out_111023", "111023010", "story_v_out_111023.awb") / 1000 > 0 and slot7 < slot8 and uv0.duration_ < slot8 + slot6 then
				slot7 = slot8
				uv0.duration_ = slot8 + slot6
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111023010].content)
				uv0.typewritter.percent = 0
			...
			slot12 = uv0:FormatText(StoryWordCfg[111023010].content)
			slot14 = string.split(slot12, ".")
