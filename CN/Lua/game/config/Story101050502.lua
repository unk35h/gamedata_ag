return {
	Play105052001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052001", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052001", "story_v_out_105052.awb") / 1000 > 0 and slot16 < slot21 and uv0.duration_ < slot21 + slot15 then
						slot16 = slot21
						uv0.duration_ = slot21 + slot15
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("105052001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_105052", "105052001", "story_v_out_105052.awb"))
					else
			...
			slot15 = slot15 + 0.3
			slot18 = uv0:FormatText(StoryWordCfg[105052001].content)
	...
	Play105052002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052002].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052002].content)
	...
	Play105052003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052003", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052003", "story_v_out_105052.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("105052003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_105052", "105052003", "story_v_out_105052.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[105052003].content)
	...
	Play105052004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052004", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052004", "story_v_out_105052.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
						slot8 = slot12
						uv0.duration_ = slot12 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						uv0:RecordAudio("105052004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_105052", "105052004", "story_v_out_105052.awb"))
					else
			...
			slot10 = uv0:FormatText(StoryWordCfg[105052004].content)
	...
	Play105052005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1111")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052005", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052005", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052005", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052005].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052006].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052006].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052007].content)
				uv0.typewritter.percent = 0
			...
			slot9 = uv0:FormatText(StoryWordCfg[105052007].content)
	...
	Play105052008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052008", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052008", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052008", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052008].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052009].content)
				uv0.typewritter.percent = 0
			...
			slot9 = slot9 + 0.3
			slot12 = uv0:FormatText(StoryWordCfg[105052009].content)
	...
	Play105052010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052010].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052010].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052011", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052011", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052011", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052011].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.775 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052012].content)
				uv0.typewritter.percent = 0
			...
			slot4 = slot4 + 0.3
			slot7 = uv0:FormatText(StoryWordCfg[105052012].content)
	...
	Play105052013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052013", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052013", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052013", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052013].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052014", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052014", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052014", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052014].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot3 = uv0.bgs_.B12a.transform

			if 1.5 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0.var_.moveOldPosB12a = slot3.localPosition
			end
			...
			slot9 = uv0.bgs_.S0503

			if 0.999999999999 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				if slot9.GetComponent(slot9, "SpriteRenderer") then
					uv0.var_.alphaOldValueS0503 = slot11.material:GetColor("_Color").a
					uv0.var_.alphaMatValueS0503 = slot11.material
				end
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot13 = Mathf.Lerp(uv0.var_.alphaOldValueS0503, 1, (uv0.time_ - slot10) / slot11)
			...
			if 1.5 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052015].content)
				uv0.typewritter.percent = 0
			...
			slot17 = uv0:FormatText(StoryWordCfg[105052015].content)
	...
	Play105052016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052016", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052016", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052016", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052016].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052017", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052017", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052017", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052017].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052018", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052018", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052018", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052018].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052019", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052019", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052019", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052019].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052020", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052020", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052020", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052020].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052021].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052021", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052021", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052021", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052021].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052023", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052023", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052023", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052023].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1011")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052024", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052024", "story_v_out_105052.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("105052024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_105052", "105052024", "story_v_out_105052.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[105052024].content)
			slot6 = string.split(slot4, ".")
	...
	Play105052025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.bgs_.S0503.transform

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPosS0503 = slot1.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				if slot5.GetComponent(slot5, "SpriteRenderer") then
					uv0.var_.alphaOldValueB12a = slot7.material:GetColor("_Color").a
					uv0.var_.alphaMatValueB12a = slot7.material
				end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot9 = Mathf.Lerp(uv0.var_.alphaOldValueB12a, 1, (uv0.time_ - slot6) / slot7)
			...
			if 0.5 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052025", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052025", "story_v_out_105052.awb") / 1000 > 0 and slot9 < slot14 and uv0.duration_ < slot14 + slot8 then
						slot9 = slot14
						uv0.duration_ = slot14 + slot8
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("105052025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105052", "105052025", "story_v_out_105052.awb"))
					else
			...
			slot8 = slot8 + 0.3
			slot11 = uv0:FormatText(StoryWordCfg[105052025].content)
	...
	Play105052026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[105052026].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_105052", "105052026", "story_v_out_105052.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_105052", "105052026", "story_v_out_105052.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("105052026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_105052", "105052026", "story_v_out_105052.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[105052026].content)
			slot14 = string.split(slot12, ".")
