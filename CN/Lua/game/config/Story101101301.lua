return {
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if slot3.GetComponent(slot3, "SpriteRenderer") then
					uv0.var_.alphaOldValueST19 = slot5.material:GetColor("_Color").a
					uv0.var_.alphaMatValueST19 = slot5.material
				end
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				slot7 = Mathf.Lerp(uv0.var_.alphaOldValueST19, 1, (uv0.time_ - slot4) / slot5)
			...
			slot6 = uv0.bgs_.ST19.transform

			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0.var_.moveOldPosST19 = slot6.localPosition
			end
			...
			slot9 = uv0.bgs_.ST19.transform

			if 0.0166666666666666 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0.var_.moveOldPosST19 = slot9.localPosition
			end
			...
			slot12 = uv0.bgs_.ST19.transform

			if 2.01666666666667 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.var_.moveOldPosST19 = slot12.localPosition
			end
			...
			if 2.8 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131001].content)
			...
			slot21 = slot21 + 0.3
			slot24 = uv0:FormatText(StoryWordCfg[110131001].content)
	...
	Play110131002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.bgs_.ST19.transform

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPosST19 = slot1.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131002].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131002].content)
	...
	Play110131003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131003].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131003].content)
	...
	Play110131004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131004].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131004].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131005].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131005].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131006].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131006].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131007].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131007].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131008].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131008].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131009].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131009].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131010", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131010", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131010", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131010].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131011].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131011].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131012].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131012].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131013].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131013].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.633333333333333 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131014].content)
				uv0.typewritter.percent = 0
			...
			slot6 = slot6 + 0.3
			slot9 = uv0:FormatText(StoryWordCfg[110131014].content)
	...
	Play110131015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131015].content)
				uv0.typewritter.percent = 0
			...
			slot7 = slot7 + 0.3
			slot10 = uv0:FormatText(StoryWordCfg[110131015].content)
	...
	Play110131016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131016", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131016", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131016", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131016].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131017].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131017].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131018].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131018].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131019].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131019].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131020].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131020].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131021].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131021", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131021", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131021", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131021].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131022].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131022].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131023", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131023", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131023", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131023].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131024].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131024].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131025", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131025", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131025", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131025].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131026].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131026].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131027].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131027", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131027", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131027", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131027", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131027].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131028].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131028].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131029].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131029", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131029", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131029", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131029", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131029].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131030].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131030].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131031].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131031", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131031", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131031", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131031", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131031].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.bgs_.OS0102

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				if slot1.GetComponent(slot1, "SpriteRenderer") then
					uv0.var_.alphaOldValueOS0102 = slot3.material:GetColor("_Color").a
					uv0.var_.alphaMatValueOS0102 = slot3.material
				end
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot5 = Mathf.Lerp(uv0.var_.alphaOldValueOS0102, 0, (uv0.time_ - slot2) / slot3)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131032].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131032", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131032", "story_v_out_110131.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("110131032", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_110131", "110131032", "story_v_out_110131.awb"))
					else
			...
			slot6 = slot6 + 0.3
			slot9 = uv0:FormatText(StoryWordCfg[110131032].content)
			slot11 = string.split(slot9, ".")
	...
	Play110131033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131033].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131033", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131033", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot5 and uv0.duration_ < slot5 + slot1 then
						slot2 = slot5
						uv0.duration_ = slot5 + slot1
					end

					if slot3.prefab_name ~= "" and uv0.actors_[slot3.prefab_name] ~= nil then
						uv0:RecordAudio("110131033", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot3.prefab_name].transform, "story_v_out_110131", "110131033", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131033].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131034].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131034", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131034", "story_v_out_110131.awb") / 1000 > 0 and slot6 < slot11 and uv0.duration_ < slot11 + slot5 then
						slot6 = slot11
						uv0.duration_ = slot11 + slot5
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("110131034", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_110131", "110131034", "story_v_out_110131.awb"))
					else
			...
			slot5 = slot5 + 0.3
			slot8 = uv0:FormatText(StoryWordCfg[110131034].content)
	...
	Play110131035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131035].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131035].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131036].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131036", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131036", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131036", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131036", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131036].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131037].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131037", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131037", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131037", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131037", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131037].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131038 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131038].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131038].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131039 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131039].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131039].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131040].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131040].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131041 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131041].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131041].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131042 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131042].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131042", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131042", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131042", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131042", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131042].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131043 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131043].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131043].content)
			slot9 = string.split(slot7, ".")
	...
	Play110131044 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(0, -0.76, -5.4), (uv0.time_ - slot8) / slot9)
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0, -0.76, -5.4)
			...
			if 3.8 < uv0.time_ and uv0.time_ <= slot11 + slot0 and uv0.var_.characterEffect1011ui_story == nil then
			...
			if 4 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131044].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131044", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131044", "story_v_out_110131.awb") / 1000 > 0 and slot16 < slot21 and uv0.duration_ < slot21 + slot15 then
						slot16 = slot21
						uv0.duration_ = slot21 + slot15
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("110131044", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_110131", "110131044", "story_v_out_110131.awb"))
					else
			...
			slot15 = slot15 + 0.3
			slot18 = uv0:FormatText(StoryWordCfg[110131044].content)
	...
	Play110131045 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131045].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131045].content)
			slot9 = string.split(slot7, ".")
	...
	Play110131046 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131046].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131046].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131047 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131047].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131047].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131048 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2.22044604925031e-16 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
			...
			slot13 = uv0.actors_["1019ui_story"]

			if 4.44089209850063e-16 < uv0.time_ and uv0.time_ <= slot14 + slot0 and uv0.var_.characterEffect1019ui_story == nil then
				uv0.var_.characterEffect1019ui_story = slot13.GetComponentInChildren(slot13, typeof(CharacterEffect))
			end
			...
			slot18 = uv0.actors_["1011ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				uv0.var_.moveOldPos1011ui_story = slot18.localPosition
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131048].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131048", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131048", "story_v_out_110131.awb") / 1000 > 0 and slot22 < slot27 and uv0.duration_ < slot27 + slot21 then
						slot22 = slot27
						uv0.duration_ = slot27 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						uv0:RecordAudio("110131048", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_110131", "110131048", "story_v_out_110131.awb"))
					else
			...
			slot21 = slot21 + 0.3
			slot24 = uv0:FormatText(StoryWordCfg[110131048].content)
			slot26 = string.split(slot24, ".")
	...
	Play110131049 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131049].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131049].content)
			slot9 = string.split(slot7, ".")
	...
	Play110131050 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131050].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131050", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131050", "story_v_out_110131.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("110131050", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_110131", "110131050", "story_v_out_110131.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[110131050].content)
			slot11 = string.split(slot9, ".")
	...
	Play110131051 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131051].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131051", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131051", "story_v_out_110131.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("110131051", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_110131", "110131051", "story_v_out_110131.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[110131051].content)
	...
	Play110131052 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131052].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131052", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131052", "story_v_out_110131.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("110131052", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_110131", "110131052", "story_v_out_110131.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[110131052].content)
			slot7 = string.split(slot5, ".")
	...
	Play110131053 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131053].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131053", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131053", "story_v_out_110131.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("110131053", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_110131", "110131053", "story_v_out_110131.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[110131053].content)
	...
	Play110131054 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131054].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131054].content)
			slot9 = string.split(slot7, ".")
	...
	Play110131055 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131055].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131055", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131055", "story_v_out_110131.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("110131055", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_110131", "110131055", "story_v_out_110131.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[110131055].content)
			slot10 = string.split(slot8, ".")
	...
	Play110131056 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131056].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131056].content)
			slot9 = string.split(slot7, ".")
	...
	Play110131057 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131057].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131057", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131057", "story_v_out_110131.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("110131057", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_110131", "110131057", "story_v_out_110131.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[110131057].content)
			slot11 = string.split(slot9, ".")
	...
	Play110131058 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot12 = uv0.actors_["1011ui_story"]

			if 1.8 < uv0.time_ and uv0.time_ <= slot13 + slot0 and uv0.var_.characterEffect1011ui_story == nil then
				uv0.var_.characterEffect1011ui_story = slot12.GetComponentInChildren(slot12, typeof(CharacterEffect))
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131058].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131058", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131058", "story_v_out_110131.awb") / 1000 > 0 and slot20 < slot25 and uv0.duration_ < slot25 + slot19 then
						slot20 = slot25
						uv0.duration_ = slot25 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						uv0:RecordAudio("110131058", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_110131", "110131058", "story_v_out_110131.awb"))
					else
			...
			slot19 = slot19 + 0.3
			slot22 = uv0:FormatText(StoryWordCfg[110131058].content)
	...
	Play110131059 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131059].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131059", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131059", "story_v_out_110131.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("110131059", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_110131", "110131059", "story_v_out_110131.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[110131059].content)
			slot7 = string.split(slot5, ".")
	...
	Play110131060 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131060].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131060].content)
			slot9 = string.split(slot7, ".")
	...
	Play110131061 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131061].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131061].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131062 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131062].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131062].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131063 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131063].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131063].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131064 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131064].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131064", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131064", "story_v_out_110131.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("110131064", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_110131", "110131064", "story_v_out_110131.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[110131064].content)
			slot10 = string.split(slot8, ".")
	...
	Play110131065 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131065].content)
				uv0.typewritter.percent = 0
			...
			slot8 = uv0:FormatText(StoryWordCfg[110131065].content)
			slot10 = string.split(slot8, ".")
	...
	Play110131066 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131066].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131066", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131066", "story_v_out_110131.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("110131066", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_110131", "110131066", "story_v_out_110131.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[110131066].content)
			slot10 = string.split(slot8, ".")
	...
	Play110131067 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131067].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131067].content)
			slot9 = string.split(slot7, ".")
	...
	Play110131068 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131068].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131068", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131068", "story_v_out_110131.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("110131068", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_110131", "110131068", "story_v_out_110131.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[110131068].content)
			slot11 = string.split(slot9, ".")
	...
	Play110131069 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot8 = uv0.actors_["1111ui_story"].transform

			if 3.8 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPos1111ui_story = slot8.localPosition
			end

			slot10 = 0.001

			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1111ui_story, Vector3.New(0, -0.72, -5.4), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(0, -0.72, -5.4)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			slot13 = uv0.actors_["1111ui_story"]

			if 3.8 < uv0.time_ and uv0.time_ <= slot14 + slot0 and uv0.var_.characterEffect1111ui_story == nil then
				uv0.var_.characterEffect1111ui_story = slot13.GetComponentInChildren(slot13, typeof(CharacterEffect))
			end
			...
			slot16 = uv0.actors_["1011ui_story"].transform

			if 1.966 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				uv0.var_.moveOldPos1011ui_story = slot16.localPosition
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131069].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131069", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131069", "story_v_out_110131.awb") / 1000 > 0 and slot20 < slot25 and uv0.duration_ < slot25 + slot19 then
						slot20 = slot25
						uv0.duration_ = slot25 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						uv0:RecordAudio("110131069", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_110131", "110131069", "story_v_out_110131.awb"))
					else
			...
			slot19 = slot19 + 0.3
			slot22 = uv0:FormatText(StoryWordCfg[110131069].content)
			slot24 = string.split(slot22, ".")
	...
	Play110131070 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131070].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131070].content)
			slot9 = string.split(slot7, ".")
	...
	Play110131071 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131071].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131071", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131071", "story_v_out_110131.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("110131071", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_110131", "110131071", "story_v_out_110131.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[110131071].content)
			slot11 = string.split(slot9, ".")
	...
	Play110131072 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131072].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131072].content)
			slot9 = string.split(slot7, ".")
	...
	Play110131073 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131073].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131073", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131073", "story_v_out_110131.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("110131073", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_110131", "110131073", "story_v_out_110131.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131073].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131074 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131074].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131074", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131074", "story_v_out_110131.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("110131074", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_110131", "110131074", "story_v_out_110131.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[110131074].content)
			slot11 = string.split(slot9, ".")
	...
	Play110131075 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131075].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[110131075].content)
			slot12 = string.split(slot10, ".")
	...
	Play110131076 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131076].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[110131076].content)
			slot6 = string.split(slot4, ".")
	...
	Play110131077 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131077].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131077", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131077", "story_v_out_110131.awb") / 1000 > 0 and slot12 < slot16 and uv0.duration_ < slot16 + slot11 then
						slot12 = slot16
						uv0.duration_ = slot16 + slot11
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						uv0:RecordAudio("110131077", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_110131", "110131077", "story_v_out_110131.awb"))
					else
			...
			slot14 = uv0:FormatText(StoryWordCfg[110131077].content)
	...
	Play110131078 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot9 = uv0.actors_["1019ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect1019ui_story == nil then
				uv0.var_.characterEffect1019ui_story = slot9.GetComponentInChildren(slot9, typeof(CharacterEffect))
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131078].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131078", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131078", "story_v_out_110131.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("110131078", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_110131", "110131078", "story_v_out_110131.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[110131078].content)
	...
	Play110131079 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131079].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131079].content)
			slot9 = string.split(slot7, ".")
	...
	Play110131080 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131080].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131080", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131080", "story_v_out_110131.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("110131080", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_110131", "110131080", "story_v_out_110131.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[110131080].content)
			slot11 = string.split(slot9, ".")
	...
	Play110131081 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.actors_["1111ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPos1111ui_story = slot7.localPosition
			end

			slot9 = 0.1

			if slot8 <= uv0.time_ and uv0.time_ < slot8 + slot9 then
				slot7.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1111ui_story, Vector3.New(0, -0.72, -5.4), (uv0.time_ - slot8) / slot9)
				slot13 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot7.localEulerAngles
				slot14.z = 0
			...
			if uv0.time_ >= slot8 + slot9 and uv0.time_ < slot8 + slot9 + slot0 then
				slot7.localPosition = Vector3.New(0, -0.72, -5.4)
				slot12 = manager.ui.mainCamera.transform.position - slot7.position
				slot7.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot7.localEulerAngles
				slot13.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131081].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131081", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131081", "story_v_out_110131.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("110131081", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_110131", "110131081", "story_v_out_110131.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[110131081].content)
			slot20 = string.split(slot18, ".")
	...
	Play110131082 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131082].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131082", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131082", "story_v_out_110131.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("110131082", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_110131", "110131082", "story_v_out_110131.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[110131082].content)
			slot17 = string.split(slot15, ".")
	...
	Play110131083 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131083].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[110131083].content)
			slot9 = string.split(slot7, ".")
	...
	Play110131084 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131084].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131084", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131084", "story_v_out_110131.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("110131084", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_110131", "110131084", "story_v_out_110131.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[110131084].content)
			slot11 = string.split(slot9, ".")
	...
	Play110131085 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot8 = uv0.actors_["1111ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 and uv0.var_.characterEffect1111ui_story == nil then
				uv0.var_.characterEffect1111ui_story = slot8.GetComponentInChildren(slot8, typeof(CharacterEffect))
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131085].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131085", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131085", "story_v_out_110131.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("110131085", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_110131", "110131085", "story_v_out_110131.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[110131085].content)
			slot17 = string.split(slot15, ".")
	...
	Play110131086 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[110131086].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_110131", "110131086", "story_v_out_110131.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_110131", "110131086", "story_v_out_110131.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("110131086", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_110131", "110131086", "story_v_out_110131.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[110131086].content)
			slot8 = string.split(slot6, ".")
