return {
	Play116021001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021001].content)
			...
			slot11 = slot11 + 0.3
			slot14 = uv0:FormatText(StoryWordCfg[116021001].content)
	...
	Play116021002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019_split_6")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021002].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021002", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021002", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021002].content)
	...
	Play116021003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021003].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021003].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021004].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021004", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021004", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021004].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019_split_6")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021005].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021005", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021005", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021005].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 3 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021006].content)
				uv0.typewritter.percent = 0
			...
			slot11 = slot11 + 0.3
			slot14 = uv0:FormatText(StoryWordCfg[116021006].content)
			slot16 = string.split(slot14, ".")
	...
	Play116021007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021007].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021007].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021008].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021008", "story_v_out_116021.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
					slot11 = slot15
					uv0.duration_ = slot15 + slot10
				end

				if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
					uv0:RecordAudio("116021008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_116021", "116021008", "story_v_out_116021.awb"))
				else
			...
			slot13 = uv0:FormatText(StoryWordCfg[116021008].content)
	...
	Play116021009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021009].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116021009].content)
	...
	Play116021010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021010].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021010", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021010", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021010].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1039")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021012].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021012", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot7 and uv0.duration_ < slot7 + slot1 then
					slot2 = slot7
					uv0.duration_ = slot7 + slot1
				end

				if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
					uv0:RecordAudio("116021012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116021", "116021012", "story_v_out_116021.awb"))
				else
			...
			slot1 = slot1 + 0.3
			slot4 = uv0:FormatText(StoryWordCfg[116021012].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021013].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021013].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1039")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021014].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021014", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021014", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021014].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.bgs_.SK0104.transform

			if 2 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosSK0104 = slot7.localPosition
			end
			...
			slot12 = uv0.actors_["1019ui_story"].transform

			if 1.966 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.var_.moveOldPos1019ui_story = slot12.localPosition
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021015].content)
				uv0.typewritter.percent = 0
			...
			slot15 = slot15 + 0.3
			slot18 = uv0:FormatText(StoryWordCfg[116021015].content)
	...
	Play116021016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021016].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021016", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021016", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021016].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021017].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021017", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021017", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021017].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019_split_6")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021018].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021018", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021018", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021018].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021019].content)
				uv0.typewritter.percent = 0
			...
			slot8 = uv0:FormatText(StoryWordCfg[116021019].content)
	...
	Play116021020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1039")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021020].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021020", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021020", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021020].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019_split_6")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021021].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021021", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021021", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021021].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1039")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021022].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021022", "story_v_out_116021.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
					slot5 = slot9
					uv0.duration_ = slot9 + slot4
				end

				if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
					uv0:RecordAudio("116021022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116021", "116021022", "story_v_out_116021.awb"))
				else
			...
			slot7 = uv0:FormatText(StoryWordCfg[116021022].content)
			slot9 = string.split(slot7, ".")
	...
	Play116021023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019_split_6")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021023].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021023", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021023", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021023].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot3 = uv0.actors_["1037ui_story"].transform

			if 3.8 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				uv0.var_.moveOldPos1037ui_story = slot3.localPosition
			end

			slot5 = 0.001

			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				slot3.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1037ui_story, Vector3.New(0, -1.14, -5.21), (uv0.time_ - slot4) / slot5)
			...
			if uv0.time_ >= slot4 + slot5 and uv0.time_ < slot4 + slot5 + slot0 then
				slot3.localPosition = Vector3.New(0, -1.14, -5.21)
			...
			slot6 = uv0.actors_["1037ui_story"]

			if 3.8 < uv0.time_ and uv0.time_ <= slot7 + slot0 and uv0.var_.characterEffect1037ui_story == nil then
				uv0.var_.characterEffect1037ui_story = slot6.GetComponentInChildren(slot6, typeof(CharacterEffect))
			end
			...
			if 3.999999999999 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021024].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021024", "story_v_out_116021.awb") / 1000 > 0 and slot16 < slot21 and uv0.duration_ < slot21 + slot15 then
					slot16 = slot21
					uv0.duration_ = slot21 + slot15
				end

				if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
					uv0:RecordAudio("116021024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_116021", "116021024", "story_v_out_116021.awb"))
				else
			...
			slot15 = slot15 + 0.3
			slot18 = uv0:FormatText(StoryWordCfg[116021024].content)
			slot20 = string.split(slot18, ".")
	...
	Play116021025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021025].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021025", "story_v_out_116021.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
					slot4 = slot8
					uv0.duration_ = slot8 + slot3
				end

				if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
					uv0:RecordAudio("116021025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116021", "116021025", "story_v_out_116021.awb"))
				else
			...
			slot6 = uv0:FormatText(StoryWordCfg[116021025].content)
	...
	Play116021026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1039")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021026].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021026", "story_v_out_116021.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
					slot5 = slot9
					uv0.duration_ = slot9 + slot4
				end

				if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
					uv0:RecordAudio("116021026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116021", "116021026", "story_v_out_116021.awb"))
				else
			...
			slot7 = uv0:FormatText(StoryWordCfg[116021026].content)
			slot9 = string.split(slot7, ".")
	...
	Play116021028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1039")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021028].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021028", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot7 and uv0.duration_ < slot7 + slot1 then
					slot2 = slot7
					uv0.duration_ = slot7 + slot1
				end

				if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
					uv0:RecordAudio("116021028", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116021", "116021028", "story_v_out_116021.awb"))
				else
			...
			slot1 = slot1 + 0.3
			slot4 = uv0:FormatText(StoryWordCfg[116021028].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021029].content)
				uv0.typewritter.percent = 0
			...
			slot10 = slot10 + 0.3
			slot13 = uv0:FormatText(StoryWordCfg[116021029].content)
			slot15 = string.split(slot13, ".")
	...
	Play116021030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021030].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021030].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.bgs_.SK0105.transform

			if 2 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPosSK0105 = slot7.localPosition
			end
			...
			slot10 = uv0.bgs_.SK0105.transform

			if 2.034 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				uv0.var_.moveOldPosSK0105 = slot10.localPosition
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021031].content)
				uv0.typewritter.percent = 0
			...
			slot15 = slot15 + 0.3
			slot18 = uv0:FormatText(StoryWordCfg[116021031].content)
			slot20 = string.split(slot18, ".")
	...
	Play116021032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021032].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021032", "story_v_out_116021.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
					slot4 = slot8
					uv0.duration_ = slot8 + slot3
				end

				if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
					uv0:RecordAudio("116021032", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116021", "116021032", "story_v_out_116021.awb"))
				else
			...
			slot6 = uv0:FormatText(StoryWordCfg[116021032].content)
			slot8 = string.split(slot6, ".")
	...
	Play116021033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021033].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021033].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021034].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021034].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021035].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021035].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.bgs_.SK0105.transform

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				uv0.var_.moveOldPosSK0105 = slot1.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021036].content)
				uv0.typewritter.percent = 0
			...
			slot9 = uv0:FormatText(StoryWordCfg[116021036].content)
	...
	Play116021037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot4 = uv0.bgs_.SK0105.transform

			if 1.966 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				uv0.var_.moveOldPosSK0105 = slot4.localPosition
			end
			...
			if 2.034 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021037].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021037", "story_v_out_116021.awb") / 1000 > 0 and slot14 < slot19 and uv0.duration_ < slot19 + slot13 then
					slot14 = slot19
					uv0.duration_ = slot19 + slot13
				end

				if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
					uv0:RecordAudio("116021037", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_116021", "116021037", "story_v_out_116021.awb"))
				else
			...
			slot13 = slot13 + 0.3
			slot16 = uv0:FormatText(StoryWordCfg[116021037].content)
	...
	Play116021038 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021038].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021038", "story_v_out_116021.awb") / 1000 > 0 and slot12 < slot17 and uv0.duration_ < slot17 + slot11 then
					slot12 = slot17
					uv0.duration_ = slot17 + slot11
				end

				if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
					uv0:RecordAudio("116021038", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_116021", "116021038", "story_v_out_116021.awb"))
				else
			...
			slot11 = slot11 + 0.3
			slot14 = uv0:FormatText(StoryWordCfg[116021038].content)
			slot16 = string.split(slot14, ".")
	...
	Play116021039 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 4 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021039].content)
				uv0.typewritter.percent = 0
			...
			slot8 = slot8 + 0.3
			slot11 = uv0:FormatText(StoryWordCfg[116021039].content)
	...
	Play116021040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021040].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021040", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021040", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021040", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021040].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021042 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021042].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021042", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021042", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021042", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021042].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021043 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021043].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021043].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021045 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if uv0.actors_["1029ui_story"] == nil then
				...
				if slot4.transform:Find("Directional Light") then
				...
				uv0.var_[slot3 .. "Animator"] = slot6.gameObject:GetComponent(typeof(UnityEngine.Animator))
				uv0.var_[slot3 .. "Animator"].applyRootMotion = true
				uv0.var_[slot3 .. "LipSync"] = slot6.gameObject:GetComponentInChildren(typeof(RogoDigital.Lipsync.LipSync))
			end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1029ui_story, Vector3.New(0, -1.14, -5.6), (uv0.time_ - slot5) / slot6)
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(0, -1.14, -5.6)
			...
			slot9 = uv0.actors_["1029ui_story"]

			if 3.8 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect1029ui_story == nil then
				uv0.var_.characterEffect1029ui_story = slot9.GetComponentInChildren(slot9, typeof(CharacterEffect))
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021045].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021045", "story_v_out_116021.awb") / 1000 > 0 and slot17 < slot22 and uv0.duration_ < slot22 + slot16 then
					slot17 = slot22
					uv0.duration_ = slot22 + slot16
				end

				if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
					uv0:RecordAudio("116021045", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_116021", "116021045", "story_v_out_116021.awb"))
				else
			...
			slot16 = slot16 + 0.3
			slot19 = uv0:FormatText(StoryWordCfg[116021045].content)
	...
	Play116021047 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = uv0.actors_["1029ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 and uv0.var_.characterEffect1029ui_story == nil then
				uv0.var_.characterEffect1029ui_story = slot2.GetComponentInChildren(slot2, typeof(CharacterEffect))
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021047].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021047", "story_v_out_116021.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
					slot6 = slot10
					uv0.duration_ = slot10 + slot5
				end

				if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
					uv0:RecordAudio("116021047", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_116021", "116021047", "story_v_out_116021.awb"))
				else
			...
			slot8 = uv0:FormatText(StoryWordCfg[116021047].content)
			slot10 = string.split(slot8, ".")
	...
	Play116021048 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021048].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116021048].content)
			slot9 = string.split(slot7, ".")
	...
	Play116021049 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021049].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021049].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021050 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021050].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021050", "story_v_out_116021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
					slot10 = slot14
					uv0.duration_ = slot14 + slot9
				end

				if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
					uv0:RecordAudio("116021050", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116021", "116021050", "story_v_out_116021.awb"))
				else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116021050].content)
	...
	Play116021051 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				...
				if uv0.var_.characterEffect1019ui_story then
					uv0.var_.characterEffect1019ui_story.fillFlat = true
					uv0.var_.characterEffect1019ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot11)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021051].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021051", "story_v_out_116021.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
					slot14 = slot18
					uv0.duration_ = slot18 + slot13
				end

				if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
					uv0:RecordAudio("116021051", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_116021", "116021051", "story_v_out_116021.awb"))
				else
			...
			slot16 = uv0:FormatText(StoryWordCfg[116021051].content)
			slot18 = string.split(slot16, ".")
	...
	Play116021052 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot8 = uv0.actors_["1029ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 and uv0.var_.characterEffect1029ui_story == nil then
				uv0.var_.characterEffect1029ui_story = slot8.GetComponentInChildren(slot8, typeof(CharacterEffect))
			end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				...
				if uv0.var_.characterEffect1029ui_story then
					uv0.var_.characterEffect1029ui_story.fillFlat = true
					uv0.var_.characterEffect1029ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot11)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021052].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021052", "story_v_out_116021.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
					slot14 = slot18
					uv0.duration_ = slot18 + slot13
				end

				if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
					uv0:RecordAudio("116021052", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_116021", "116021052", "story_v_out_116021.awb"))
				else
			...
			slot16 = uv0:FormatText(StoryWordCfg[116021052].content)
			slot18 = string.split(slot16, ".")
	...
	Play116021053 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021053].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021053", "story_v_out_116021.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("116021053", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116021", "116021053", "story_v_out_116021.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116021053].content)
			slot13 = string.split(slot11, ".")
	...
	Play116021054 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021054].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021054", "story_v_out_116021.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("116021054", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116021", "116021054", "story_v_out_116021.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116021054].content)
			slot13 = string.split(slot11, ".")
	...
	Play116021055 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021055].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021055", "story_v_out_116021.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
					slot3 = slot7
					uv0.duration_ = slot7 + slot2
				end

				if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
					uv0:RecordAudio("116021055", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_116021", "116021055", "story_v_out_116021.awb"))
				else
			...
			slot5 = uv0:FormatText(StoryWordCfg[116021055].content)
	...
	Play116021056 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				...
				if uv0.var_.characterEffect1019ui_story then
					uv0.var_.characterEffect1019ui_story.fillFlat = true
					uv0.var_.characterEffect1019ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot5)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021056].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021056", "story_v_out_116021.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("116021056", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116021", "116021056", "story_v_out_116021.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116021056].content)
			slot13 = string.split(slot11, ".")
	...
	Play116021057 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021057].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021057", "story_v_out_116021.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("116021057", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116021", "116021057", "story_v_out_116021.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116021057].content)
			slot13 = string.split(slot11, ".")
	...
	Play116021058 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot3 = uv0.actors_["1019ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 and uv0.var_.characterEffect1019ui_story == nil then
				uv0.var_.characterEffect1019ui_story = slot3.GetComponentInChildren(slot3, typeof(CharacterEffect))
			end
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				...
				if uv0.var_.characterEffect1019ui_story then
					uv0.var_.characterEffect1019ui_story.fillFlat = true
					uv0.var_.characterEffect1019ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot6)
				end
			end
			...
			slot6 = uv0.actors_["1029ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 and uv0.var_.characterEffect1029ui_story == nil then
				uv0.var_.characterEffect1029ui_story = slot6.GetComponentInChildren(slot6, typeof(CharacterEffect))
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021058].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021058", "story_v_out_116021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
					slot10 = slot14
					uv0.duration_ = slot14 + slot9
				end

				if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
					uv0:RecordAudio("116021058", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116021", "116021058", "story_v_out_116021.awb"))
				else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116021058].content)
			slot14 = string.split(slot12, ".")
	...
	Play116021059 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021059].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021059", "story_v_out_116021.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("116021059", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116021", "116021059", "story_v_out_116021.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116021059].content)
			slot13 = string.split(slot11, ".")
	...
	Play116021060 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021060].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021060", "story_v_out_116021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
					slot10 = slot14
					uv0.duration_ = slot14 + slot9
				end

				if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
					uv0:RecordAudio("116021060", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116021", "116021060", "story_v_out_116021.awb"))
				else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116021060].content)
			slot14 = string.split(slot12, ".")
	...
	Play116021061 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021061].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021061", "story_v_out_116021.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("116021061", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116021", "116021061", "story_v_out_116021.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116021061].content)
			slot13 = string.split(slot11, ".")
	...
	Play116021062 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021062].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021062", "story_v_out_116021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
					slot10 = slot14
					uv0.duration_ = slot14 + slot9
				end

				if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
					uv0:RecordAudio("116021062", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116021", "116021062", "story_v_out_116021.awb"))
				else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116021062].content)
			slot14 = string.split(slot12, ".")
	...
	Play116021063 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021063].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021063", "story_v_out_116021.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("116021063", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116021", "116021063", "story_v_out_116021.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116021063].content)
			slot13 = string.split(slot11, ".")
	...
	Play116021064 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021064].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021064", "story_v_out_116021.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("116021064", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116021", "116021064", "story_v_out_116021.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116021064].content)
			slot13 = string.split(slot11, ".")
	...
	Play116021065 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021065].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021065", "story_v_out_116021.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("116021065", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116021", "116021065", "story_v_out_116021.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116021065].content)
			slot13 = string.split(slot11, ".")
	...
	Play116021066 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021066].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021066", "story_v_out_116021.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("116021066", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116021", "116021066", "story_v_out_116021.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116021066].content)
			slot13 = string.split(slot11, ".")
	...
	Play116021067 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021067].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021067", "story_v_out_116021.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("116021067", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116021", "116021067", "story_v_out_116021.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116021067].content)
			slot13 = string.split(slot11, ".")
	...
	Play116021068 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021068].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116021068].content)
			slot9 = string.split(slot7, ".")
	...
	Play116021069 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021069].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021069].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021070 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021070].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021070", "story_v_out_116021.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
					slot7 = slot11
					uv0.duration_ = slot11 + slot6
				end

				if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
					uv0:RecordAudio("116021070", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116021", "116021070", "story_v_out_116021.awb"))
				else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116021070].content)
			slot11 = string.split(slot9, ".")
	...
	Play116021071 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021071].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116021071].content)
			slot9 = string.split(slot7, ".")
	...
	Play116021072 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot3 = uv0.actors_["1029ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 and uv0.var_.characterEffect1029ui_story == nil then
				uv0.var_.characterEffect1029ui_story = slot3.GetComponentInChildren(slot3, typeof(CharacterEffect))
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021072].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021072", "story_v_out_116021.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
					slot7 = slot11
					uv0.duration_ = slot11 + slot6
				end

				if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
					uv0:RecordAudio("116021072", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116021", "116021072", "story_v_out_116021.awb"))
				else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116021072].content)
			slot11 = string.split(slot9, ".")
	...
	Play116021073 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021073].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116021073].content)
			slot9 = string.split(slot7, ".")
	...
	Play116021074 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021074].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021074", "story_v_out_116021.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
					slot6 = slot10
					uv0.duration_ = slot10 + slot5
				end

				if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
					uv0:RecordAudio("116021074", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_116021", "116021074", "story_v_out_116021.awb"))
				else
			...
			slot8 = uv0:FormatText(StoryWordCfg[116021074].content)
			slot10 = string.split(slot8, ".")
	...
	Play116021075 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				...
				if uv0.var_.characterEffect1019ui_story then
					uv0.var_.characterEffect1019ui_story.fillFlat = true
					uv0.var_.characterEffect1019ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot9)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021075].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021075", "story_v_out_116021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
					slot10 = slot14
					uv0.duration_ = slot14 + slot9
				end

				if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
					uv0:RecordAudio("116021075", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116021", "116021075", "story_v_out_116021.awb"))
				else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116021075].content)
			slot14 = string.split(slot12, ".")
	...
	Play116021076 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1028ui_story, Vector3.New(-1.1, -0.95, -5.3), (uv0.time_ - slot3) / slot4)
				slot8 = manager.ui.mainCamera.transform.position - slot2.position
				slot2.forward = Vector3.New(slot8.x, slot8.y, slot8.z)
				slot9 = slot2.localEulerAngles
				slot9.z = 0
			...
			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 then
				slot2.localPosition = Vector3.New(-1.1, -0.95, -5.3)
				slot7 = manager.ui.mainCamera.transform.position - slot2.position
				slot2.forward = Vector3.New(slot7.x, slot7.y, slot7.z)
				slot8 = slot2.localEulerAngles
				slot8.z = 0
			...
			slot10 = uv0.actors_["1028ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 and uv0.var_.characterEffect1028ui_story == nil then
				uv0.var_.characterEffect1028ui_story = slot10.GetComponentInChildren(slot10, typeof(CharacterEffect))
			end
			...
			slot13 = uv0.actors_["1029ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 and uv0.var_.characterEffect1029ui_story == nil then
				uv0.var_.characterEffect1029ui_story = slot13.GetComponentInChildren(slot13, typeof(CharacterEffect))
			end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				...
				if uv0.var_.characterEffect1029ui_story then
					uv0.var_.characterEffect1029ui_story.fillFlat = true
					uv0.var_.characterEffect1029ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot16)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021076].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021076", "story_v_out_116021.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
					slot17 = slot21
					uv0.duration_ = slot21 + slot16
				end

				if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
					uv0:RecordAudio("116021076", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_116021", "116021076", "story_v_out_116021.awb"))
				else
			...
			slot19 = uv0:FormatText(StoryWordCfg[116021076].content)
			slot21 = string.split(slot19, ".")
	...
	Play116021077 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6 = uv0.actors_["1028ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 and uv0.var_.characterEffect1028ui_story == nil then
				uv0.var_.characterEffect1028ui_story = slot6.GetComponentInChildren(slot6, typeof(CharacterEffect))
			end
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				...
				if uv0.var_.characterEffect1028ui_story then
					...
					uv0.var_.characterEffect1028ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot9)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021077].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021077", "story_v_out_116021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
					slot10 = slot14
					uv0.duration_ = slot14 + slot9
				end

				if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
					uv0:RecordAudio("116021077", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116021", "116021077", "story_v_out_116021.awb"))
				else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116021077].content)
			slot14 = string.split(slot12, ".")
	...
	Play116021078 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021078].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021078", "story_v_out_116021.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
					slot5 = slot9
					uv0.duration_ = slot9 + slot4
				end

				if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
					uv0:RecordAudio("116021078", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116021", "116021078", "story_v_out_116021.awb"))
				else
			...
			slot7 = uv0:FormatText(StoryWordCfg[116021078].content)
			slot9 = string.split(slot7, ".")
	...
	Play116021079 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021079].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021079", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021079", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021079", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021079].content)
			slot6 = string.split(slot4, ".")
	...
	Play116021080 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021080].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021080", "story_v_out_116021.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
					slot6 = slot10
					uv0.duration_ = slot10 + slot5
				end

				if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
					uv0:RecordAudio("116021080", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_116021", "116021080", "story_v_out_116021.awb"))
				else
			...
			slot8 = uv0:FormatText(StoryWordCfg[116021080].content)
			slot10 = string.split(slot8, ".")
	...
	Play116021081 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019_split_6")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021081].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021081", "story_v_out_116021.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
					slot5 = slot9
					uv0.duration_ = slot9 + slot4
				end

				if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
					uv0:RecordAudio("116021081", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116021", "116021081", "story_v_out_116021.awb"))
				else
			...
			slot7 = uv0:FormatText(StoryWordCfg[116021081].content)
			slot9 = string.split(slot7, ".")
	...
	Play116021082 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021082].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021082", "story_v_out_116021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
					slot10 = slot14
					uv0.duration_ = slot14 + slot9
				end

				if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
					uv0:RecordAudio("116021082", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116021", "116021082", "story_v_out_116021.awb"))
				else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116021082].content)
			slot14 = string.split(slot12, ".")
	...
	Play116021083 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot7 = uv0.actors_["1028ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0.var_.moveOldPos1028ui_story = slot7.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021083].content)
				uv0.typewritter.percent = 0
			...
			slot13 = uv0:FormatText(StoryWordCfg[116021083].content)
			slot15 = string.split(slot13, ".")
	...
	Play116021084 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1029ui_story, Vector3.New(0, -1.14, -5.6), (uv0.time_ - slot7) / slot8)
			...
			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 then
				slot6.localPosition = Vector3.New(0, -1.14, -5.6)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021084].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021084", "story_v_out_116021.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
					slot10 = slot14
					uv0.duration_ = slot14 + slot9
				end

				if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
					uv0:RecordAudio("116021084", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116021", "116021084", "story_v_out_116021.awb"))
				else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116021084].content)
			slot14 = string.split(slot12, ".")
	...
	Play116021086 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021086].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021086", "story_v_out_116021.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
					slot4 = slot8
					uv0.duration_ = slot8 + slot3
				end

				if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
					uv0:RecordAudio("116021086", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116021", "116021086", "story_v_out_116021.awb"))
				else
			...
			slot6 = uv0:FormatText(StoryWordCfg[116021086].content)
			slot8 = string.split(slot6, ".")
	...
	Play116021087 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021087].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021087", "story_v_out_116021.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
					slot5 = slot9
					uv0.duration_ = slot9 + slot4
				end

				if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
					uv0:RecordAudio("116021087", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116021", "116021087", "story_v_out_116021.awb"))
				else
			...
			slot7 = uv0:FormatText(StoryWordCfg[116021087].content)
			slot9 = string.split(slot7, ".")
	...
	Play116021088 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021088].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021088", "story_v_out_116021.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
					slot7 = slot11
					uv0.duration_ = slot11 + slot6
				end

				if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
					uv0:RecordAudio("116021088", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116021", "116021088", "story_v_out_116021.awb"))
				else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116021088].content)
			slot11 = string.split(slot9, ".")
	...
	Play116021089 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021089].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021089", "story_v_out_116021.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
					slot4 = slot8
					uv0.duration_ = slot8 + slot3
				end

				if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
					uv0:RecordAudio("116021089", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_116021", "116021089", "story_v_out_116021.awb"))
				else
			...
			slot6 = uv0:FormatText(StoryWordCfg[116021089].content)
			slot8 = string.split(slot6, ".")
	...
	Play116021090 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1019")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021090].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021090", "story_v_out_116021.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
					slot5 = slot9
					uv0.duration_ = slot9 + slot4
				end

				if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
					uv0:RecordAudio("116021090", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116021", "116021090", "story_v_out_116021.awb"))
				else
			...
			slot7 = uv0:FormatText(StoryWordCfg[116021090].content)
			slot9 = string.split(slot7, ".")
	...
	Play116021044 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116021044].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_116021", "116021044", "story_v_out_116021.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("116021044", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116021", "116021044", "story_v_out_116021.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116021044].content)
			slot6 = string.split(slot4, ".")
