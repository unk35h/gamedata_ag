return {
	Play103051001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot10 = uv0.bgs_.B07b

			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				if slot10.GetComponent(slot10, "SpriteRenderer") then
					uv0.var_.alphaOldValueB07b = slot12.material:GetColor("_Color").a
					uv0.var_.alphaMatValueB07b = slot12.material
				end
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot14 = Mathf.Lerp(uv0.var_.alphaOldValueB07b, 1, (uv0.time_ - slot11) / slot12)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051001", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051001", "story_v_out_103051.awb") / 1000 > 0 and slot22 < slot27 and uv0.duration_ < slot27 + slot21 then
						slot22 = slot27
						uv0.duration_ = slot27 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						uv0:RecordAudio("103051001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_103051", "103051001", "story_v_out_103051.awb"))
					else
			...
			slot21 = slot21 + 0.3
			slot24 = uv0:FormatText(StoryWordCfg[103051001].content)
	...
	Play103051002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051002", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051002", "story_v_out_103051.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("103051002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_103051", "103051002", "story_v_out_103051.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[103051002].content)
	...
	Play103051003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051003", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051003", "story_v_out_103051.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("103051003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_103051", "103051003", "story_v_out_103051.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[103051003].content)
	...
	Play103051004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051004", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051004", "story_v_out_103051.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103051004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103051", "103051004", "story_v_out_103051.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103051004].content)
	...
	Play103051005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051005].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[103051005].content)
	...
	Play103051006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051006", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051006", "story_v_out_103051.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("103051006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_103051", "103051006", "story_v_out_103051.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[103051006].content)
	...
	Play103051007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051007", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051007", "story_v_out_103051.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("103051007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_103051", "103051007", "story_v_out_103051.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[103051007].content)
			slot11 = string.split(slot9, ".")
	...
	Play103051008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(0.85, -0.76, -5.4), (uv0.time_ - slot13) / slot14)
			...
			if uv0.time_ >= slot13 + slot14 and uv0.time_ < slot13 + slot14 + slot0 then
				slot12.localPosition = Vector3.New(0.85, -0.76, -5.4)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051008", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051008", "story_v_out_103051.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("103051008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_103051", "103051008", "story_v_out_103051.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[103051008].content)
			slot21 = string.split(slot19, ".")
	...
	Play103051009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(10, -0.76, -5.4), (uv0.time_ - slot7) / slot8)
			...
			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 then
				slot6.localPosition = Vector3.New(10, -0.76, -5.4)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051009", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051009", "story_v_out_103051.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("103051009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_103051", "103051009", "story_v_out_103051.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[103051009].content)
	...
	Play103051010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051010", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051010", "story_v_out_103051.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103051010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103051", "103051010", "story_v_out_103051.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103051010].content)
			slot14 = string.split(slot12, ".")
	...
	Play103051011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051011].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[103051011].content)
			slot9 = string.split(slot7, ".")
	...
	Play103051012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_mmr")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051012", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051012", "story_v_out_103051.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("103051012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_103051", "103051012", "story_v_out_103051.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[103051012].content)
			slot6 = string.split(slot4, ".")
	...
	Play103051013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051013", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051013", "story_v_out_103051.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("103051013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103051", "103051013", "story_v_out_103051.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[103051013].content)
	...
	Play103051014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051014", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051014", "story_v_out_103051.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
						slot8 = slot12
						uv0.duration_ = slot12 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						uv0:RecordAudio("103051014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_103051", "103051014", "story_v_out_103051.awb"))
					else
			...
			slot10 = uv0:FormatText(StoryWordCfg[103051014].content)
	...
	Play103051015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1036")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051015", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051015", "story_v_out_103051.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("103051015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_103051", "103051015", "story_v_out_103051.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[103051015].content)
			slot9 = string.split(slot7, ".")
	...
	Play103051017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1036")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051017", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051017", "story_v_out_103051.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("103051017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_103051", "103051017", "story_v_out_103051.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[103051017].content)
			slot9 = string.split(slot7, ".")
	...
	Play103051019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051019].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[103051019].content)
			slot9 = string.split(slot7, ".")
	...
	Play103051020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1036")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051020", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051020", "story_v_out_103051.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("103051020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_103051", "103051020", "story_v_out_103051.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[103051020].content)
			slot9 = string.split(slot7, ".")
	...
	Play103051018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_1036")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103051018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103051", "103051018", "story_v_out_103051.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103051", "103051018", "story_v_out_103051.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("103051018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_103051", "103051018", "story_v_out_103051.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[103051018].content)
			slot6 = string.split(slot4, ".")
