	...
	Play117061001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061001].content)
			...
			slot13 = slot13 + 0.3
			slot16 = uv0:FormatText(StoryWordCfg[117061001].content)
	...
	Play117061002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061002].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[117061002].content)
	...
	Play117061003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061003].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117061", "117061003", "story_v_out_117061.awb") / 1000 > 0 and slot12 < slot16 and uv0.duration_ < slot16 + slot11 then
					slot12 = slot16
					uv0.duration_ = slot16 + slot11
				end

				if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
					uv0:RecordAudio("117061003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_117061", "117061003", "story_v_out_117061.awb"))
				else
			...
			slot14 = uv0:FormatText(StoryWordCfg[117061003].content)
	...
	Play117061004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061004].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[117061004].content)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				if slot14.GetComponent(slot14, "Image") then
					uv0.var_.alphaMatValue1132_split_6 = slot16
					uv0.var_.alphaOldValue1132_split_6 = slot16.color.a
				end
			...
			if slot15 <= uv0.time_ and uv0.time_ < slot15 + slot16 then
				slot18 = Mathf.Lerp(uv0.var_.alphaOldValue1132_split_6, 1, (uv0.time_ - slot15) / slot16)

				if uv0.var_.alphaMatValue1132_split_6 then
					slot19 = uv0.var_.alphaMatValue1132_split_6.color
					slot19.a = slot18
					uv0.var_.alphaMatValue1132_split_6.color = slot19
				end
			end

			if uv0.time_ >= slot15 + slot16 and uv0.time_ < slot15 + slot16 + slot0 and uv0.var_.alphaMatValue1132_split_6 then
				slot17 = uv0.var_.alphaMatValue1132_split_6
				slot18 = slot17.color
				slot18.a = 1
				slot17.color = slot18
			end

			slot17 = uv0.actors_["1033_split_6"]

			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				if slot17.GetComponent(slot17, "Image") then
					uv0.var_.alphaMatValue1033_split_6 = slot19
					uv0.var_.alphaOldValue1033_split_6 = slot19.color.a
				end
			...
			if slot18 <= uv0.time_ and uv0.time_ < slot18 + slot19 then
				slot21 = Mathf.Lerp(uv0.var_.alphaOldValue1033_split_6, 1, (uv0.time_ - slot18) / slot19)

				if uv0.var_.alphaMatValue1033_split_6 then
					slot22 = uv0.var_.alphaMatValue1033_split_6.color
					slot22.a = slot21
					uv0.var_.alphaMatValue1033_split_6.color = slot22
				end
			end

			if uv0.time_ >= slot18 + slot19 and uv0.time_ < slot18 + slot19 + slot0 and uv0.var_.alphaMatValue1033_split_6 then
				slot20 = uv0.var_.alphaMatValue1033_split_6
				slot21 = slot20.color
				slot21.a = 1
				slot20.color = slot21
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot20 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061005].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117061", "117061005", "story_v_out_117061.awb") / 1000 > 0 and slot21 < slot25 and uv0.duration_ < slot25 + slot20 then
					slot21 = slot25
					uv0.duration_ = slot25 + slot20
				end

				if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
					uv0:RecordAudio("117061005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_117061", "117061005", "story_v_out_117061.awb"))
				else
			...
			slot23 = uv0:FormatText(StoryWordCfg[117061005].content)
	...
	Play117061006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061006].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117061", "117061006", "story_v_out_117061.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
					slot8 = slot12
					uv0.duration_ = slot12 + slot7
				end

				if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
					uv0:RecordAudio("117061006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117061", "117061006", "story_v_out_117061.awb"))
				else
			...
			slot10 = uv0:FormatText(StoryWordCfg[117061006].content)
	...
	Play117061007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061007].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117061", "117061007", "story_v_out_117061.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
					slot8 = slot12
					uv0.duration_ = slot12 + slot7
				end

				if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
					uv0:RecordAudio("117061007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117061", "117061007", "story_v_out_117061.awb"))
				else
			...
			slot10 = uv0:FormatText(StoryWordCfg[117061007].content)
			slot12 = string.split(slot10, ".")
	...
	Play117061008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061008].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117061", "117061008", "story_v_out_117061.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
					slot8 = slot12
					uv0.duration_ = slot12 + slot7
				end

				if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
					uv0:RecordAudio("117061008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117061", "117061008", "story_v_out_117061.awb"))
				else
			...
			slot10 = uv0:FormatText(StoryWordCfg[117061008].content)
			slot12 = string.split(slot10, ".")
	...
	Play117061009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061009].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[117061009].content)
			slot9 = string.split(slot7, ".")
	...
	Play117061010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061010].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117061", "117061010", "story_v_out_117061.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
					slot5 = slot9
					uv0.duration_ = slot9 + slot4
				end

				if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
					uv0:RecordAudio("117061010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_117061", "117061010", "story_v_out_117061.awb"))
				else
			...
			slot7 = uv0:FormatText(StoryWordCfg[117061010].content)
			slot9 = string.split(slot7, ".")
	...
	Play117061011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061011].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117061", "117061011", "story_v_out_117061.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
					slot8 = slot12
					uv0.duration_ = slot12 + slot7
				end

				if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
					uv0:RecordAudio("117061011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117061", "117061011", "story_v_out_117061.awb"))
				else
			...
			slot10 = uv0:FormatText(StoryWordCfg[117061011].content)
			slot12 = string.split(slot10, ".")
	...
	Play117061012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117061012].content)
				uv0.typewritter.percent = 0
			...
			slot14 = slot14 + 0.3
			slot17 = uv0:FormatText(StoryWordCfg[117061012].content)
