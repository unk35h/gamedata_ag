return {
	Play117111001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111001].content)
			...
			slot9 = slot9 + 0.3
			slot12 = uv0:FormatText(StoryWordCfg[117111001].content)
	...
	Play117111002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10035_split_4, Vector3.New(-390, -410, -235), (uv0.time_ - slot3) / slot4)
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				if slot8.GetComponent(slot8, "Image") then
					uv0.var_.alphaMatValue10035_split_4 = slot10
					uv0.var_.alphaOldValue10035_split_4 = slot10.color.a
				end
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot12 = Mathf.Lerp(uv0.var_.alphaOldValue10035_split_4, 1, (uv0.time_ - slot9) / slot10)

				if uv0.var_.alphaMatValue10035_split_4 then
					slot13 = uv0.var_.alphaMatValue10035_split_4.color
					slot13.a = slot12
					uv0.var_.alphaMatValue10035_split_4.color = slot13
				end
			end

			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 and uv0.var_.alphaMatValue10035_split_4 then
				slot11 = uv0.var_.alphaMatValue10035_split_4
				slot12 = slot11.color
				slot12.a = 1
				slot11.color = slot12
			end
			...
			slot12 = uv0.actors_["1033_split_6"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.var_.moveOldPos1033_split_6 = slot12.localPosition
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1033_split_6, Vector3.New(390, -420, 0), (uv0.time_ - slot13) / slot14)
			end
			...
			if slot16 <= uv0.time_ and uv0.time_ < slot16 + slot17 then
				...
				if uv0.var_.highlightMatValue1033_split_6 then
					...
					slot20 = uv0.var_.highlightMatValue1033_split_6
					slot21 = slot20.color
					slot21.r = slot19
					slot21.g = slot19
					slot21.b = slot19
			...
			if uv0.time_ >= slot16 + slot17 and uv0.time_ < slot16 + slot17 + slot0 and uv0.var_.highlightMatValue1033_split_6 then
				slot18 = 0.5
				slot19 = uv0.var_.highlightMatValue1033_split_6
				slot20 = slot19.color
				slot20.r = slot18
				slot20.g = slot18
				slot20.b = slot18
			...
			slot18 = uv0.actors_["1033_split_6"]

			if 0 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				if slot18.GetComponent(slot18, "Image") then
					uv0.var_.alphaMatValue1033_split_6 = slot20
					uv0.var_.alphaOldValue1033_split_6 = slot20.color.a
				end
			...
			if slot19 <= uv0.time_ and uv0.time_ < slot19 + slot20 then
				slot22 = Mathf.Lerp(uv0.var_.alphaOldValue1033_split_6, 1, (uv0.time_ - slot19) / slot20)

				if uv0.var_.alphaMatValue1033_split_6 then
					slot23 = uv0.var_.alphaMatValue1033_split_6.color
					slot23.a = slot22
					uv0.var_.alphaMatValue1033_split_6.color = slot23
				end
			end

			if uv0.time_ >= slot19 + slot20 and uv0.time_ < slot19 + slot20 + slot0 and uv0.var_.alphaMatValue1033_split_6 then
				slot21 = uv0.var_.alphaMatValue1033_split_6
				slot22 = slot21.color
				slot22.a = 1
				slot21.color = slot22
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111002].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111002", "story_v_out_117111.awb") / 1000 > 0 and slot22 < slot26 and uv0.duration_ < slot26 + slot21 then
					slot22 = slot26
					uv0.duration_ = slot26 + slot21
				end

				if slot24.prefab_name ~= "" and uv0.actors_[slot24.prefab_name] ~= nil then
					uv0:RecordAudio("117111002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot24.prefab_name].transform, "story_v_out_117111", "117111002", "story_v_out_117111.awb"))
				else
			...
			slot24 = uv0:FormatText(StoryWordCfg[117111002].content)
	...
	Play117111003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111003].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111003", "story_v_out_117111.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("117111003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117111", "117111003", "story_v_out_117111.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[117111003].content)
	...
	Play117111004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111004].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111004", "story_v_out_117111.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("117111004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117111", "117111004", "story_v_out_117111.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[117111004].content)
			slot6 = string.split(slot4, ".")
	...
	Play117111005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111005].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111005", "story_v_out_117111.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
					slot8 = slot12
					uv0.duration_ = slot12 + slot7
				end

				if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
					uv0:RecordAudio("117111005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117111", "117111005", "story_v_out_117111.awb"))
				else
			...
			slot10 = uv0:FormatText(StoryWordCfg[117111005].content)
	...
	Play117111006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111006].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111006", "story_v_out_117111.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
					slot8 = slot12
					uv0.duration_ = slot12 + slot7
				end

				if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
					uv0:RecordAudio("117111006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117111", "117111006", "story_v_out_117111.awb"))
				else
			...
			slot10 = uv0:FormatText(StoryWordCfg[117111006].content)
			slot12 = string.split(slot10, ".")
	...
	Play117111007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111007].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[117111007].content)
	...
	Play117111008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111008].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111008", "story_v_out_117111.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
					slot9 = slot13
					uv0.duration_ = slot13 + slot8
				end

				if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
					uv0:RecordAudio("117111008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_117111", "117111008", "story_v_out_117111.awb"))
				else
			...
			slot11 = uv0:FormatText(StoryWordCfg[117111008].content)
	...
	Play117111009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111009].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111009", "story_v_out_117111.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
					slot8 = slot12
					uv0.duration_ = slot12 + slot7
				end

				if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
					uv0:RecordAudio("117111009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_117111", "117111009", "story_v_out_117111.awb"))
				else
			...
			slot10 = uv0:FormatText(StoryWordCfg[117111009].content)
			slot12 = string.split(slot10, ".")
	...
	Play117111010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111010].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111010", "story_v_out_117111.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
					slot11 = slot15
					uv0.duration_ = slot15 + slot10
				end

				if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
					uv0:RecordAudio("117111010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117111", "117111010", "story_v_out_117111.awb"))
				else
			...
			slot13 = uv0:FormatText(StoryWordCfg[117111010].content)
	...
	Play117111011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot2 = uv0.actors_["10035_split_5"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				uv0.var_.moveOldPos10035_split_5 = slot2.localPosition
				slot2.localScale = Vector3.New(1, 1, 1)

				uv0:CheckSpriteTmpPos("10035_split_5", 2)
			end

			slot4 = 0.001

			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10035_split_5, Vector3.New(-390, -410, -235), (uv0.time_ - slot3) / slot4)
			end
			...
			slot5 = uv0.actors_["10035_split_5"]

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and slot5.GetComponent(slot5, "Image") then
				uv0.var_.highlightMatValue10035_split_5 = slot7
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				...
				if uv0.var_.highlightMatValue10035_split_5 then
					slot9 = Mathf.Lerp(0.5, 1, slot8)
					slot10 = uv0.var_.highlightMatValue10035_split_5
					slot11 = slot10.color
					slot11.r = slot9
					slot11.g = slot9
					slot11.b = slot9
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 and uv0.var_.highlightMatValue10035_split_5 then
				slot8 = 1

				slot5.transform:SetSiblingIndex(1)

				slot9 = uv0.var_.highlightMatValue10035_split_5
				slot10 = slot9.color
				slot10.r = slot8
				slot10.g = slot8
				slot10.b = slot8
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111011].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111011", "story_v_out_117111.awb") / 1000 > 0 and slot12 < slot16 and uv0.duration_ < slot16 + slot11 then
					slot12 = slot16
					uv0.duration_ = slot16 + slot11
				end

				if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
					uv0:RecordAudio("117111011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_117111", "117111011", "story_v_out_117111.awb"))
				else
			...
			slot14 = uv0:FormatText(StoryWordCfg[117111011].content)
	...
	Play117111012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			slot1 = uv0.actors_["10035_split_5"]

			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 and slot1.GetComponent(slot1, "Image") then
				uv0.var_.highlightMatValue10035_split_5 = slot3
			end
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				...
				if uv0.var_.highlightMatValue10035_split_5 then
					slot5 = Mathf.Lerp(1, 0.5, slot4)
					slot6 = uv0.var_.highlightMatValue10035_split_5
					slot7 = slot6.color
					slot7.r = slot5
					slot7.g = slot5
					slot7.b = slot5
			...
			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 and uv0.var_.highlightMatValue10035_split_5 then
				slot4 = 0.5
				slot5 = uv0.var_.highlightMatValue10035_split_5
				slot6 = slot5.color
				slot6.r = slot4
				slot6.g = slot4
				slot6.b = slot4
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111012].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[117111012].content)
			slot9 = string.split(slot7, ".")
	...
	Play117111013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111013].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111013", "story_v_out_117111.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
					slot11 = slot15
					uv0.duration_ = slot15 + slot10
				end

				if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
					uv0:RecordAudio("117111013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117111", "117111013", "story_v_out_117111.awb"))
				else
			...
			slot13 = uv0:FormatText(StoryWordCfg[117111013].content)
			slot15 = string.split(slot13, ".")
	...
	Play117111014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111014].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111014", "story_v_out_117111.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("117111014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117111", "117111014", "story_v_out_117111.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[117111014].content)
			slot6 = string.split(slot4, ".")
	...
	Play117111015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111015].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111015", "story_v_out_117111.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
					slot11 = slot15
					uv0.duration_ = slot15 + slot10
				end

				if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
					uv0:RecordAudio("117111015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117111", "117111015", "story_v_out_117111.awb"))
				else
			...
			slot13 = uv0:FormatText(StoryWordCfg[117111015].content)
			slot15 = string.split(slot13, ".")
	...
	Play117111016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111016].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[117111016].content)
			slot12 = string.split(slot10, ".")
	...
	Play117111017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111017].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111017", "story_v_out_117111.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
					slot11 = slot15
					uv0.duration_ = slot15 + slot10
				end

				if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
					uv0:RecordAudio("117111017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_117111", "117111017", "story_v_out_117111.awb"))
				else
			...
			slot13 = uv0:FormatText(StoryWordCfg[117111017].content)
			slot15 = string.split(slot13, ".")
	...
	Play117111018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[117111018].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_out_117111", "117111018", "story_v_out_117111.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("117111018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_117111", "117111018", "story_v_out_117111.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[117111018].content)
			slot6 = string.split(slot4, ".")
