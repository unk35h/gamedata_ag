return {
	Play113101001 = function (slot0, slot1)
		...
		slot1.duration_ = 6.299999999999
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 1.999999999999 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101001", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101001", "story_v_out_113101.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("113101001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_113101", "113101001", "story_v_out_113101.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[113101001].content)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				...
				if uv0.var_.characterEffect1041ui_story then
					...
					uv0.var_.characterEffect1041ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot13)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101002", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101002", "story_v_out_113101.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("113101002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_113101", "113101002", "story_v_out_113101.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[113101002].content)
	...
	Play113101003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101003", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101003", "story_v_out_113101.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("113101003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_113101", "113101003", "story_v_out_113101.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[113101003].content)
	...
	Play113101004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1042ui_story, Vector3.New(1.1, -1.11, -5.6), (uv0.time_ - slot6) / slot7)
			...
			slot13 = uv0.actors_["1041ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 and uv0.var_.characterEffect1041ui_story == nil then
				uv0.var_.characterEffect1041ui_story = slot13.GetComponentInChildren(slot13, typeof(CharacterEffect))
			end
			...
			if slot14 <= uv0.time_ and uv0.time_ < slot14 + slot15 then
				...
				if uv0.var_.characterEffect1041ui_story then
					uv0.var_.characterEffect1041ui_story.fillFlat = true
					uv0.var_.characterEffect1041ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot16)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101004", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101004", "story_v_out_113101.awb") / 1000 > 0 and slot17 < slot21 and uv0.duration_ < slot21 + slot16 then
						slot17 = slot21
						uv0.duration_ = slot21 + slot16
					end

					if slot19.prefab_name ~= "" and uv0.actors_[slot19.prefab_name] ~= nil then
						uv0:RecordAudio("113101004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot19.prefab_name].transform, "story_v_out_113101", "113101004", "story_v_out_113101.awb"))
					else
			...
			slot19 = uv0:FormatText(StoryWordCfg[113101004].content)
	...
	Play113101005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101005", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101005", "story_v_out_113101.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("113101005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_113101", "113101005", "story_v_out_113101.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[113101005].content)
	...
	Play113101006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101006", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101006", "story_v_out_113101.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("113101006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_113101", "113101006", "story_v_out_113101.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[113101006].content)
			slot13 = string.split(slot11, ".")
	...
	Play113101007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101007].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[113101007].content)
	...
	Play113101008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101008", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101008", "story_v_out_113101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("113101008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_113101", "113101008", "story_v_out_113101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[113101008].content)
	...
	Play113101009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				...
				if uv0.var_.characterEffect1041ui_story then
					uv0.var_.characterEffect1041ui_story.fillFlat = true
					uv0.var_.characterEffect1041ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot12)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101009", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101009", "story_v_out_113101.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("113101009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_113101", "113101009", "story_v_out_113101.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[113101009].content)
			slot17 = string.split(slot15, ".")
	...
	Play113101010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101010", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101010", "story_v_out_113101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("113101010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_113101", "113101010", "story_v_out_113101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[113101010].content)
			slot14 = string.split(slot12, ".")
	...
	Play113101011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101011", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101011", "story_v_out_113101.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("113101011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_113101", "113101011", "story_v_out_113101.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[113101011].content)
			slot13 = string.split(slot11, ".")
	...
	Play113101012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101012", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101012", "story_v_out_113101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("113101012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_113101", "113101012", "story_v_out_113101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[113101012].content)
			slot14 = string.split(slot12, ".")
	...
	Play113101013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101013", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101013", "story_v_out_113101.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("113101013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_113101", "113101013", "story_v_out_113101.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[113101013].content)
	...
	Play113101014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101014", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101014", "story_v_out_113101.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("113101014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_113101", "113101014", "story_v_out_113101.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[113101014].content)
	...
	Play113101015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101015", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101015", "story_v_out_113101.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("113101015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_113101", "113101015", "story_v_out_113101.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[113101015].content)
			slot13 = string.split(slot11, ".")
	...
	Play113101016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101016", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101016", "story_v_out_113101.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
						slot4 = slot8
						uv0.duration_ = slot8 + slot3
					end

					if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
						uv0:RecordAudio("113101016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_out_113101", "113101016", "story_v_out_113101.awb"))
					else
			...
			slot6 = uv0:FormatText(StoryWordCfg[113101016].content)
	...
	Play113101017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101017", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101017", "story_v_out_113101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("113101017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_113101", "113101017", "story_v_out_113101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[113101017].content)
			slot14 = string.split(slot12, ".")
	...
	Play113101018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101018", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101018", "story_v_out_113101.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("113101018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_113101", "113101018", "story_v_out_113101.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[113101018].content)
			slot20 = string.split(slot18, ".")
	...
	Play113101020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_113101", "113101020", "story_v_out_113101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_113101", "113101020", "story_v_out_113101.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("113101020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_113101", "113101020", "story_v_out_113101.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[113101020].content)
			slot17 = string.split(slot15, ".")
	...
	Play113101021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[113101021].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[113101021].content)
