	...
	Play109011001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011001].content)
			...
			slot3 = slot3 + 0.3
			slot6 = uv0:FormatText(StoryWordCfg[109011001].content)
	...
	Play109011002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				slot10.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1084ui_story, Vector3.New(-0.84, -1.16, -5), (uv0.time_ - slot11) / slot12)
			...
			if uv0.time_ >= slot11 + slot12 and uv0.time_ < slot11 + slot12 + slot0 then
				slot10.localPosition = Vector3.New(-0.84, -1.16, -5)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot17 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_109011", "109011002", "story_v_out_109011.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_109011", "109011002", "story_v_out_109011.awb") / 1000 > 0 and slot18 < slot22 and uv0.duration_ < slot22 + slot17 then
						slot18 = slot22
						uv0.duration_ = slot22 + slot17
					end

					if slot20.prefab_name ~= "" and uv0.actors_[slot20.prefab_name] ~= nil then
						uv0:RecordAudio("109011002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot20.prefab_name].transform, "story_v_out_109011", "109011002", "story_v_out_109011.awb"))
					else
			...
			slot20 = uv0:FormatText(StoryWordCfg[109011002].content)
	...
	Play109011003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_109011", "109011003", "story_v_out_109011.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_109011", "109011003", "story_v_out_109011.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("109011003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_109011", "109011003", "story_v_out_109011.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[109011003].content)
	...
	Play109011004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_109011", "109011004", "story_v_out_109011.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_109011", "109011004", "story_v_out_109011.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
						slot8 = slot12
						uv0.duration_ = slot12 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						uv0:RecordAudio("109011004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_109011", "109011004", "story_v_out_109011.awb"))
					else
			...
			slot10 = uv0:FormatText(StoryWordCfg[109011004].content)
	...
	Play109011005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_109011", "109011005", "story_v_out_109011.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_109011", "109011005", "story_v_out_109011.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("109011005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_109011", "109011005", "story_v_out_109011.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[109011005].content)
	...
	Play109011006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_109011", "109011006", "story_v_out_109011.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_109011", "109011006", "story_v_out_109011.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("109011006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_109011", "109011006", "story_v_out_109011.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[109011006].content)
	...
	Play109011007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_109011", "109011007", "story_v_out_109011.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_109011", "109011007", "story_v_out_109011.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("109011007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_109011", "109011007", "story_v_out_109011.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[109011007].content)
	...
	Play109011008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_109011", "109011008", "story_v_out_109011.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_109011", "109011008", "story_v_out_109011.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("109011008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_109011", "109011008", "story_v_out_109011.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[109011008].content)
			slot7 = string.split(slot5, ".")
	...
	Play109011009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_109011", "109011009", "story_v_out_109011.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_109011", "109011009", "story_v_out_109011.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("109011009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_109011", "109011009", "story_v_out_109011.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[109011009].content)
			slot18 = string.split(slot16, ".")
	...
	Play109011010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_109011", "109011010", "story_v_out_109011.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_109011", "109011010", "story_v_out_109011.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("109011010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_109011", "109011010", "story_v_out_109011.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[109011010].content)
	...
	Play109011011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_109011", "109011011", "story_v_out_109011.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_109011", "109011011", "story_v_out_109011.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("109011011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_109011", "109011011", "story_v_out_109011.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[109011011].content)
			slot14 = string.split(slot12, ".")
	...
	Play109011012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[109011012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_109011", "109011012", "story_v_out_109011.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_109011", "109011012", "story_v_out_109011.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("109011012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_109011", "109011012", "story_v_out_109011.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[109011012].content)
			slot7 = string.split(slot5, ".")
