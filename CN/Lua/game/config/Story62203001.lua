return {
	Play62203001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot6 = uv0.actors_["1111ui_story"].transform

			if 1.8 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				uv0.var_.moveOldPos1111ui_story = slot6.localPosition
			end

			slot8 = 0.001

			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1111ui_story, Vector3.New(0, -0.72, -5.4), (uv0.time_ - slot7) / slot8)
			...
			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 then
				slot6.localPosition = Vector3.New(0, -0.72, -5.4)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62203001].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203001", "story_v_chess_62203.awb") / 1000 > 0 and slot19 < slot24 and uv0.duration_ < slot24 + slot18 then
					slot19 = slot24
					uv0.duration_ = slot24 + slot18
				end

				if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
					uv0:RecordAudio("62203001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_chess_62203", "62203001", "story_v_chess_62203.awb"))
				else
			...
			slot18 = slot18 + 0.3
			slot21 = uv0:FormatText(StoryWordCfg[62203001].content)
	...
	Play62203002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot5 = uv0.actors_["1111ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				uv0.var_.moveOldPos1111ui_story = slot5.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62203002].content)
				uv0.typewritter.percent = 0
			...
			slot11 = uv0:FormatText(StoryWordCfg[62203002].content)
	...
	Play62203003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62203003].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[62203003].content)
	...
	Play62203004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_4013")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62203004].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203004", "story_v_chess_62203.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
					slot2 = slot6
					uv0.duration_ = slot6 + slot1
				end

				if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
					uv0:RecordAudio("62203004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_chess_62203", "62203004", "story_v_chess_62203.awb"))
				else
			...
			slot4 = uv0:FormatText(StoryWordCfg[62203004].content)
			slot6 = string.split(slot4, ".")
	...
	Play62203005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62203005].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203005", "story_v_chess_62203.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
					slot10 = slot14
					uv0.duration_ = slot14 + slot9
				end

				if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
					uv0:RecordAudio("62203005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_chess_62203", "62203005", "story_v_chess_62203.awb"))
				else
			...
			slot12 = uv0:FormatText(StoryWordCfg[62203005].content)
	...
	Play62203006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62203006].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203006", "story_v_chess_62203.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
					slot4 = slot8
					uv0.duration_ = slot8 + slot3
				end

				if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
					uv0:RecordAudio("62203006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_chess_62203", "62203006", "story_v_chess_62203.awb"))
				else
			...
			slot6 = uv0:FormatText(StoryWordCfg[62203006].content)
	...
	Play62203007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_4013")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62203007].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62203", "62203007", "story_v_chess_62203.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
					slot5 = slot9
					uv0.duration_ = slot9 + slot4
				end

				if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
					uv0:RecordAudio("62203007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_chess_62203", "62203007", "story_v_chess_62203.awb"))
				else
			...
			slot7 = uv0:FormatText(StoryWordCfg[62203007].content)
	...
	Play62203008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62203008].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[62203008].content)
			slot9 = string.split(slot7, ".")
	...
	Play62203009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62203009].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[62203009].content)
			slot6 = string.split(slot4, ".")
