	...
	Play62201001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62201001].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201001", "story_v_chess_62201.awb") / 1000 > 0 and slot19 < slot24 and uv0.duration_ < slot24 + slot18 then
					slot19 = slot24
					uv0.duration_ = slot24 + slot18
				end

				if slot22.prefab_name ~= "" and uv0.actors_[slot22.prefab_name] ~= nil then
					uv0:RecordAudio("62201001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot22.prefab_name].transform, "story_v_chess_62201", "62201001", "story_v_chess_62201.awb"))
				else
			...
			slot18 = slot18 + 0.3
			slot21 = uv0:FormatText(StoryWordCfg[62201001].content)
	...
	Play62201002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62201002].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201002", "story_v_chess_62201.awb") / 1000 > 0 and slot4 < slot8 and uv0.duration_ < slot8 + slot3 then
					slot4 = slot8
					uv0.duration_ = slot8 + slot3
				end

				if slot6.prefab_name ~= "" and uv0.actors_[slot6.prefab_name] ~= nil then
					uv0:RecordAudio("62201002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot6.prefab_name].transform, "story_v_chess_62201", "62201002", "story_v_chess_62201.awb"))
				else
			...
			slot6 = uv0:FormatText(StoryWordCfg[62201002].content)
	...
	Play62201003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62201003].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[62201003].content)
	...
	Play62201004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62201004].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201004", "story_v_chess_62201.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
					slot7 = slot11
					uv0.duration_ = slot11 + slot6
				end

				if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
					uv0:RecordAudio("62201004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_chess_62201", "62201004", "story_v_chess_62201.awb"))
				else
			...
			slot9 = uv0:FormatText(StoryWordCfg[62201004].content)
	...
	Play62201005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62201005].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[62201005].content)
			slot9 = string.split(slot7, ".")
	...
	Play62201006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[62201006].content)
				uv0.typewritter.percent = 0

				uv0.typewritter:SetDirty()
				uv0:ShowNextGo(false)

				if manager.audio:GetVoiceLength("story_v_chess_62201", "62201006", "story_v_chess_62201.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
					slot7 = slot11
					uv0.duration_ = slot11 + slot6
				end

				if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
					uv0:RecordAudio("62201006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_chess_62201", "62201006", "story_v_chess_62201.awb"))
				else
			...
			slot9 = uv0:FormatText(StoryWordCfg[62201006].content)
			slot11 = string.split(slot9, ".")
