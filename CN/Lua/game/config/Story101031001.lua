return {
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				if slot4.GetComponent(slot4, "SpriteRenderer") then
					uv0.var_.alphaOldValueB13 = slot6.material:GetColor("_Color").a
					uv0.var_.alphaMatValueB13 = slot6.material
				end
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot8 = Mathf.Lerp(uv0.var_.alphaOldValueB13, 1, (uv0.time_ - slot5) / slot6)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101001].content)
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101001", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101001", "story_v_out_103101.awb") / 1000 > 0 and slot11 < slot16 and uv0.duration_ < slot16 + slot10 then
						slot11 = slot16
						uv0.duration_ = slot16 + slot10
					end

					if slot14.prefab_name ~= "" and uv0.actors_[slot14.prefab_name] ~= nil then
						uv0:RecordAudio("103101001", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot14.prefab_name].transform, "story_v_out_103101", "103101001", "story_v_out_103101.awb"))
					else
			...
			slot10 = slot10 + 0.3
			slot13 = uv0:FormatText(StoryWordCfg[103101001].content)
	...
	Play103101002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101002", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101002", "story_v_out_103101.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("103101002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_103101", "103101002", "story_v_out_103101.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[103101002].content)
			slot15 = string.split(slot13, ".")
	...
	Play103101003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.icon_.sprite = getSpriteWithoutAtlas("Textures/Story/Character/" .. "story_6061")
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101003", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101003", "story_v_out_103101.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("103101003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_103101", "103101003", "story_v_out_103101.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[103101003].content)
	...
	Play103101004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101004", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101004", "story_v_out_103101.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("103101004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_103101", "103101004", "story_v_out_103101.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[103101004].content)
	...
	Play103101005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101005].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[103101005].content)
			slot9 = string.split(slot7, ".")
	...
	Play103101006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101006", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101006", "story_v_out_103101.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("103101006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_103101", "103101006", "story_v_out_103101.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[103101006].content)
	...
	Play103101007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot9 = uv0.actors_["1037ui_story"].transform

			if 1.966 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				uv0.var_.moveOldPos1037ui_story = slot9.localPosition
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101007].content)
				uv0.typewritter.percent = 0
			...
			slot12 = slot12 + 0.3
			slot15 = uv0:FormatText(StoryWordCfg[103101007].content)
	...
	Play103101008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot10 <= uv0.time_ and uv0.time_ < slot10 + slot11 then
				slot9.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(-1.1, -1.14, -5.21), (uv0.time_ - slot10) / slot11)
				slot15 = manager.ui.mainCamera.transform.position - slot9.position
				slot9.forward = Vector3.New(slot15.x, slot15.y, slot15.z)
				slot16 = slot9.localEulerAngles
				slot16.z = 0
			...
			if uv0.time_ >= slot10 + slot11 and uv0.time_ < slot10 + slot11 + slot0 then
				slot9.localPosition = Vector3.New(-1.1, -1.14, -5.21)
				slot14 = manager.ui.mainCamera.transform.position - slot9.position
				slot9.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot9.localEulerAngles
				slot15.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot14 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101008", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101008", "story_v_out_103101.awb") / 1000 > 0 and slot15 < slot19 and uv0.duration_ < slot19 + slot14 then
						slot15 = slot19
						uv0.duration_ = slot19 + slot14
					end

					if slot17.prefab_name ~= "" and uv0.actors_[slot17.prefab_name] ~= nil then
						uv0:RecordAudio("103101008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot17.prefab_name].transform, "story_v_out_103101", "103101008", "story_v_out_103101.awb"))
					else
			...
			slot17 = uv0:FormatText(StoryWordCfg[103101008].content)
	...
	Play103101009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot5 = uv0.actors_["1036ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 and uv0.var_.characterEffect1036ui_story == nil then
				uv0.var_.characterEffect1036ui_story = slot5.GetComponentInChildren(slot5, typeof(CharacterEffect))
			end
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				...
				if uv0.var_.characterEffect1036ui_story then
					...
					uv0.var_.characterEffect1036ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot8)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101009", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101009", "story_v_out_103101.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("103101009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_103101", "103101009", "story_v_out_103101.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[103101009].content)
	...
	Play103101010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101010].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[103101010].content)
			slot9 = string.split(slot7, ".")
	...
	Play103101011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101011", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101011", "story_v_out_103101.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("103101011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_103101", "103101011", "story_v_out_103101.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[103101011].content)
			slot10 = string.split(slot8, ".")
	...
	Play103101012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101012", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101012", "story_v_out_103101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103101012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103101", "103101012", "story_v_out_103101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103101012].content)
	...
	Play103101013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101013", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101013", "story_v_out_103101.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("103101013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103101", "103101013", "story_v_out_103101.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[103101013].content)
	...
	Play103101014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101014", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101014", "story_v_out_103101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103101014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103101", "103101014", "story_v_out_103101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103101014].content)
			slot14 = string.split(slot12, ".")
	...
	Play103101015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101015", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101015", "story_v_out_103101.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("103101015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103101", "103101015", "story_v_out_103101.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[103101015].content)
			slot13 = string.split(slot11, ".")
	...
	Play103101016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101016].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101016", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101016", "story_v_out_103101.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("103101016", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_103101", "103101016", "story_v_out_103101.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[103101016].content)
	...
	Play103101017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101017", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101017", "story_v_out_103101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103101017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103101", "103101017", "story_v_out_103101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103101017].content)
			slot14 = string.split(slot12, ".")
	...
	Play103101018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101018].content)
				uv0.typewritter.percent = 0
			...
			slot13 = uv0:FormatText(StoryWordCfg[103101018].content)
			slot15 = string.split(slot13, ".")
	...
	Play103101019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot8 = uv0.actors_["1036ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPos1036ui_story = slot8.localPosition
			end

			slot10 = 0.001

			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(-1.1, -1.14, -5.21), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(-1.1, -1.14, -5.21)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101019", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101019", "story_v_out_103101.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("103101019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_103101", "103101019", "story_v_out_103101.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[103101019].content)
			slot17 = string.split(slot15, ".")
	...
	Play103101020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101020].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101020", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101020", "story_v_out_103101.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("103101020", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_103101", "103101020", "story_v_out_103101.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[103101020].content)
			slot17 = string.split(slot15, ".")
	...
	Play103101021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101021].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101021", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101021", "story_v_out_103101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103101021", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103101", "103101021", "story_v_out_103101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103101021].content)
			slot14 = string.split(slot12, ".")
	...
	Play103101022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101022].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101022", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101022", "story_v_out_103101.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("103101022", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103101", "103101022", "story_v_out_103101.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[103101022].content)
			slot13 = string.split(slot11, ".")
	...
	Play103101023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101023].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101023", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101023", "story_v_out_103101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103101023", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103101", "103101023", "story_v_out_103101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103101023].content)
			slot14 = string.split(slot12, ".")
	...
	Play103101024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101024", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101024", "story_v_out_103101.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("103101024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103101", "103101024", "story_v_out_103101.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[103101024].content)
			slot13 = string.split(slot11, ".")
	...
	Play103101025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101025].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101025", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101025", "story_v_out_103101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103101025", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103101", "103101025", "story_v_out_103101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103101025].content)
			slot14 = string.split(slot12, ".")
	...
	Play103101026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101026].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101026", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101026", "story_v_out_103101.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("103101026", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_103101", "103101026", "story_v_out_103101.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[103101026].content)
			slot13 = string.split(slot11, ".")
	...
	Play103101027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101027].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101027", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101027", "story_v_out_103101.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("103101027", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_103101", "103101027", "story_v_out_103101.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[103101027].content)
			slot17 = string.split(slot15, ".")
	...
	Play103101028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot3 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101028].content)
				uv0.typewritter.percent = 0
			...
			slot6 = uv0:FormatText(StoryWordCfg[103101028].content)
	...
	Play103101029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0.600000023841858 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101029].content)
				uv0.typewritter.percent = 0
			...
			slot8 = slot8 + 0.3
			slot11 = uv0:FormatText(StoryWordCfg[103101029].content)
			slot13 = string.split(slot11, ".")
	...
	Play103101030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot3 <= uv0.time_ and uv0.time_ < slot3 + slot4 then
				slot2.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1019ui_story, Vector3.New(-1.1, -1.13, -5.3), (uv0.time_ - slot3) / slot4)
			...
			if uv0.time_ >= slot3 + slot4 and uv0.time_ < slot3 + slot4 + slot0 then
				slot2.localPosition = Vector3.New(-1.1, -1.13, -5.3)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101030].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101030", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101030", "story_v_out_103101.awb") / 1000 > 0 and slot11 < slot15 and uv0.duration_ < slot15 + slot10 then
						slot11 = slot15
						uv0.duration_ = slot15 + slot10
					end

					if slot13.prefab_name ~= "" and uv0.actors_[slot13.prefab_name] ~= nil then
						uv0:RecordAudio("103101030", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot13.prefab_name].transform, "story_v_out_103101", "103101030", "story_v_out_103101.awb"))
					else
			...
			slot13 = uv0:FormatText(StoryWordCfg[103101030].content)
			slot15 = string.split(slot13, ".")
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				...
				if uv0.var_.characterEffect1019ui_story then
					...
					uv0.var_.characterEffect1019ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot13)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101031].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101031", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101031", "story_v_out_103101.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("103101031", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_103101", "103101031", "story_v_out_103101.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[103101031].content)
			slot18 = string.split(slot16, ".")
	...
	Play103101032 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot5 <= uv0.time_ and uv0.time_ < slot5 + slot6 then
				slot4.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(1.1, -1.14, -5.21), (uv0.time_ - slot5) / slot6)
				slot10 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot4.localEulerAngles
				slot11.z = 0
			...
			if uv0.time_ >= slot5 + slot6 and uv0.time_ < slot5 + slot6 + slot0 then
				slot4.localPosition = Vector3.New(1.1, -1.14, -5.21)
				slot9 = manager.ui.mainCamera.transform.position - slot4.position
				slot4.forward = Vector3.New(slot9.x, slot9.y, slot9.z)
				slot10 = slot4.localEulerAngles
				slot10.z = 0
			...
			slot9 = uv0.actors_["1036ui_story"]

			if 0 < uv0.time_ and uv0.time_ <= slot10 + slot0 and uv0.var_.characterEffect1036ui_story == nil then
				uv0.var_.characterEffect1036ui_story = slot9.GetComponentInChildren(slot9, typeof(CharacterEffect))
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101032].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101032", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101032", "story_v_out_103101.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("103101032", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_103101", "103101032", "story_v_out_103101.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[103101032].content)
	...
	Play103101033 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101033].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101033", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101033", "story_v_out_103101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103101033", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103101", "103101033", "story_v_out_103101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103101033].content)
			slot14 = string.split(slot12, ".")
	...
	Play103101034 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot6 <= uv0.time_ and uv0.time_ < slot6 + slot7 then
				slot5.localPosition = Vector3.Lerp(uv0.var_.moveOldPos4010ui_story, Vector3.New(0, -1.64, -4.6), (uv0.time_ - slot6) / slot7)
				slot11 = manager.ui.mainCamera.transform.position - slot5.position
				slot5.forward = Vector3.New(slot11.x, slot11.y, slot11.z)
				slot12 = slot5.localEulerAngles
				slot12.z = 0
			...
			if uv0.time_ >= slot6 + slot7 and uv0.time_ < slot6 + slot7 + slot0 then
				slot5.localPosition = Vector3.New(0, -1.64, -4.6)
				slot10 = manager.ui.mainCamera.transform.position - slot5.position
				slot5.forward = Vector3.New(slot10.x, slot10.y, slot10.z)
				slot11 = slot5.localEulerAngles
				slot11.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				uv0:PlayTimeline("4010ui_story", "StoryTimeline/CharAction/public_expression/public_lipsync/publicface3103cva")
			end
			...
			if slot13 <= uv0.time_ and uv0.time_ < slot13 + slot14 then
				slot12.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1036ui_story, Vector3.New(0, 100, 0), (uv0.time_ - slot13) / slot14)
				slot18 = manager.ui.mainCamera.transform.position - slot12.position
				slot12.forward = Vector3.New(slot18.x, slot18.y, slot18.z)
				slot19 = slot12.localEulerAngles
				slot19.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101034].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101034", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101034", "story_v_out_103101.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("103101034", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_103101", "103101034", "story_v_out_103101.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[103101034].content)
			slot20 = string.split(slot18, ".")
	...
	Play103101035 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101035].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101035", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101035", "story_v_out_103101.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("103101035", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_103101", "103101035", "story_v_out_103101.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[103101035].content)
			slot17 = string.split(slot15, ".")
	...
	Play103101036 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101036].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[103101036].content)
	...
	Play103101037 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101037].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[103101037].content)
	...
	Play103101038 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101038].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101038", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101038", "story_v_out_103101.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("103101038", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_103101", "103101038", "story_v_out_103101.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[103101038].content)
			slot14 = string.split(slot12, ".")
	...
	Play103101039 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101039].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101039", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101039", "story_v_out_103101.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("103101039", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_103101", "103101039", "story_v_out_103101.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[103101039].content)
			slot9 = string.split(slot7, ".")
	...
	Play103101040 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot9 <= uv0.time_ and uv0.time_ < slot9 + slot10 then
				slot8.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(-1.1, -0.76, -5.4), (uv0.time_ - slot9) / slot10)
				slot14 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot14.x, slot14.y, slot14.z)
				slot15 = slot8.localEulerAngles
				slot15.z = 0
			...
			if uv0.time_ >= slot9 + slot10 and uv0.time_ < slot9 + slot10 + slot0 then
				slot8.localPosition = Vector3.New(-1.1, -0.76, -5.4)
				slot13 = manager.ui.mainCamera.transform.position - slot8.position
				slot8.forward = Vector3.New(slot13.x, slot13.y, slot13.z)
				slot14 = slot8.localEulerAngles
				slot14.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101040].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101040", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101040", "story_v_out_103101.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("103101040", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_103101", "103101040", "story_v_out_103101.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[103101040].content)
			slot18 = string.split(slot16, ".")
	...
	Play103101041 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101041].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101041", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101041", "story_v_out_103101.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("103101041", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_103101", "103101041", "story_v_out_103101.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[103101041].content)
			slot17 = string.split(slot15, ".")
	...
	Play103101042 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot2 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101042].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101042", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101042", "story_v_out_103101.awb") / 1000 > 0 and slot3 < slot7 and uv0.duration_ < slot7 + slot2 then
						slot3 = slot7
						uv0.duration_ = slot7 + slot2
					end

					if slot5.prefab_name ~= "" and uv0.actors_[slot5.prefab_name] ~= nil then
						uv0:RecordAudio("103101042", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot5.prefab_name].transform, "story_v_out_103101", "103101042", "story_v_out_103101.awb"))
					else
			...
			slot5 = uv0:FormatText(StoryWordCfg[103101042].content)
			slot7 = string.split(slot5, ".")
	...
	Play103101043 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot18 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[103101043].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_103101", "103101043", "story_v_out_103101.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_103101", "103101043", "story_v_out_103101.awb") / 1000 > 0 and slot19 < slot23 and uv0.duration_ < slot23 + slot18 then
						slot19 = slot23
						uv0.duration_ = slot23 + slot18
					end

					if slot21.prefab_name ~= "" and uv0.actors_[slot21.prefab_name] ~= nil then
						uv0:RecordAudio("103101043", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot21.prefab_name].transform, "story_v_out_103101", "103101043", "story_v_out_103101.awb"))
					else
			...
			slot21 = uv0:FormatText(StoryWordCfg[103101043].content)
