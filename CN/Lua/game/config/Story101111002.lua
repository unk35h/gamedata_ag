return {
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				if slot3.GetComponent(slot3, "SpriteRenderer") then
					uv0.var_.alphaOldValueD06b = slot5.material:GetColor("_Color").a
					uv0.var_.alphaMatValueD06b = slot5.material
				end
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				slot7 = Mathf.Lerp(uv0.var_.alphaOldValueD06b, 1, (uv0.time_ - slot4) / slot5)
			...
			slot18 = uv0.actors_["1094ui_story"].transform

			if 2 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				uv0.var_.moveOldPos1094ui_story = slot18.localPosition
			end

			slot20 = 0.001

			if slot19 <= uv0.time_ and uv0.time_ < slot19 + slot20 then
				slot18.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1094ui_story, Vector3.New(0, -0.89, -5.5), (uv0.time_ - slot19) / slot20)
			...
			if uv0.time_ >= slot19 + slot20 and uv0.time_ < slot19 + slot20 + slot0 then
				slot18.localPosition = Vector3.New(0, -0.89, -5.5)
			...
			slot21 = uv0.actors_["1094ui_story"]

			if 2 < uv0.time_ and uv0.time_ <= slot22 + slot0 and uv0.var_.characterEffect1094ui_story == nil then
				uv0.var_.characterEffect1094ui_story = slot21.GetComponentInChildren(slot21, typeof(CharacterEffect))
			end
			...
			if slot22 <= uv0.time_ and uv0.time_ < slot22 + slot23 then
				...
				if uv0.var_.characterEffect1094ui_story then
					...
					uv0.var_.characterEffect1094ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot24)
				end
			end
			...
			if 2 < uv0.time_ and uv0.time_ <= slot26 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102001].content)
			...
			slot26 = slot26 + 0.3
			slot29 = uv0:FormatText(StoryWordCfg[111102001].content)
			slot31 = string.split(slot29, ".")

			if #string.split(slot29, "\n") >= 4 or #slot31 >= 4 then
				slot27 = slot27 * 3
			end
	...
	Play111102002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102002].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[111102002].content)
	...
	Play111102003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot8 = uv0.actors_["1094ui_story"].transform

			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				uv0.var_.moveOldPos1094ui_story = slot8.localPosition
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot11 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102003].content)
				uv0.typewritter.percent = 0
			...
			slot14 = uv0:FormatText(StoryWordCfg[111102003].content)
	...
	Play111102004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				uv0.var_.shakeOldPos = slot14.localPosition
			end
			...
			if 0.8 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102004", "story_v_out_111102.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111102", "111102004", "story_v_out_111102.awb") / 1000 > 0 and slot20 < slot25 and uv0.duration_ < slot25 + slot19 then
						slot20 = slot25
						uv0.duration_ = slot25 + slot19
					end

					if slot23.prefab_name ~= "" and uv0.actors_[slot23.prefab_name] ~= nil then
						uv0:RecordAudio("111102004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot23.prefab_name].transform, "story_v_out_111102", "111102004", "story_v_out_111102.awb"))
					else
			...
			slot19 = slot19 + 0.3
			slot22 = uv0:FormatText(StoryWordCfg[111102004].content)
	...
	Play111102005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102005", "story_v_out_111102.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111102", "111102005", "story_v_out_111102.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("111102005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_111102", "111102005", "story_v_out_111102.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[111102005].content)
	...
	Play111102006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102006].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111102006].content)
			slot9 = string.split(slot7, ".")
	...
	Play111102007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot2 <= uv0.time_ and uv0.time_ < slot2 + slot3 then
				slot1.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1094ui_story, Vector3.New(1.1, -0.89, -5.5), (uv0.time_ - slot2) / slot3)
			...
			if uv0.time_ >= slot2 + slot3 and uv0.time_ < slot2 + slot3 + slot0 then
				slot1.localPosition = Vector3.New(1.1, -0.89, -5.5)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102007", "story_v_out_111102.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111102", "111102007", "story_v_out_111102.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("111102007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111102", "111102007", "story_v_out_111102.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[111102007].content)
	...
	Play111102008 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102008].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111102008].content)
			slot9 = string.split(slot7, ".")
	...
	Play111102009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102009].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111102009].content)
			slot9 = string.split(slot7, ".")
	...
	Play111102010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102010].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102010", "story_v_out_111102.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111102", "111102010", "story_v_out_111102.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("111102010", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_111102", "111102010", "story_v_out_111102.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[111102010].content)
			slot14 = string.split(slot12, ".")
	...
	Play111102011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102011].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111102011].content)
			slot9 = string.split(slot7, ".")
	...
	Play111102012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102012", "story_v_out_111102.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111102", "111102012", "story_v_out_111102.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("111102012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_111102", "111102012", "story_v_out_111102.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[111102012].content)
	...
	Play111102013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102013].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111102013].content)
			slot9 = string.split(slot7, ".")
	...
	Play111102014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot5 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_111102", "111102014", "story_v_out_111102.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_111102", "111102014", "story_v_out_111102.awb") / 1000 > 0 and slot6 < slot10 and uv0.duration_ < slot10 + slot5 then
						slot6 = slot10
						uv0.duration_ = slot10 + slot5
					end

					if slot8.prefab_name ~= "" and uv0.actors_[slot8.prefab_name] ~= nil then
						uv0:RecordAudio("111102014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot8.prefab_name].transform, "story_v_out_111102", "111102014", "story_v_out_111102.awb"))
					else
			...
			slot8 = uv0:FormatText(StoryWordCfg[111102014].content)
	...
	Play111102015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[111102015].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[111102015].content)
			slot9 = string.split(slot7, ".")
