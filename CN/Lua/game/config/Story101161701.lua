return {
	Play116171001 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 2 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171001].content)
			...
			slot12 = uv0:FormatText(StoryWordCfg[116171001].content)
	...
	Play116171002 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171002].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171002", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171002", "story_v_out_116171.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116171002", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116171", "116171002", "story_v_out_116171.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116171002].content)
			slot14 = string.split(slot12, ".")
	...
	Play116171003 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot4 <= uv0.time_ and uv0.time_ < slot4 + slot5 then
				slot3.localPosition = Vector3.Lerp(uv0.var_.moveOldPos10014ui_story, Vector3.New(1.1, -1.11, -5.6), (uv0.time_ - slot4) / slot5)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				...
				if uv0.var_.characterEffect2079ui_story then
					...
					uv0.var_.characterEffect2079ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot9)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot15 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171003].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171003", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171003", "story_v_out_116171.awb") / 1000 > 0 and slot16 < slot20 and uv0.duration_ < slot20 + slot15 then
						slot16 = slot20
						uv0.duration_ = slot20 + slot15
					end

					if slot18.prefab_name ~= "" and uv0.actors_[slot18.prefab_name] ~= nil then
						uv0:RecordAudio("116171003", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot18.prefab_name].transform, "story_v_out_116171", "116171003", "story_v_out_116171.awb"))
					else
			...
			slot18 = uv0:FormatText(StoryWordCfg[116171003].content)
	...
	Play116171004 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171004].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171004", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171004", "story_v_out_116171.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("116171004", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116171", "116171004", "story_v_out_116171.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[116171004].content)
	...
	Play116171005 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171005].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171005", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171005", "story_v_out_116171.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("116171005", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116171", "116171005", "story_v_out_116171.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[116171005].content)
			slot9 = string.split(slot7, ".")
	...
	Play116171006 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171006].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171006", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171006", "story_v_out_116171.awb") / 1000 > 0 and slot5 < slot9 and uv0.duration_ < slot9 + slot4 then
						slot5 = slot9
						uv0.duration_ = slot9 + slot4
					end

					if slot7.prefab_name ~= "" and uv0.actors_[slot7.prefab_name] ~= nil then
						uv0:RecordAudio("116171006", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot7.prefab_name].transform, "story_v_out_116171", "116171006", "story_v_out_116171.awb"))
					else
			...
			slot7 = uv0:FormatText(StoryWordCfg[116171006].content)
			slot9 = string.split(slot7, ".")
	...
	Play116171007 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot15 = uv0.actors_["2079ui_story"].transform

			if 1.966 < uv0.time_ and uv0.time_ <= slot16 + slot0 then
				uv0.var_.moveOldPos2079ui_story = slot15.localPosition
			end
			...
			slot18 = uv0.actors_["10014ui_story"].transform

			if 1.966 < uv0.time_ and uv0.time_ <= slot19 + slot0 then
				uv0.var_.moveOldPos10014ui_story = slot18.localPosition
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171007].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171007", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171007", "story_v_out_116171.awb") / 1000 > 0 and slot22 < slot27 and uv0.duration_ < slot27 + slot21 then
						slot22 = slot27
						uv0.duration_ = slot27 + slot21
					end

					if slot25.prefab_name ~= "" and uv0.actors_[slot25.prefab_name] ~= nil then
						uv0:RecordAudio("116171007", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot25.prefab_name].transform, "story_v_out_116171", "116171007", "story_v_out_116171.awb"))
					else
			...
			slot21 = slot21 + 0.3
			slot24 = uv0:FormatText(StoryWordCfg[116171007].content)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot11 <= uv0.time_ and uv0.time_ < slot11 + slot12 then
				...
				if uv0.var_.characterEffect1011ui_story then
					...
					uv0.var_.characterEffect1011ui_story.fillRatio = Mathf.Lerp(0, 0.5, slot13)
				end
			end
			...
			if 0 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171008].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171008", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171008", "story_v_out_116171.awb") / 1000 > 0 and slot14 < slot18 and uv0.duration_ < slot18 + slot13 then
						slot14 = slot18
						uv0.duration_ = slot18 + slot13
					end

					if slot16.prefab_name ~= "" and uv0.actors_[slot16.prefab_name] ~= nil then
						uv0:RecordAudio("116171008", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot16.prefab_name].transform, "story_v_out_116171", "116171008", "story_v_out_116171.awb"))
					else
			...
			slot16 = uv0:FormatText(StoryWordCfg[116171008].content)
	...
	Play116171009 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171009].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171009", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171009", "story_v_out_116171.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("116171009", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116171", "116171009", "story_v_out_116171.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116171009].content)
	...
	Play116171010 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171010].content)
				uv0.typewritter.percent = 0
			...
			slot10 = uv0:FormatText(StoryWordCfg[116171010].content)
	...
	Play116171011 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171011].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171011", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171011", "story_v_out_116171.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116171011", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116171", "116171011", "story_v_out_116171.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116171011].content)
			slot14 = string.split(slot12, ".")
	...
	Play116171012 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171012].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171012", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171012", "story_v_out_116171.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("116171012", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_116171", "116171012", "story_v_out_116171.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[116171012].content)
	...
	Play116171013 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot7 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171013].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171013", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171013", "story_v_out_116171.awb") / 1000 > 0 and slot8 < slot12 and uv0.duration_ < slot12 + slot7 then
						slot8 = slot12
						uv0.duration_ = slot12 + slot7
					end

					if slot10.prefab_name ~= "" and uv0.actors_[slot10.prefab_name] ~= nil then
						uv0:RecordAudio("116171013", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot10.prefab_name].transform, "story_v_out_116171", "116171013", "story_v_out_116171.awb"))
					else
			...
			slot10 = uv0:FormatText(StoryWordCfg[116171013].content)
			slot12 = string.split(slot10, ".")
	...
	Play116171014 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if slot7 <= uv0.time_ and uv0.time_ < slot7 + slot8 then
				slot6.localPosition = Vector3.Lerp(uv0.var_.moveOldPos1011ui_story, Vector3.New(-1.1, -0.76, -5.4), (uv0.time_ - slot7) / slot8)
				slot12 = manager.ui.mainCamera.transform.position - slot6.position
				slot6.forward = Vector3.New(slot12.x, slot12.y, slot12.z)
				slot13 = slot6.localEulerAngles
				slot13.z = 0
			...
			if uv0.time_ >= slot7 + slot8 and uv0.time_ < slot7 + slot8 + slot0 then
				slot6.localPosition = Vector3.New(-1.1, -0.76, -5.4)
				slot11 = manager.ui.mainCamera.transform.position - slot6.position
				slot6.forward = Vector3.New(slot11.x, slot11.y, slot11.z)
				slot12 = slot6.localEulerAngles
				slot12.z = 0
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171014].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171014", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171014", "story_v_out_116171.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116171014", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116171", "116171014", "story_v_out_116171.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116171014].content)
			slot14 = string.split(slot12, ".")
	...
	Play116171015 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot12 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171015].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171015", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171015", "story_v_out_116171.awb") / 1000 > 0 and slot13 < slot17 and uv0.duration_ < slot17 + slot12 then
						slot13 = slot17
						uv0.duration_ = slot17 + slot12
					end

					if slot15.prefab_name ~= "" and uv0.actors_[slot15.prefab_name] ~= nil then
						uv0:RecordAudio("116171015", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot15.prefab_name].transform, "story_v_out_116171", "116171015", "story_v_out_116171.awb"))
					else
			...
			slot15 = uv0:FormatText(StoryWordCfg[116171015].content)
			slot17 = string.split(slot15, ".")
	...
	Play116171016 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot4 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171016].content)
				uv0.typewritter.percent = 0
			...
			slot7 = uv0:FormatText(StoryWordCfg[116171016].content)
			slot9 = string.split(slot7, ".")
	...
	Play116171017 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot6 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171017].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171017", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171017", "story_v_out_116171.awb") / 1000 > 0 and slot7 < slot11 and uv0.duration_ < slot11 + slot6 then
						slot7 = slot11
						uv0.duration_ = slot11 + slot6
					end

					if slot9.prefab_name ~= "" and uv0.actors_[slot9.prefab_name] ~= nil then
						uv0:RecordAudio("116171017", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot9.prefab_name].transform, "story_v_out_116171", "116171017", "story_v_out_116171.awb"))
					else
			...
			slot9 = uv0:FormatText(StoryWordCfg[116171017].content)
	...
	Play116171018 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot9 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171018].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171018", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171018", "story_v_out_116171.awb") / 1000 > 0 and slot10 < slot14 and uv0.duration_ < slot14 + slot9 then
						slot10 = slot14
						uv0.duration_ = slot14 + slot9
					end

					if slot12.prefab_name ~= "" and uv0.actors_[slot12.prefab_name] ~= nil then
						uv0:RecordAudio("116171018", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot12.prefab_name].transform, "story_v_out_116171", "116171018", "story_v_out_116171.awb"))
					else
			...
			slot12 = uv0:FormatText(StoryWordCfg[116171018].content)
			slot14 = string.split(slot12, ".")
	...
	Play116171019 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot8 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171019].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171019", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171019", "story_v_out_116171.awb") / 1000 > 0 and slot9 < slot13 and uv0.duration_ < slot13 + slot8 then
						slot9 = slot13
						uv0.duration_ = slot13 + slot8
					end

					if slot11.prefab_name ~= "" and uv0.actors_[slot11.prefab_name] ~= nil then
						uv0:RecordAudio("116171019", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot11.prefab_name].transform, "story_v_out_116171", "116171019", "story_v_out_116171.awb"))
					else
			...
			slot11 = uv0:FormatText(StoryWordCfg[116171019].content)
			slot13 = string.split(slot11, ".")
	...
	Play116171020 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			slot12 = uv0.actors_["1011ui_story"].transform

			if 1.966 < uv0.time_ and uv0.time_ <= slot13 + slot0 then
				uv0.var_.moveOldPos1011ui_story = slot12.localPosition
			end
			...
			if 4 < uv0.time_ and uv0.time_ <= slot21 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171020].content)
				uv0.typewritter.percent = 0
			...
			slot21 = slot21 + 0.3
			slot24 = uv0:FormatText(StoryWordCfg[116171020].content)
			slot26 = string.split(slot24, ".")
	...
	Play116171021 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171021].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116171021].content)
	...
	Play116171022 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171022].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116171022].content)
			slot6 = string.split(slot4, ".")
	...
	Play116171023 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171023].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116171023].content)
			slot6 = string.split(slot4, ".")
	...
	Play116171024 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171024].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171024", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171024", "story_v_out_116171.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("116171024", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116171", "116171024", "story_v_out_116171.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116171024].content)
			slot6 = string.split(slot4, ".")
	...
	Play116171025 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171025].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116171025].content)
			slot6 = string.split(slot4, ".")
	...
	Play116171026 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171026].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116171026].content)
			slot6 = string.split(slot4, ".")
	...
	Play116171027 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171027].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116171027].content)
			slot6 = string.split(slot4, ".")
	...
	Play116171028 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171028].content)
				uv0.typewritter.percent = 0
				...
				if manager.audio:GetVoiceLength("story_v_out_116171", "116171028", "story_v_out_116171.awb") ~= 0 then
					if manager.audio:GetVoiceLength("story_v_out_116171", "116171028", "story_v_out_116171.awb") / 1000 > 0 and slot2 < slot6 and uv0.duration_ < slot6 + slot1 then
						slot2 = slot6
						uv0.duration_ = slot6 + slot1
					end

					if slot4.prefab_name ~= "" and uv0.actors_[slot4.prefab_name] ~= nil then
						uv0:RecordAudio("116171028", LuaForUtil.PlayVoiceWithCriLipsync(uv0.actors_[slot4.prefab_name].transform, "story_v_out_116171", "116171028", "story_v_out_116171.awb"))
					else
			...
			slot4 = uv0:FormatText(StoryWordCfg[116171028].content)
			slot6 = string.split(slot4, ".")
	...
	Play116171029 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171029].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116171029].content)
			slot6 = string.split(slot4, ".")
	...
	Play116171030 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171030].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116171030].content)
			slot6 = string.split(slot4, ".")
	...
	Play116171031 = function (slot0, slot1)
		...
		function slot1.onSingleLineUpdate_(slot0)
			...
			if 0 < uv0.time_ and uv0.time_ <= slot1 + slot0 then
				...
				uv0.text_.text = uv0:FormatText(StoryWordCfg[116171031].content)
				uv0.typewritter.percent = 0
			...
			slot4 = uv0:FormatText(StoryWordCfg[116171031].content)
			slot6 = string.split(slot4, ".")
